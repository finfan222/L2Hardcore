...
public class MathUtil {
    ...
    /**
     * This check includes collision radius of both characters.<br> Used for accurate checks (skill casts, knownlist,
     * etc).
     *
    ...
    /**
     * Returns the rounded value of val to specified number of digits after the decimal point.<BR> (Based on round() in
     * PHP)
     *
     * @param val
     * @param numPlaces
