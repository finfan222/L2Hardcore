...
public class Polygon extends AShape {
    ...
    /**
     * Returns true if the triangle formed by A, B, C points is an ear considering the polygon - thus if no other point
     * is inside and it is convex.
     *
     * @param isCw : Polygon orientation (clockwise/counterclockwise).
     * @param nonConvexPoints : List of all non-convex points.
    ...
    /**
     * Returns true when the point B is convex considered the actual polygon. A, B and C are three consecutive points of
     * the polygon.
     *
     * @param isCw : Polygon orientation (clockwise/counterclockwise).
