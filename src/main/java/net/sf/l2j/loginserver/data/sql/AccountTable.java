...
public class AccountTable {
     ...
     * @return A new {@link Account} whom informations are already registered into the database, or null if not
     * existing.
     */
     ...
     * @return True if the given {@link Account} last_active timestamp has been correctly refreshed on the database,
     * false otherwise.
     */
