...
public class NewCrypt {
    ...
    /**
     * Packet is first XOR encoded with <code>key</code>.<br> Then, the last 4 bytes are overwritten with the the XOR
     * "key".<br> Thus this assume that there is enough room for the key to fit without overwriting data.
     *
