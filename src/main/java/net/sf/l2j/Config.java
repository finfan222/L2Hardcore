...
public final class Config {
    ...
    /**
     * Loads event settings.<br> Such as olympiad, seven signs festival, four sepulchures, dimensional rift, weddings,
     * lottery, fishing championship.
     */
    ...
    /**
     * Loads NPC settings.<br> Such as champion monsters, NPC buffer, class master, wyvern, raid bosses and grand
     * bosses, AI.
     */
    ...
    /**
     * Loads gameserver settings.<br> IP addresses, database, rates, feature enabled/disabled, misc.
     */
    ...
    /**
     * Loads loginserver settings.<br> IP addresses, database, account, misc.
     */
