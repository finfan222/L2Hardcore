...
public class AdminEditChar implements IAdminCommandHandler {
    ...
    /**
     * Gather {@link Player} informations and send them on an existing {@link NpcHtmlMessage}. Additionally, set the
     * target to this {@link Player}.
     *
    ...
    /**
     * Gather {@link Player} informations and send them on a new {@link NpcHtmlMessage}. Additionally, set the target to
     * this {@link Player}.
     *
     * @param player : The {@link Player} who requested that action.
     * @param targetPlayer : The {@link Player} target to gather informations from.
