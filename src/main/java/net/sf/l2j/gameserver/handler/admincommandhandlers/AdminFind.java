...
public class AdminFind implements IAdminCommandHandler {
    ...
    /**
     * Find all {@link Player}s using their names and related to a tested {@link String}, and send back the results to
     * the {@link Player}.
     *
     * @param player : The {@link Player} to send back results.
    ...
    /**
     * List all characters names attached to an ONLINE {@link Player} name and send results to the {@link Player} set as
     * parameter.
     *
     * @param player : The {@link Player} who requested the action.
