...
public final class SystemMessageId {
    ...
    /**
     * ID: 1<br> Message: The server will be coming down in $1 seconds. Please find a safe place to log out.
     */
    public static final SystemMessageId THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_SECONDS;

    /**
     * ID: 2<br> Message: $s1 does not exist.
     */
    ...
    /**
     * ID: 7<br> Message: You are already a member of $s1.
     */
    ...
    /**
     * ID: 32<br> Message: You are unable to engage in combat. Please go to the nearest restart point.
     */
    public static final SystemMessageId UNABLE_COMBAT_PLEASE_GO_RESTART;

    /**
     * ID: 32<br> Message: You cannot move while casting.
     */
    ...
    /**
     * ID: 37<br> Message: $s1 hit you for $s2 damage.
     */
    ...
    /**
     * ID: 45<br> Message: You have earned $s1 experience.
     */
    ...
    /**
     * ID: 47<br> Message: You begin to use a(n) $s1.
     */
    public static final SystemMessageId BEGIN_TO_USE_S1;

    /**
     * ID: 48<br> Message: $s1 is not available at this time: being prepared for reuse.
     */
    ...
    /**
     * ID: 58<br> Message: You have failed to earn $s1 adena.
     */
    public static final SystemMessageId FAILED_TO_EARN_S1_ADENA;

    /**
     * ID: 59<br> Message: You have failed to earn $s1.
     */
    public static final SystemMessageId FAILED_TO_EARN_S1;

    /**
     * ID: 60<br> Message: You have failed to earn $s2 $s1(s).
     */
    ...
    /**
     * ID: 64<br> Message: The enchantment has failed! Your $s1 has been crystallized.
     */
    public static final SystemMessageId ENCHANTMENT_FAILED_S1_EVAPORATED;

    /**
     * ID: 65<br> Message: The enchantment has failed! Your +$s1 $s2 has been crystallized.
     */
    public static final SystemMessageId ENCHANTMENT_FAILED_S1_S2_EVAPORATED;

    /**
     * ID: 66<br> Message: $s1 is inviting you to join a party. Do you accept?
     */
    public static final SystemMessageId S1_INVITED_YOU_TO_PARTY;

    /**
     * ID: 67<br> Message: $s1 has invited you to the join the clan, $s2. Do you wish to join?
     */
    public static final SystemMessageId S1_HAS_INVITED_YOU_TO_JOIN_THE_CLAN_S2;

    /**
     * ID: 68<br> Message: Would you like to withdraw from the $s1 clan? If you leave, you will have to wait at least a
     * day before joining another clan.
     */
    public static final SystemMessageId WOULD_YOU_LIKE_TO_WITHDRAW_FROM_THE_S1_CLAN;

    /**
     * ID: 69<br> Message: Would you like to dismiss $s1 from the clan? If you do so, you will have to wait at least a
     * day before accepting a new member.
     */
    public static final SystemMessageId WOULD_YOU_LIKE_TO_DISMISS_S1_FROM_THE_CLAN;

    /**
     * ID: 70<br> Message: Do you wish to disperse the clan, $s1?
     */
    public static final SystemMessageId DO_YOU_WISH_TO_DISPERSE_THE_CLAN_S1;

    /**
     * ID: 71<br> Message: How many of your $s1(s) do you wish to discard?
     */
    public static final SystemMessageId HOW_MANY_S1_DISCARD;

    /**
     * ID: 72<br> Message: How many of your $s1(s) do you wish to move?
     */
    public static final SystemMessageId HOW_MANY_S1_MOVE;

    /**
     * ID: 73<br> Message: How many of your $s1(s) do you wish to destroy?
     */
    public static final SystemMessageId HOW_MANY_S1_DESTROY;

    /**
     * ID: 74<br> Message: Do you wish to destroy your $s1?
     */
    public static final SystemMessageId WISH_DESTROY_S1;

    /**
     * ID: 75<br> Message: ID does not exist.
     */
    public static final SystemMessageId ID_NOT_EXIST;

    /**
     * ID: 76<br> Message: Incorrect password.
     */
    public static final SystemMessageId INCORRECT_PASSWORD;

    /**
     * ID: 77<br> Message: You cannot create another character. Please delete the existing character and try again.
     */
    public static final SystemMessageId CANNOT_CREATE_CHARACTER;

    /**
     * ID: 78<br> Message: When you delete a character, any items in his/her possession will also be deleted. Do you
     * really wish to delete $s1%?
     */
    ...
    /**
     * ID: 80<br> Message: Names must be between 1-16 characters, excluding spaces or special characters.
     */
    public static final SystemMessageId NAMING_CHARNAME_UP_TO_16CHARS;

    /**
     * ID: 81<br> Message: Please select your race.
     */
    public static final SystemMessageId PLEASE_SELECT_RACE;

    /**
     * ID: 82<br> Message: Please select your occupation.
     */
    public static final SystemMessageId PLEASE_SELECT_OCCUPATION;

    /**
     * ID: 83<br> Message: Please select your gender.
     */
    ...
    /**
     * ID: 86<br> Message: Please enter your ID.
     */
    public static final SystemMessageId PLEASE_ENTER_ID;

    /**
     * ID: 87<br> Message: Please enter your password.
     */
    public static final SystemMessageId PLEASE_ENTER_PASSWORD;

    /**
     * ID: 88<br> Message: Your protocol version is different, please restart your client and run a full check.
     */
    public static final SystemMessageId WRONG_PROTOCOL_CHECK;

    /**
     * ID: 89<br> Message: Your protocol version is different, please continue.
     */
    public static final SystemMessageId WRONG_PROTOCOL_CONTINUE;

    /**
     * ID: 90<br> Message: You are unable to connect to the server.
     */
    public static final SystemMessageId UNABLE_TO_CONNECT;

    /**
     * ID: 91<br> Message: Please select your hairstyle.
     */
    ...
    /**
     * ID: 93<br> Message: You do not have enough SP for this.
     */
    public static final SystemMessageId NOT_ENOUGH_SP;

    /**
     * ID: 94<br> Message: 2004-2009 (c) Copyright NCsoft Corporation. All Rights Reserved.
     */
    ...
    /**
     * ID: 97<br> Message: This item cannot be moved.
     */
    ...
    /**
     * ID: 99<br> Message: This item cannot be traded or sold.
     */
    public static final SystemMessageId CANNOT_TRADE_THIS_ITEM;

    /**
     * ID: 100<br> Message: $s1 is requesting to trade. Do you wish to continue?
     */
    ...
    /**
     * ID: 103<br> Message: This ID is currently logged in.
     */
    public static final SystemMessageId ID_LOGGED_IN;

    /**
     * ID: 104<br> Message: You may not equip items while casting or performing a skill.
     */
    ...
    /**
     * ID: 110<br> Message: $s1 $s2's effect can be felt.
     */
    ...
    /**
     * ID: 112<br> Message: You may no longer adjust items in the trade because the trade has been confirmed.
     */
    ...
    /**
     * ID: 116<br> Message: You have entered a peaceful zone.
     */
    public static final SystemMessageId ENTER_PEACEFUL_ZONE;

    /**
     * ID: 117<br> Message: You have left the peaceful zone.
     */
    ...
    /**
     * ID: 122<br> Message: You may no longer adjust items in the trade because the trade has been confirmed.
     */
    ...
    /**
     * ID: 124<br> Message: $s1 has cancelled the trade.
     */
    public static final SystemMessageId S1_CANCELED_TRADE;

    /**
     * ID: 125<br> Message: Do you wish to exit the game?
     */
    public static final SystemMessageId WISH_EXIT_GAME;

    /**
     * ID: 126<br> Message: Do you wish to return to the character select screen?
     */
    public static final SystemMessageId WISH_RESTART_GAME;

    /**
     * ID: 127<br> Message: You have been disconnected from the server. Please login again.
     */
    public static final SystemMessageId DISCONNECTED_FROM_SERVER;

    /**
     * ID: 128<br> Message: Your character creation has failed.
     */
    ...
    /**
     * ID: 130<br> Message: Your warehouse is full.
     */
    public static final SystemMessageId WAREHOUSE_FULL;

    /**
     * ID: 131<br> Message: $s1 has logged in.
     */
    ...
    /**
     * ID: 135<br> Message: $s1 did not reply to your invitation. Your invitation has been cancelled.
     */
    public static final SystemMessageId S1_DID_NOT_REPLY_TO_YOUR_INVITE;

    /**
     * ID: 136<br> Message: You have not replied to $s1's invitation. The offer has been cancelled.
     */
    public static final SystemMessageId YOU_DID_NOT_REPLY_TO_S1_INVITE;

    /**
     * ID: 137<br> Message: There are no more items in the shortcut.
     */
    public static final SystemMessageId NO_MORE_ITEMS_SHORTCUT;

    /**
     * ID: 138<br> Message: Designate shortcut.
     */
    ...
    /**
     * ID: 141<br> Message: Once the trade is confirmed, the item cannot be moved again.
     */
    ...
    /**
     * ID: 143<br> Message: $s1 is already trading with another person. Please try again later.
     */
    ...
    /**
     * ID: 146<br> Message: Chatting is now permitted.
     */
    public static final SystemMessageId CHATTING_PERMITTED;

    /**
     * ID: 147<br> Message: Chatting is currently prohibited.
     */
    public static final SystemMessageId CHATTING_PROHIBITED;

    /**
     * ID: 148<br> Message: You cannot use quest items.
     */
    ...
    /**
     * ID: 150<br> Message: You cannot discard or destroy an item while trading at a private store.
     */
    ...
    /**
     * ID: 153<br> Message: $s1 is on another task. Please try again later.
     */
    ...
    /**
     * ID: 159<br> Message: You resisted $s1's magic.
     */
    public static final SystemMessageId RESISTED_S1_MAGIC;

    /**
     * ID: 160<br> Message: $s1 is a member of another party and cannot be invited.
     */
    ...
    /**
     * ID: 162<br> Message: Warehouse is too far.
     */
    public static final SystemMessageId WAREHOUSE_TOO_FAR;

    /**
     * ID: 163<br> Message: You cannot destroy it because the number is incorrect.
     */
    ...
    /**
     * ID: 166<br> Message: Friend list is not ready yet. Please register again later.
     */
    ...
    /**
     * ID: 168<br> Message: $s1 has sent a friend request.
     */
    public static final SystemMessageId S1_REQUESTED_TO_BECOME_FRIENDS;

    /**
     * ID: 169<br> Message: Accept friendship 0/1 (1 to accept, 0 to deny)
     */
    public static final SystemMessageId ACCEPT_THE_FRIENDSHIP;

    /**
     * ID: 170<br> Message: The user who requested to become friends is not found in the game.
     */
    ...
    /**
     * ID: 172<br> Message: You lack the funds needed to pay for this transaction.
     */
    public static final SystemMessageId LACK_FUNDS_FOR_TRANSACTION1;

    /**
     * ID: 173<br> Message: You lack the funds needed to pay for this transaction.
     */
    public static final SystemMessageId LACK_FUNDS_FOR_TRANSACTION2;

    /**
     * ID: 174<br> Message: That person's inventory is full.
     */
    public static final SystemMessageId OTHER_INVENTORY_FULL;

    /**
     * ID: 175<br> Message: That skill has been de-activated as HP was fully recovered.
     */
    ...
    /**
     * ID: 179<br> Message: You cannot discard those items here.
     */
    public static final SystemMessageId CANT_DISCARD_HERE;

    /**
     * ID: 180<br> Message: You have $s1 day(s) left until deletion. Do you wish to cancel this action?
     */
    ...
    /**
     * ID: 182<br> Message: Do you want to quit the current quest?
     */
    public static final SystemMessageId WANT_QUIT_CURRENT_QUEST;

    /**
     * ID: 183<br> Message: There are too many users on the server. Please try again later
     */
    public static final SystemMessageId TOO_MANY_USERS;

    /**
     * ID: 184<br> Message: Please try again later.
     */
    public static final SystemMessageId TRY_AGAIN_LATER;

    /**
     * ID: 185<br> Message: You must first select a user to invite to your party.
     */
    public static final SystemMessageId FIRST_SELECT_USER_TO_INVITE_TO_PARTY;

    /**
     * ID: 186<br> Message: You must first select a user to invite to your clan.
     */
    public static final SystemMessageId FIRST_SELECT_USER_TO_INVITE_TO_CLAN;

    /**
     * ID: 187<br> Message: Select user to expel.
     */
    public static final SystemMessageId SELECT_USER_TO_EXPEL;

    /**
     * ID: 188<br> Message: Please create your clan name.
     */
    ...
    /**
     * ID: 192<br> Message: You have failed to expel $s1 from the clan.
     */
    ...
    /**
     * ID: 194<br> Message: You have failed to disperse the clan.
     */
    ...
    /**
     * ID: 198<br> Message: You have failed to withdraw from the $s1 clan.
     */
    public static final SystemMessageId FAILED_TO_WITHDRAW_FROM_S1_CLAN;

    /**
     * ID: 199<br> Message: You have recently been dismissed from a clan. You are not allowed to join another clan for
     * 24-hours.
     */
    ...
    /**
     * ID: 201<br> Message: $s1 was expelled from the party.
     */
    public static final SystemMessageId S1_WAS_EXPELLED_FROM_PARTY;

    /**
     * ID: 202<br> Message: You have been expelled from the party.
     */
    ...
    /**
     * ID: 204<br> Message: Incorrect name. Please try again.
     */
    public static final SystemMessageId INCORRECT_NAME_TRY_AGAIN;

    /**
     * ID: 205<br> Message: Incorrect character name. Please try again.
     */
    public static final SystemMessageId INCORRECT_CHARACTER_NAME_TRY_AGAIN;

    /**
     * ID: 206<br> Message: Please enter the name of the clan you wish to declare war on.
     */
    public static final SystemMessageId ENTER_CLAN_NAME_TO_DECLARE_WAR;

    /**
     * ID: 207<br> Message: $s2 of the clan $s1 requests declaration of war. Do you accept?
     */
    public static final SystemMessageId S2_OF_THE_CLAN_S1_REQUESTS_WAR;

    /**
     * ID: 212<br> Message: You are not a clan member and cannot perform this action.
     */
    public static final SystemMessageId YOU_ARE_NOT_A_CLAN_MEMBER;

    /**
     * ID: 213<br> Message: Not working. Please try again later.
     */
    ...
    /**
     * ID: 219<br> Message: Your clan leader has died. You have been defeated by the $s1 clan.
     */
    public static final SystemMessageId YOU_WERE_DEFEATED_BY_S1_CLAN;

    /**
     * ID: 220<br> Message: You have $s1 minutes left until the clan war ends.
     */
    public static final SystemMessageId S1_MINUTES_LEFT_UNTIL_CLAN_WAR_ENDS;

    /**
     * ID: 221<br> Message: The time limit for the clan war is up. War with the $s1 clan is over.
     */
    ...
    /**
     * ID: 224<br> Message: $s1 did not respond: Invitation to the clan has been cancelled.
     */
    public static final SystemMessageId S1_DID_NOT_RESPOND_TO_CLAN_INVITATION;

    /**
     * ID: 225<br> Message: You didn't respond to $s1's invitation: joining has been cancelled.
     */
    public static final SystemMessageId YOU_DID_NOT_RESPOND_TO_S1_CLAN_INVITATION;

    /**
     * ID: 226<br> Message: The $s1 clan did not respond: war proclamation has been refused.
     */
    public static final SystemMessageId S1_CLAN_DID_NOT_RESPOND;

    /**
     * ID: 227<br> Message: Clan war has been refused because you did not respond to $s1 clan's war proclamation.
     */
    ...
    /**
     * ID: 229<br> Message: You do not meet the criteria in order to create a clan.
     */
    ...
    /**
     * ID: 231<br> Message: After a clan member is dismissed from a clan, the clan must wait at least a day before
     * accepting a new member.
     */
    public static final SystemMessageId YOU_MUST_WAIT_BEFORE_ACCEPTING_A_NEW_MEMBER;

    /**
     * ID: 232<br> Message: After leaving or having been dismissed from a clan, you must wait at least a day before
     * joining another clan.
     */
    public static final SystemMessageId YOU_MUST_WAIT_BEFORE_JOINING_ANOTHER_CLAN;

    /**
     * ID: 233<br> Message: The Academy/Royal Guard/Order of Knights is full and cannot accept new members at this
     * time.
     */
    ...
    /**
     * ID: 235<br> Message: You are not authorized to bestow these rights.
     */
    public static final SystemMessageId NOT_AUTHORIZED_TO_BESTOW_RIGHTS;

    /**
     * ID: 236<br> Message: Only the clan leader is enabled.
     */
    public static final SystemMessageId ONLY_THE_CLAN_LEADER_IS_ENABLED;

    /**
     * ID: 237<br> Message: The clan leader could not be found.
     */
    public static final SystemMessageId CLAN_LEADER_NOT_FOUND;

    /**
     * ID: 238<br> Message: Not joined in any clan.
     */
    ...
    /**
     * ID: 240<br> Message: Currently involved in clan war.
     */
    public static final SystemMessageId CURRENTLY_INVOLVED_IN_CLAN_WAR;

    /**
     * ID: 241<br> Message: Leader of the $s1 Clan is not logged in.
     */
    public static final SystemMessageId LEADER_OF_S1_CLAN_NOT_FOUND;

    /**
     * ID: 242<br> Message: Select target.
     */
    public static final SystemMessageId SELECT_TARGET;

    /**
     * ID: 243<br> Message: You cannot declare war on an allied clan.
     */
    public static final SystemMessageId CANNOT_DECLARE_WAR_ON_ALLIED_CLAN;

    /**
     * ID: 244<br> Message: You are not allowed to issue this challenge.
     */
    public static final SystemMessageId NOT_ALLOWED_TO_CHALLENGE;

    /**
     * ID: 245<br> Message: 5 days has not passed since you were refused war. Do you wish to continue?
     */
    public static final SystemMessageId FIVE_DAYS_NOT_PASSED_SINCE_REFUSED_WAR;

    /**
     * ID: 246<br> Message: That clan is currently at war.
     */
    public static final SystemMessageId CLAN_CURRENTLY_AT_WAR;

    /**
     * ID: 247<br> Message: You have already been at war with the $s1 clan: 5 days must pass before you can challenge
     * this clan again
     */
    public static final SystemMessageId FIVE_DAYS_MUST_PASS_BEFORE_CHALLENGE_S1_AGAIN;

    /**
     * ID: 248<br> Message: You cannot proclaim war: the $s1 clan does not have enough members.
     */
    public static final SystemMessageId S1_CLAN_NOT_ENOUGH_MEMBERS_FOR_WAR;

    /**
     * ID: 249<br> Message: Do you wish to surrender to the $s1 clan?
     */
    public static final SystemMessageId WISH_SURRENDER_TO_S1_CLAN;

    /**
     * ID: 250<br> Message: You have personally surrendered to the $s1 clan. You are no longer participating in this
     * clan war.
     */
    public static final SystemMessageId YOU_HAVE_PERSONALLY_SURRENDERED_TO_THE_S1_CLAN;

    /**
     * ID: 251<br> Message: You cannot proclaim war: you are at war with another clan.
     */
    public static final SystemMessageId ALREADY_AT_WAR_WITH_ANOTHER_CLAN;

    /**
     * ID: 252<br> Message: Enter the clan name to surrender to.
     */
    public static final SystemMessageId ENTER_CLAN_NAME_TO_SURRENDER_TO;

    /**
     * ID: 253<br> Message: Enter the name of the clan you wish to end the war with.
     */
    public static final SystemMessageId ENTER_CLAN_NAME_TO_END_WAR;

    /**
     * ID: 254<br> Message: A clan leader cannot personally surrender.
     */
    public static final SystemMessageId LEADER_CANT_PERSONALLY_SURRENDER;

    /**
     * ID: 255<br> Message: The $s1 clan has requested to end war. Do you agree?
     */
    public static final SystemMessageId S1_CLAN_REQUESTED_END_WAR;

    /**
     * ID: 256<br> Message: Enter title
     */
    public static final SystemMessageId ENTER_TITLE;

    /**
     * ID: 257<br> Message: Do you offer the $s1 clan a proposal to end the war?
     */
    public static final SystemMessageId DO_YOU_OFFER_S1_CLAN_END_WAR;

    /**
     * ID: 258<br> Message: You are not involved in a clan war.
     */
    public static final SystemMessageId NOT_INVOLVED_CLAN_WAR;

    /**
     * ID: 259<br> Message: Select clan members from list.
     */
    public static final SystemMessageId SELECT_MEMBERS_FROM_LIST;

    /**
     * ID: 260<br> Message: Fame level has decreased: 5 days have not passed since you were refused war
     */
    ...
    /**
     * ID: 263<br> Message: You have already requested the dissolution of your clan.
     */
    ...
    /**
     * ID: 265<br> Message: You cannot dissolve a clan during a siege or while protecting a castle.
     */
    public static final SystemMessageId CANNOT_DISSOLVE_WHILE_IN_SIEGE;

    /**
     * ID: 266<br> Message: You cannot dissolve a clan while owning a clan hall or castle.
     */
    public static final SystemMessageId CANNOT_DISSOLVE_WHILE_OWNING_CLAN_HALL_OR_CASTLE;

    /**
     * ID: 267<br> Message: There are no requests to disperse.
     */
    public static final SystemMessageId NO_REQUESTS_TO_DISPERSE;

    /**
     * ID: 268<br> Message: That player already belongs to another clan.
     */
    ...
    /**
     * ID: 270<br> Message: You have already surrendered.
     */
    public static final SystemMessageId YOU_HAVE_ALREADY_SURRENDERED;

    /**
     * ID: 271<br> Message: A player can only be granted a title if the clan is level 3 or above
     */
    public static final SystemMessageId CLAN_LVL_3_NEEDED_TO_ENDOWE_TITLE;

    /**
     * ID: 272<br> Message: A clan crest can only be registered when the clan's skill level is 3 or above.
     */
    public static final SystemMessageId CLAN_LVL_3_NEEDED_TO_SET_CREST;

    /**
     * ID: 273<br> Message: A clan war can only be declared when a clan's skill level is 3 or above.
     */
    ...
    /**
     * ID: 275<br> Message: Clan has failed to increase skill level.
     */
    public static final SystemMessageId CLAN_LEVEL_INCREASE_FAILED;

    /**
     * ID: 276<br> Message: You do not have the necessary materials or prerequisites to learn this skill.
     */
    ...
    /**
     * ID: 280<br> Message: You do not have any items to sell.
     */
    public static final SystemMessageId NO_ITEMS_TO_SELL;

    /**
     * ID: 281<br> Message: You do not have enough adena to pay the fee.
     */
    ...
    /**
     * ID: 285<br> Message: Clan $s1 has succeeded in engraving the ruler!
     */
    public static final SystemMessageId CLAN_S1_ENGRAVED_RULER;

    /**
     * ID: 286<br> Message: Your base is being attacked.
     */
    public static final SystemMessageId BASE_UNDER_ATTACK;

    /**
     * ID: 287<br> Message: The opposing clan has started to engrave the monument!
     */
    public static final SystemMessageId OPPONENT_STARTED_ENGRAVING;

    /**
     * ID: 288<br> Message: The castle gate has been broken down.
     */
    public static final SystemMessageId CASTLE_GATE_BROKEN_DOWN;

    /**
     * ID: 289<br> Message: An outpost or headquarters cannot be built because at least one already exists.
     */
    public static final SystemMessageId NOT_ANOTHER_HEADQUARTERS;

    /**
     * ID: 290<br> Message: You cannot set up a base here.
     */
    public static final SystemMessageId NOT_SET_UP_BASE_HERE;

    /**
     * ID: 291<br> Message: Clan $s1 is victorious over $s2's castle siege!
     */
    public static final SystemMessageId CLAN_S1_VICTORIOUS_OVER_S2_S_SIEGE;

    /**
     * ID: 292<br> Message: $s1 has announced the castle siege time.
     */
    public static final SystemMessageId S1_ANNOUNCED_SIEGE_TIME;

    /**
     * ID: 293<br> Message: The registration term for $s1 has ended.
     */
    public static final SystemMessageId REGISTRATION_TERM_FOR_S1_ENDED;

    /**
     * ID: 294<br> Message: Because your clan is not currently on the offensive in a Clan Hall siege war, it cannot
     * summon its base camp.
     */
    ...
    /**
     * ID: 295<br> Message: $s1's siege was canceled because there were no clans that participated.
     */
    ...
    /**
     * ID: 297<br> Message: You have taken $s1 damage because you were unable to breathe.
     */
    ...
    /**
     * ID: 311<br> Message: The clan war declaration has been accepted.
     */
    public static final SystemMessageId CLAN_WAR_DECLARATION_ACCEPTED;

    /**
     * ID: 312<br> Message: The clan war declaration has been refused.
     */
    public static final SystemMessageId CLAN_WAR_DECLARATION_REFUSED;

    /**
     * ID: 313<br> Message: The cease war request has been accepted.
     */
    public static final SystemMessageId CEASE_WAR_REQUEST_ACCEPTED;

    /**
     * ID: 314<br> Message: You have failed to surrender.
     */
    public static final SystemMessageId FAILED_TO_SURRENDER;

    /**
     * ID: 315<br> Message: You have failed to personally surrender.
     */
    public static final SystemMessageId FAILED_TO_PERSONALLY_SURRENDER;

    /**
     * ID: 316<br> Message: You have failed to withdraw from the party.
     */
    public static final SystemMessageId FAILED_TO_WITHDRAW_FROM_THE_PARTY;

    /**
     * ID: 317<br> Message: You have failed to expel the party member.
     */
    public static final SystemMessageId FAILED_TO_EXPEL_THE_PARTY_MEMBER;

    /**
     * ID: 318<br> Message: You have failed to disperse the party.
     */
    ...
    /**
     * ID: 321<br> Message: It is not locked.
     */
    public static final SystemMessageId ITS_NOT_LOCKED;

    /**
     * ID: 322<br> Message: Please decide on the sales price.
     */
    ...
    /**
     * ID: 325<br> Message: The corpse has already disappeared.
     */
    public static final SystemMessageId CORPSE_ALREADY_DISAPPEARED;

    /**
     * ID: 326<br> Message: Select target from list.
     */
    public static final SystemMessageId SELECT_TARGET_FROM_LIST;

    /**
     * ID: 327<br> Message: You cannot exceed 80 characters.
     */
    public static final SystemMessageId CANNOT_EXCEED_80_CHARACTERS;

    /**
     * ID: 328<br> Message: Please input title using less than 128 characters.
     */
    public static final SystemMessageId PLEASE_INPUT_TITLE_LESS_128_CHARACTERS;

    /**
     * ID: 329<br> Message: Please input content using less than 3000 characters.
     */
    public static final SystemMessageId PLEASE_INPUT_CONTENT_LESS_3000_CHARACTERS;

    /**
     * ID: 330<br> Message: A one-line response may not exceed 128 characters.
     */
    public static final SystemMessageId ONE_LINE_RESPONSE_NOT_EXCEED_128_CHARACTERS;

    /**
     * ID: 331<br> Message: You have acquired $s1 SP.
     */
    public static final SystemMessageId ACQUIRED_S1_SP;

    /**
     * ID: 332<br> Message: Do you want to be restored?
     */
    public static final SystemMessageId DO_YOU_WANT_TO_BE_RESTORED;

    /**
     * ID: 333<br> Message: You have received $s1 damage by Core's barrier.
     */
    public static final SystemMessageId S1_DAMAGE_BY_CORE_BARRIER;

    /**
     * ID: 334<br> Message: Please enter your private store display message.
     */
    public static final SystemMessageId ENTER_PRIVATE_STORE_MESSAGE;

    /**
     * ID: 335<br> Message: $s1 has been aborted.
     */
    public static final SystemMessageId S1_HAS_BEEN_ABORTED;

    /**
     * ID: 336<br> Message: You are attempting to crystallize $s1. Do you wish to continue?
     */
    public static final SystemMessageId WISH_TO_CRYSTALLIZE_S1;

    /**
     * ID: 337<br> Message: The soulshot you are attempting to use does not match the grade of your equipped weapon.
     */
    ...
    /**
     * ID: 340<br> Message: Your private store is now open for business.
     */
    public static final SystemMessageId PRIVATE_STORE_UNDER_WAY;

    /**
     * ID: 341<br> Message: You do not have enough materials to perform that action.
     */
    ...
    /**
     * ID: 354<br> Message: Cancel enchant.
     */
    ...
    /**
     * ID: 356<br> Message: Reject resurrection.
     */
    ...
    /**
     * ID: 358<br> Message: $s1 hour(s) until castle siege conclusion.
     */
    public static final SystemMessageId S1_HOURS_UNTIL_SIEGE_CONCLUSION;

    /**
     * ID: 359<br> Message: $s1 minute(s) until castle siege conclusion.
     */
    public static final SystemMessageId S1_MINUTES_UNTIL_SIEGE_CONCLUSION;

    /**
     * ID: 360<br> Message: Castle siege $s1 second(s) left!
     */
    ...
    /**
     * ID: 362<br> Message: You have acquired $s1 bonus experience from a successful over-hit.
     */
    public static final SystemMessageId ACQUIRED_BONUS_EXPERIENCE_THROUGH_OVER_HIT;

    /**
     * ID: 363<br> Message: Chat available time: $s1 minute.
     */
    public static final SystemMessageId CHAT_AVAILABLE_S1_MINUTE;

    /**
     * ID: 364<br> Message: Enter user's name to search
     */
    public static final SystemMessageId ENTER_USER_NAME_TO_SEARCH;

    /**
     * ID: 365<br> Message: Are you sure?
     */
    public static final SystemMessageId ARE_YOU_SURE;

    /**
     * ID: 366<br> Message: Please select your hair color.
     */
    public static final SystemMessageId PLEASE_SELECT_HAIR_COLOR;

    /**
     * ID: 367<br> Message: You cannot remove that clan character at this time.
     */
    ...
    /**
     * ID: 370<br> Message: Failed to pickup $s1.
     */
    ...
    /**
     * ID: 372<br> Message: Failed to earn $s1.
     */
    public static final SystemMessageId FAILED_EARN_S1;

    /**
     * ID: 373<br> Message: You are trying to destroy +$s1 $s2. Do you wish to continue?
     */
    public static final SystemMessageId WISH_DESTROY_S1_S2;

    /**
     * ID: 374<br> Message: You are attempting to crystallize +$s1 $s2. Do you wish to continue?
     */
    public static final SystemMessageId WISH_CRYSTALLIZE_S1_S2;

    /**
     * ID: 375<br> Message: You have dropped +$s1 $s2 .
     */
    public static final SystemMessageId DROPPED_S1_S2;

    /**
     * ID: 376<br> Message: $s1 has obtained +$s2$s3.
     */
    public static final SystemMessageId S1_OBTAINED_S2_S3;

    /**
     * ID: 377<br> Message: $S1 $S2 disappeared.
     */
    ...
    /**
     * ID: 381<br> Message: The game client encountered an error and was unable to connect to the petition server.
     */
    public static final SystemMessageId GAME_CLIENT_UNABLE_TO_CONNECT_TO_PETITION_SERVER;

    /**
     * ID: 382<br> Message: Currently there are no users that have checked out a GM ID.
     */
    public static final SystemMessageId NO_USERS_CHECKED_OUT_GM_ID;

    /**
     * ID: 383<br> Message: Request confirmed to end consultation at petition server.
     */
    public static final SystemMessageId REQUEST_CONFIRMED_TO_END_CONSULTATION;

    /**
     * ID: 384<br> Message: The client is not logged onto the game server.
     */
    public static final SystemMessageId CLIENT_NOT_LOGGED_ONTO_GAME_SERVER;

    /**
     * ID: 385<br> Message: Request confirmed to begin consultation at petition server.
     */
    public static final SystemMessageId REQUEST_CONFIRMED_TO_BEGIN_CONSULTATION;

    /**
     * ID: 386<br> Message: The body of your petition must be more than five characters in length.
     */
    public static final SystemMessageId PETITION_MORE_THAN_FIVE_CHARACTERS;

    /**
     * ID: 387<br> Message: This ends the GM petition consultation. Please take a moment to provide feedback about this
     * service.
     */
    ...
    /**
     * ID: 389<br> Message: Your petition application has been accepted. - Receipt No. is $s1.
     */
    ...
    /**
     * ID: 392<br> Message: Under petition advice.
     */
    ...
    /**
     * ID: 396<br> Message: Please login after changing your temporary password.
     */
    public static final SystemMessageId TRY_AGAIN_AFTER_CHANGING_PASSWORD;

    /**
     * ID: 397<br> Message: Not a paid account.
     */
    public static final SystemMessageId NO_PAID_ACCOUNT;

    /**
     * ID: 398<br> Message: There is no time left on this account.
     */
    ...
    /**
     * ID: 400<br> Message: You are attempting to drop $s1. Dou you wish to continue?
     */
    public static final SystemMessageId WISH_TO_DROP_S1;

    /**
     * ID: 401<br> Message: You have to many ongoing quests.
     */
    public static final SystemMessageId TOO_MANY_QUESTS;

    /**
     * ID: 402<br> Message: You do not possess the correct ticket to board the boat.
     */
    public static final SystemMessageId NOT_CORRECT_BOAT_TICKET;

    /**
     * ID: 403<br> Message: You have exceeded your out-of-pocket adena limit.
     */
    public static final SystemMessageId EXCEECED_POCKET_ADENA_LIMIT;

    /**
     * ID: 404<br> Message: Your Create Item level is too low to register this recipe.
     */
    public static final SystemMessageId CREATE_LVL_TOO_LOW_TO_REGISTER;

    /**
     * ID: 405<br> Message: The total price of the product is too high.
     */
    ...
    /**
     * ID: 419<br> Message: $s1 minute(s) of usage time left.
     */
    public static final SystemMessageId S1_MINUTES_USAGE_LEFT;

    /**
     * ID: 420<br> Message: Time expired.
     */
    public static final SystemMessageId TIME_EXPIRED;

    /**
     * ID: 421<br> Message: Another person has logged in with the same account.
     */
    ...
    /**
     * ID: 424<br> Message: Does not fit strengthening conditions of the scroll.
     */
    public static final SystemMessageId DOES_NOT_FIT_SCROLL_CONDITIONS;

    /**
     * ID: 425<br> Message: Your Create Item level is too low to register this recipe.
     */
    public static final SystemMessageId CREATE_LVL_TOO_LOW_TO_REGISTER2;

    /**
     * ID: 445<br> Message: (Reference Number Regarding Membership Withdrawal Request: $s1)
     */
    ...
    /**
     * ID: 448<br> Message: There is a system error. Please log in again later.
     */
    public static final SystemMessageId SYSTEM_ERROR_LOGIN_LATER;

    /**
     * ID: 449<br> Message: The password you have entered is incorrect.
     */
    public static final SystemMessageId PASSWORD_ENTERED_INCORRECT1;

    /**
     * ID: 450<br> Message: Confirm your account information and log in later.
     */
    public static final SystemMessageId CONFIRM_ACCOUNT_LOGIN_LATER;

    /**
     * ID: 451<br> Message: The password you have entered is incorrect.
     */
    public static final SystemMessageId PASSWORD_ENTERED_INCORRECT2;

    /**
     * ID: 452<br> Message: Please confirm your account information and try logging in later.
     */
    public static final SystemMessageId PLEASE_CONFIRM_ACCOUNT_LOGIN_LATER;

    /**
     * ID: 453<br> Message: Your account information is incorrect.
     */
    public static final SystemMessageId ACCOUNT_INFORMATION_INCORRECT;

    /**
     * ID: 455<br> Message: Account is already in use. Unable to log in.
     */
    public static final SystemMessageId ACCOUNT_IN_USE;

    /**
     * ID: 456<br> Message: Lineage II game services may be used by individuals 15 years of age or older except for PvP
    ...
    /**
     * ID: 457<br> Message: Currently undergoing game server maintenance. Please log in again later.
     */
    public static final SystemMessageId SERVER_MAINTENANCE;

    /**
     * ID: 458<br> Message: Your usage term has expired.
     */
    public static final SystemMessageId USAGE_TERM_EXPIRED;

    /**
     * ID: 460<br> Message: to reactivate your account.
     */
    public static final SystemMessageId TO_REACTIVATE_YOUR_ACCOUNT;

    /**
     * ID: 461<br> Message: Access failed.
     */
    public static final SystemMessageId ACCESS_FAILED;

    /**
     * ID: 461<br> Message: Please try again later.
     */
    ...
    /**
     * ID: 467<br> Message: You may not accept any clan within a day after expelling another clan.
     */
    public static final SystemMessageId CANT_INVITE_CLAN_WITHIN_1_DAY;

    /**
     * ID: 468<br> Message: A clan that has withdrawn or been expelled cannot enter into an alliance within one day of
     * withdrawal or expulsion.
     */
    public static final SystemMessageId CANT_ENTER_ALLIANCE_WITHIN_1_DAY;

    /**
     * ID: 469<br> Message: You may not ally with a clan you are currently at war with. That would be diabolical and
     * treacherous.
     */
    public static final SystemMessageId MAY_NOT_ALLY_CLAN_BATTLE;

    /**
     * ID: 470<br> Message: Only the clan leader may apply for withdrawal from the alliance.
     */
    ...
    /**
     * ID: 472<br> Message: You cannot expel yourself from the clan.
     */
    ...
    /**
     * ID: 475<br> Message: Different alliance.
     */
    public static final SystemMessageId DIFFERENT_ALLIANCE2;

    /**
     * ID: 476<br> Message: Please adjust the image size to 8x12.
     */
    public static final SystemMessageId ADJUST_IMAGE_8_12;

    /**
     * ID: 477<br> Message: No response. Invitation to join an alliance has been cancelled.
     */
    public static final SystemMessageId NO_RESPONSE_TO_ALLY_INVITATION;

    /**
     * ID: 478<br> Message: No response. Your entrance to the alliance has been cancelled.
     */
    ...
    /**
     * ID: 480<br> Message: Please check your friend list.
     */
    ...
    /**
     * ID: 483<br> Message: This function is inaccessible right now. Please try again later.
     */
    public static final SystemMessageId FUNCTION_INACCESSIBLE_NOW;

    /**
     * ID: 484<br> Message: This player is already registered in your friends list.
     */
    ...
    /**
     * ID: 505<br> Message: You cannot create a new alliance within 10 days after dissolution.
     */
    ...
    /**
     * ID: 509<br> Message: Cannot accept. clan ally is registered as an enemy during siege battle.
     */
    ...
    /**
     * ID: 525<br> Message: You have succeeded in inviting a friend to your friends list.
     */
    public static final SystemMessageId YOU_HAVE_SUCCEEDED_INVITING_FRIEND;

    /**
     * ID: 526<br> Message: You have failed to add a friend to your friends list.
     */
    ...
    /**
     * ID: 534<br> Message: Power of Mana disabled.
     */
    public static final SystemMessageId DISABLED_SPIRITSHOT;

    /**
     * ID: 536<br> Message: How much adena do you wish to transfer to your Inventory?
     */
    public static final SystemMessageId HOW_MUCH_ADENA_TRANSFER;

    /**
     * ID: 537<br> Message: How much will you transfer?
     */
    ...
    /**
     * ID: 540<br> Message: Clan leaders may not be deleted. Dissolve the clan first and try again.
     */
    public static final SystemMessageId CLAN_LEADERS_MAY_NOT_BE_DELETED;

    /**
     * ID: 541<br> Message: You may not delete a clan member. Withdraw from the clan first and try again.
     */
    public static final SystemMessageId CLAN_MEMBER_MAY_NOT_BE_DELETED;

    /**
     * ID: 542<br> Message: The NPC server is currently down. Pets and servitors cannot be summoned at this time.
     */
    ...
    /**
     * ID: 545<br> Message: Your pet cannot carry any more items. Remove some, then try again.
     */
    public static final SystemMessageId YOUR_PET_CANNOT_CARRY_ANY_MORE_ITEMS;

    /**
     * ID: 546<br> Message: Unable to place item, your pet is too encumbered.
     */
    ...
    /**
     * ID: 549<br> Message: To create an alliance, your clan must be Level 5 or higher.
     */
    public static final SystemMessageId TO_CREATE_AN_ALLY_YOU_CLAN_MUST_BE_LEVEL_5_OR_HIGHER;

    /**
     * ID: 550<br> Message: You may not create an alliance during the term of dissolution postponement.
     */
    public static final SystemMessageId YOU_MAY_NOT_CREATE_ALLY_WHILE_DISSOLVING;

    /**
     * ID: 551<br> Message: You cannot raise your clan level during the term of dispersion postponement.
     */
    public static final SystemMessageId CANNOT_RISE_LEVEL_WHILE_DISSOLUTION_IN_PROGRESS;

    /**
     * ID: 552<br> Message: During the grace period for dissolving a clan, the registration or deletion of a clan's
     * crest is not allowed.
     */
    public static final SystemMessageId CANNOT_SET_CREST_WHILE_DISSOLUTION_IN_PROGRESS;

    /**
     * ID: 553<br> Message: The opposing clan has applied for dispersion.
     */
    ...
    /**
     * ID: 555<br> Message: You cannot move - you are too encumbered
     */
    public static final SystemMessageId CANT_MOVE_TOO_ENCUMBERED;

    /**
     * ID: 556<br> Message: You cannot move in this state
     */
    public static final SystemMessageId CANT_MOVE_IN_THIS_STATE;

    /**
     * ID: 557<br> Message: Your pet has been summoned and may not be destroyed
     */
    public static final SystemMessageId PET_SUMMONED_MAY_NOT_DESTROYED;

    /**
     * ID: 558<br> Message: Your pet has been summoned and may not be let go.
     */
    ...
    /**
     * ID: 562<br> Message: You may not crystallize this item. Your crystallization skill level is too low.
     */
    public static final SystemMessageId CRYSTALLIZE_LEVEL_TOO_LOW;

    /**
     * ID: 563<br> Message: Failed to disable attack target.
     */
    public static final SystemMessageId FAILED_DISABLE_TARGET;

    /**
     * ID: 564<br> Message: Failed to change attack target.
     */
    public static final SystemMessageId FAILED_CHANGE_TARGET;

    /**
     * ID: 565<br> Message: Not enough luck.
     */
    public static final SystemMessageId NOT_ENOUGH_LUCK;

    /**
     * ID: 566<br> Message: Your confusion spell failed.
     */
    public static final SystemMessageId CONFUSION_FAILED;

    /**
     * ID: 567<br> Message: Your fear spell failed.
     */
    ...
    /**
     * ID: 572<br> Message: Do you accept $s1's party invitation? (Item Distribution: Finders Keepers.)
     */
    public static final SystemMessageId S1_INVITED_YOU_TO_PARTY_FINDERS_KEEPERS;

    /**
     * ID: 573<br> Message: Do you accept $s1's party invitation? (Item Distribution: Random.)
     */
    ...
    /**
     * ID: 575<br> Message: How much adena do you wish to transfer to your pet?
     */
    public static final SystemMessageId HOW_MUCH_ADENA_TRANSFER_TO_PET;

    /**
     * ID: 576<br> Message: How much do you wish to transfer?
     */
    public static final SystemMessageId HOW_MUCH_TRANSFER2;

    /**
     * ID: 577<br> Message: You cannot summon during a trade or while using the private shops.
     */
    ...
    /**
     * ID: 580<br> Message: You may not use multiple pets or servitors at the same time.
     */
    ...
    /**
     * ID: 585<br> Message: Please decide on the price.
     */
    public static final SystemMessageId DECIDE_ON_PRICE;

    /**
     * ID: 586<br> Message: Pet items cannot be registered as shortcuts.
     */
    public static final SystemMessageId PET_NO_SHORTCUT;

    /**
     * ID: 588<br> Message: Your pet's inventory is full.
     */
    ...
    /**
     * ID: 590<br> Message: Your pet is motionless and any attempt you make to give it something goes unrecognized.
     */
    ...
    /**
     * ID: 592<br> Message: Do you wish to dismiss your pet? Dismissing your pet will cause the pet necklace to
     * disappear
     */
    public static final SystemMessageId WISH_TO_DISMISS_PET;

    /**
     * ID: 593<br> Message: Starving, grumpy and fed up, your pet has left.
     */
    ...
    /**
     * ID: 595<br> Message: Your pet is very hungry.
     */
    public static final SystemMessageId YOUR_PET_IS_VERY_HUNGRY;

    /**
     * ID: 596<br> Message: Your pet ate a little, but is still hungry.
     */
    public static final SystemMessageId YOUR_PET_ATE_A_LITTLE_BUT_IS_STILL_HUNGRY;

    /**
     * ID: 597<br> Message: Your pet is very hungry. Please be careful.
     */
    public static final SystemMessageId YOUR_PET_IS_VERY_HUNGRY_PLEASE_BE_CAREFUL;

    /**
     * ID: 598<br> Message: You may not chat while you are invisible.
     */
    public static final SystemMessageId NOT_CHAT_WHILE_INVISIBLE;

    /**
     * ID: 599<br> Message: The GM has an important notice. Chat has been temporarily disabled.
     */
    ...
    /**
     * ID: 601<br> Message: There are $S1 petitions currently on the waiting list.
     */
    public static final SystemMessageId S1_PETITION_ON_WAITING_LIST;

    /**
     * ID: 602<br> Message: The petition system is currently unavailable. Please try again later.
     */
    ...
    /**
     * ID: 604<br> Message: You may not call forth a pet or summoned creature from this location
     */
    public static final SystemMessageId NOT_CALL_PET_FROM_THIS_LOCATION;

    /**
     * ID: 605<br> Message: You may register up to 64 people on your list.
     */
    public static final SystemMessageId MAY_REGISTER_UP_TO_64_PEOPLE;

    /**
     * ID: 606<br> Message: You cannot be registered because the other person has already registered 64 people on
     * his/her list.
     */
    public static final SystemMessageId OTHER_PERSON_ALREADY_64_PEOPLE;

    /**
     * ID: 607<br> Message: You do not have any further skills to learn. Come back when you have reached Level $s1.
     */
    ...
    /**
     * ID: 611<br> Message: You have succeeded in Confusing the enemy.
     */
    ...
    /**
     * ID: 613<br> Message: ======<Ignore List>======
     */
    public static final SystemMessageId BLOCK_LIST_HEADER;

    /**
     * ID: 614<br> Message: $s1 : $s2
     */
    public static final SystemMessageId S1_S2;

    /**
     * ID: 615<br> Message: You have failed to register the user to your Ignore List.
     */
    public static final SystemMessageId FAILED_TO_REGISTER_TO_IGNORE_LIST;

    /**
     * ID: 616<br> Message: You have failed to delete the character.
     */
    ...
    /**
     * ID: 620<br> Message: $s1 has placed you on his/her Ignore List.
     */
    public static final SystemMessageId S1_HAS_ADDED_YOU_TO_IGNORE_LIST2;

    /**
     * ID: 621<br> Message: Game connection attempted through a restricted IP.
     */
    public static final SystemMessageId CONNECTION_RESTRICTED_IP;

    /**
     * ID: 622<br> Message: You may not make a declaration of war during an alliance battle.
     */
    public static final SystemMessageId NO_WAR_DURING_ALLY_BATTLE;

    /**
     * ID: 623<br> Message: Your opponent has exceeded the number of simultaneous alliance battles alllowed.
     */
    public static final SystemMessageId OPPONENT_TOO_MUCH_ALLY_BATTLES1;

    /**
     * ID: 624<br> Message: $s1 Clan leader is not currently connected to the game server.
     */
    public static final SystemMessageId S1_LEADER_NOT_CONNECTED;

    /**
     * ID: 625<br> Message: Your request for Alliance Battle truce has been denied.
     */
    public static final SystemMessageId ALLY_BATTLE_TRUCE_DENIED;

    /**
     * ID: 626<br> Message: The $s1 clan did not respond: war proclamation has been refused.
     */
    public static final SystemMessageId WAR_PROCLAMATION_HAS_BEEN_REFUSED;

    /**
     * ID: 627<br> Message: Clan battle has been refused because you did not respond to $s1 clan's war proclamation.
     */
    public static final SystemMessageId YOU_REFUSED_CLAN_WAR_PROCLAMATION;

    /**
     * ID: 628<br> Message: You have already been at war with the $s1 clan: 5 days must pass before you can declare war
     * again.
     */
    public static final SystemMessageId ALREADY_AT_WAR_WITH_S1_WAIT_5_DAYS;

    /**
     * ID: 629<br> Message: Your opponent has exceeded the number of simultaneous alliance battles alllowed.
     */
    public static final SystemMessageId OPPONENT_TOO_MUCH_ALLY_BATTLES2;

    /**
     * ID: 630<br> Message: War with the clan has begun.
     */
    public static final SystemMessageId WAR_WITH_CLAN_BEGUN;

    /**
     * ID: 631<br> Message: War with the clan is over.
     */
    public static final SystemMessageId WAR_WITH_CLAN_ENDED;

    /**
     * ID: 632<br> Message: You have won the war over the clan!
     */
    public static final SystemMessageId WON_WAR_OVER_CLAN;

    /**
     * ID: 633<br> Message: You have surrendered to the clan.
     */
    public static final SystemMessageId SURRENDERED_TO_CLAN;

    /**
     * ID: 634<br> Message: Your alliance leader has been slain. You have been defeated by the clan.
     */
    public static final SystemMessageId DEFEATED_BY_CLAN;

    /**
     * ID: 635<br> Message: The time limit for the clan war has been exceeded. War with the clan is over.
     */
    public static final SystemMessageId TIME_UP_WAR_OVER;

    /**
     * ID: 636<br> Message: You are not involved in a clan war.
     */
    public static final SystemMessageId NOT_INVOLVED_IN_WAR;

    /**
     * ID: 637<br> Message: A clan ally has registered itself to the opponent.
     */
    public static final SystemMessageId ALLY_REGISTERED_SELF_TO_OPPONENT;

    /**
     * ID: 638<br> Message: You have already requested a Siege Battle.
     */
    public static final SystemMessageId ALREADY_REQUESTED_SIEGE_BATTLE;

    /**
     * ID: 639<br> Message: Your application has been denied because you have already submitted a request for another
     * Siege Battle.
     */
    ...
    /**
     * ID: 642<br> Message: You are already registered to the attacker side and must not cancel your registration before
     * submitting your request
     */
    public static final SystemMessageId ALREADY_ATTACKER_NOT_CANCEL;

    /**
     * ID: 643<br> Message: You are already registered to the defender side and must not cancel your registration before
     * submitting your request
     */
    public static final SystemMessageId ALREADY_DEFENDER_NOT_CANCEL;

    /**
     * ID: 644<br> Message: You are not yet registered for the castle siege.
     */
    public static final SystemMessageId NOT_REGISTERED_FOR_SIEGE;

    /**
     * ID: 645<br> Message: Only clans of level 4 or higher may register for a castle siege.
     */
    ...
    /**
     * ID: 648<br> Message: No more registrations may be accepted for the attacker side.
     */
    public static final SystemMessageId ATTACKER_SIDE_FULL;

    /**
     * ID: 649<br> Message: No more registrations may be accepted for the defender side.
     */
    ...
    /**
     * ID: 651<br> Message: Place $s1 in the current location and direction. Do you wish to continue?
     */
    public static final SystemMessageId PLACE_S1_IN_CURRENT_LOCATION_AND_DIRECTION;

    /**
     * ID: 652<br> Message: The target of the summoned monster is wrong.
     */
    public static final SystemMessageId TARGET_OF_SUMMON_WRONG;

    /**
     * ID: 653<br> Message: You do not have the authority to position mercenaries.
     */
    public static final SystemMessageId YOU_DO_NOT_HAVE_AUTHORITY_TO_POSITION_MERCENARIES;

    /**
     * ID: 654<br> Message: You do not have the authority to cancel mercenary positioning.
     */
    public static final SystemMessageId YOU_DO_NOT_HAVE_AUTHORITY_TO_CANCEL_MERCENARY_POSITIONING;

    /**
     * ID: 655<br> Message: Mercenaries cannot be positioned here.
     */
    public static final SystemMessageId MERCENARIES_CANNOT_BE_POSITIONED_HERE;

    /**
     * ID: 656<br> Message: This mercenary cannot be positioned anymore.
     */
    public static final SystemMessageId THIS_MERCENARY_CANNOT_BE_POSITIONED_ANYMORE;

    /**
     * ID: 657<br> Message: Positioning cannot be done here because the distance between mercenaries is too short.
     */
    public static final SystemMessageId POSITIONING_CANNOT_BE_DONE_BECAUSE_DISTANCE_BETWEEN_MERCENARIES_TOO_SHORT;

    /**
     * ID: 658<br> Message: This is not a mercenary of a castle that you own and so you cannot cancel its positioning.
     */
    public static final SystemMessageId THIS_IS_NOT_A_MERCENARY_OF_A_CASTLE_THAT_YOU_OWN_AND_SO_CANNOT_CANCEL_POSITIONING;

    /**
     * ID: 659<br> Message: This is not the time for siege registration and so registrations cannot be accepted or
     * rejected.
     */
    public static final SystemMessageId NOT_SIEGE_REGISTRATION_TIME1;

    /**
     * ID: 659<br> Message: This is not the time for siege registration and so registration and cancellation cannot be
     * done.
     */
    ...
    /**
     * ID: 664<br> Message: Please choose a person to receive.
     */
    public static final SystemMessageId CHOOSE_PERSON_TO_RECEIVE;

    /**
     * ID: 665<br> Message: of alliance is applying for alliance war. Do you want to accept the challenge?
     */
    public static final SystemMessageId APPLYING_ALLIANCE_WAR;

    /**
     * ID: 666<br> Message: A request for ceasefire has been received from alliance. Do you agree?
     */
    public static final SystemMessageId REQUEST_FOR_CEASEFIRE;

    /**
     * ID: 667<br> Message: You are registering on the attacking side of the siege. Do you want to continue?
     */
    public static final SystemMessageId REGISTERING_ON_ATTACKING_SIDE;

    /**
     * ID: 668<br> Message: You are registering on the defending side of the siege. Do you want to continue?
     */
    public static final SystemMessageId REGISTERING_ON_DEFENDING_SIDE;

    /**
     * ID: 669<br> Message: You are canceling your application to participate in the siege battle. Do you want to
     * continue?
     */
    public static final SystemMessageId CANCELING_REGISTRATION;

    /**
     * ID: 670<br> Message: You are refusing the registration of clan on the defending side. Do you want to continue?
     */
    public static final SystemMessageId REFUSING_REGISTRATION;

    /**
     * ID: 671<br> Message: You are agreeing to the registration of clan on the defending side. Do you want to
     * continue?
     */
    ...
    /**
     * ID: 673<br> Message: Only a clan leader whose clan is of level 2 or higher is allowed to participate in a clan
     * hall auction.
     */
    public static final SystemMessageId AUCTION_ONLY_CLAN_LEVEL_2_HIGHER;

    /**
     * ID: 674<br> Message: I has not yet been seven days since canceling an auction.
     */
    public static final SystemMessageId NOT_SEVEN_DAYS_SINCE_CANCELING_AUCTION;

    /**
     * ID: 675<br> Message: There are no clan halls up for auction.
     */
    public static final SystemMessageId NO_CLAN_HALLS_UP_FOR_AUCTION;

    /**
     * ID: 676<br> Message: Since you have already submitted a bid, you are not allowed to participate in another
     * auction at this time.
     */
    public static final SystemMessageId ALREADY_SUBMITTED_BID;

    /**
     * ID: 677<br> Message: Your bid price must be higher than the minimum price that can be bid.
     */
    public static final SystemMessageId BID_PRICE_MUST_BE_HIGHER;

    /**
     * ID: 678<br> Message: You have submitted a bid for the auction of $s1.
     */
    public static final SystemMessageId SUBMITTED_A_BID;

    /**
     * ID: 679<br> Message: You have canceled your bid.
     */
    public static final SystemMessageId CANCELED_BID;

    /**
     * ID: 680<br> You cannot participate in an auction.
     */
    ...
    /**
     * ID: 684<br> Message: You cannot position mercenaries during a siege.
     */
    public static final SystemMessageId CANNOT_POSITION_MERCS_DURING_SIEGE;

    /**
     * ID: 685<br> Message: You cannot apply for clan war with a clan that belongs to the same alliance
     */
    public static final SystemMessageId CANNOT_DECLARE_WAR_ON_ALLY;

    /**
     * ID: 686<br> Message: You have received $s1 damage from the fire of magic.
     */
    public static final SystemMessageId S1_DAMAGE_FROM_FIRE_MAGIC;

    /**
     * ID: 687<br> Message: You cannot move while frozen. Please wait.
     */
    public static final SystemMessageId CANNOT_MOVE_FROZEN;

    /**
     * ID: 688<br> Message: The clan that owns the castle is automatically registered on the defending side.
     */
    public static final SystemMessageId CLAN_THAT_OWNS_CASTLE_IS_AUTOMATICALLY_REGISTERED_DEFENDING;

    /**
     * ID: 689<br> Message: A clan that owns a castle cannot participate in another siege.
     */
    public static final SystemMessageId CLAN_THAT_OWNS_CASTLE_CANNOT_PARTICIPATE_OTHER_SIEGE;

    /**
     * ID: 690<br> Message: You cannot register on the attacking side because you are part of an alliance with the clan
    ...
    /**
     * ID: 693<br> Message: The package that arrived is in another warehouse.
     */
    public static final SystemMessageId PACKAGE_IN_ANOTHER_WAREHOUSE;

    /**
     * ID: 694<br> Message: No packages have arrived.
     */
    ...
    /**
     * ID: 697<br> Message: The item enchant value is strange
     */
    public static final SystemMessageId ITEM_ENCHANT_VALUE_STRANGE;

    /**
     * ID: 698<br> Message: The price is different than the same item on the sales list.
     */
    public static final SystemMessageId PRICE_DIFFERENT_FROM_SALES_LIST;

    /**
     * ID: 699<br> Message: Currently not purchasing.
     */
    ...
    /**
     * ID: 701<br> Message: You do not have enough required items.
     */
    public static final SystemMessageId NOT_ENOUGH_REQUIRED_ITEMS;

    /**
     * ID: 702 <br> Message: There are no GMs currently visible in the public list as they may be performing other
    ...
    /**
     * ID: 705<br> Message: You cannot exclude yourself.
     */
    public static final SystemMessageId CANNOT_EXCLUDE_SELF;

    /**
     * ID: 706<br> Message: You can only register up to 64 names on your exclude list.
     */
    ...
    /**
     * ID: 708<br> Message: You do not have the right to use the castle warehouse.
     */
    ...
    /**
     * ID: 710<br> Message: Only clans of clan level 1 or higher can use a clan warehouse.
     */
    public static final SystemMessageId ONLY_LEVEL_1_CLAN_OR_HIGHER_CAN_USE_WAREHOUSE;

    /**
     * ID: 711<br> Message: The siege of $s1 has started.
     */
    public static final SystemMessageId SIEGE_OF_S1_HAS_STARTED;

    /**
     * ID: 712<br> Message: The siege of $s1 has finished.
     */
    public static final SystemMessageId SIEGE_OF_S1_HAS_ENDED;

    /**
     * ID: 713<br> Message: $s1/$s2/$s3 :
     */
    public static final SystemMessageId S1_S2_S3_D;

    /**
     * ID: 714<br> Message: A trap device has been tripped.
     */
    public static final SystemMessageId A_TRAP_DEVICE_HAS_BEEN_TRIPPED;

    /**
     * ID: 715<br> Message: A trap device has been stopped.
     */
    public static final SystemMessageId A_TRAP_DEVICE_HAS_BEEN_STOPPED;

    /**
     * ID: 716<br> Message: If a base camp does not exist, resurrection is not possible.
     */
    public static final SystemMessageId NO_RESURRECTION_WITHOUT_BASE_CAMP;

    /**
     * ID: 717<br> Message: The guardian tower has been destroyed and resurrection is not possible
     */
    public static final SystemMessageId TOWER_DESTROYED_NO_RESURRECTION;

    /**
     * ID: 718<br> Message: The castle gates cannot be opened and closed during a siege.
     */
    public static final SystemMessageId GATES_NOT_OPENED_CLOSED_DURING_SIEGE;

    /**
     * ID: 719<br> Message: You failed at mixing the item.
     */
    public static final SystemMessageId ITEM_MIXING_FAILED;

    /**
     * ID: 720<br> Message: The purchase price is higher than the amount of money that you have and so you cannot open a
     * personal store.
     */
    public static final SystemMessageId THE_PURCHASE_PRICE_IS_HIGHER_THAN_MONEY;

    /**
     * ID: 721<br> Message: You cannot create an alliance while participating in a siege.
     */
    public static final SystemMessageId NO_ALLY_CREATION_WHILE_SIEGE;

    /**
     * ID: 722<br> Message: You cannot dissolve an alliance while an affiliated clan is participating in a siege
     * battle.
     */
    public static final SystemMessageId CANNOT_DISSOLVE_ALLY_WHILE_IN_SIEGE;

    /**
     * ID: 723<br> Message: The opposing clan is participating in a siege battle.
     */
    public static final SystemMessageId OPPOSING_CLAN_IS_PARTICIPATING_IN_SIEGE;

    /**
     * ID: 724<br> Message: You cannot leave while participating in a siege battle.
     */
    public static final SystemMessageId CANNOT_LEAVE_WHILE_SIEGE;

    /**
     * ID: 725<br> Message: You cannot banish a clan from an alliance while the clan is participating in a siege
     */
    public static final SystemMessageId CANNOT_DISMISS_WHILE_SIEGE;

    /**
     * ID: 726<br> Message: Frozen condition has started. Please wait a moment.
     */
    public static final SystemMessageId FROZEN_CONDITION_STARTED;

    /**
     * ID: 727<br> Message: The frozen condition was removed.
     */
    public static final SystemMessageId FROZEN_CONDITION_REMOVED;

    /**
     * ID: 728<br> Message: You cannot apply for dissolution again within seven days after a previous application for
     * dissolution.
     */
    public static final SystemMessageId CANNOT_APPLY_DISSOLUTION_AGAIN;

    /**
     * ID: 729<br> Message: That item cannot be discarded.
     */
    public static final SystemMessageId ITEM_NOT_DISCARDED;

    /**
     * ID: 730<br> Message: - You have submitted your $s1th petition. - You may submit $s2 more petition(s) today.
     */
    public static final SystemMessageId SUBMITTED_YOUR_S1_TH_PETITION_S2_LEFT;

    /**
     * ID: 731<br> Message: A petition has been received by the GM on behalf of $s1. The petition code is $s2.
     */
    public static final SystemMessageId PETITION_S1_RECEIVED_CODE_IS_S2;

    /**
     * ID: 732<br> Message: $s1 has received a request for a consultation with the GM.
     */
    public static final SystemMessageId S1_RECEIVED_CONSULTATION_REQUEST;

    /**
     * ID: 733<br> Message: We have received $s1 petitions from you today and that is the maximum that you can submit in
     * one day. You cannot submit any more petitions.
     */
    public static final SystemMessageId WE_HAVE_RECEIVED_S1_PETITIONS_TODAY;

    /**
     * ID: 734<br> Message: You have failed at submitting a petition on behalf of someone else. $s1 already submitted a
     * petition.
     */
    public static final SystemMessageId PETITION_FAILED_S1_ALREADY_SUBMITTED;

    /**
     * ID: 735<br> Message: You have failed at submitting a petition on behalf of $s1. The error number is $s2.
     */
    public static final SystemMessageId PETITION_FAILED_FOR_S1_ERROR_NUMBER_S2;

    /**
     * ID: 736<br> Message: The petition was canceled. You may submit $s1 more petition(s) today.
     */
    public static final SystemMessageId PETITION_CANCELED_SUBMIT_S1_MORE_TODAY;

    /**
     * ID: 737<br> Message: You have cancelled submitting a petition on behalf of $s1.
     */
    ...
    /**
     * ID: 739<br> Message: You have failed at cancelling a petition on behalf of $s1. The error number is $s2.
     */
    public static final SystemMessageId PETITION_CANCEL_FAILED_FOR_S1_ERROR_NUMBER_S2;

    /**
     * ID: 740<br> Message: $s1 participated in a petition chat at the request of the GM.
     */
    public static final SystemMessageId S1_PARTICIPATE_PETITION;

    /**
     * ID: 741<br> Message: You have failed at adding $s1 to the petition chat. Petition has already been submitted.
     */
    public static final SystemMessageId FAILED_ADDING_S1_TO_PETITION;

    /**
     * ID: 742<br> Message: You have failed at adding $s1 to the petition chat. The error code is $s2.
     */
    public static final SystemMessageId PETITION_ADDING_S1_FAILED_ERROR_NUMBER_S2;

    /**
     * ID: 743<br> Message: $s1 left the petition chat.
     */
    public static final SystemMessageId S1_LEFT_PETITION_CHAT;

    /**
     * ID: 744<br> Message: You have failed at removing $s1 from the petition chat. The error code is $s2.
     */
    ...
    /**
     * ID: 746<br> Message: It is not currently a petition.
     */
    public static final SystemMessageId CURRENTLY_NO_PETITION;

    /**
     * ID: 748<br> Message: The distance is too far and so the casting has been stopped.
     */
    ...
    /**
     * ID: 751<br> Message: As there is a conflict in the siege relationship with a clan in the alliance, you cannot
     * invite that clan to the alliance.
     */
    public static final SystemMessageId CANNOT_INVITE_CONFLICT_CLAN;

    /**
     * ID: 752<br> Message: That name cannot be used.
     */
    public static final SystemMessageId CANNOT_USE_NAME;

    /**
     * ID: 753<br> Message: You cannot position mercenaries here.
     */
    public static final SystemMessageId NO_MERCS_HERE;

    /**
     * ID: 754<br> Message: There are $s1 hours and $s2 minutes left in this week's usage time.
     */
    public static final SystemMessageId S1_HOURS_S2_MINUTES_LEFT_THIS_WEEK;

    /**
     * ID: 755<br> Message: There are $s1 minutes left in this week's usage time.
     */
    public static final SystemMessageId S1_MINUTES_LEFT_THIS_WEEK;

    /**
     * ID: 756<br> Message: This week's usage time has finished.
     */
    public static final SystemMessageId WEEKS_USAGE_TIME_FINISHED;

    /**
     * ID: 757<br> Message: There are $s1 hours and $s2 minutes left in the fixed use time.
     */
    public static final SystemMessageId S1_HOURS_S2_MINUTES_LEFT_IN_TIME;

    /**
     * ID: 758<br> Message: There are $s1 hours and $s2 minutes left in this week's play time.
     */
    public static final SystemMessageId S1_HOURS_S2_MINUTES_LEFT_THIS_WEEKS_PLAY_TIME;

    /**
     * ID: 759<br> Message: There are $s1 minutes left in this week's play time.
     */
    public static final SystemMessageId S1_MINUTES_LEFT_THIS_WEEKS_PLAY_TIME;

    /**
     * ID: 760<br> Message: $s1 cannot join the clan because one day has not yet passed since he/she left another clan.
     */
    public static final SystemMessageId S1_MUST_WAIT_BEFORE_JOINING_ANOTHER_CLAN;

    /**
     * ID: 761<br> Message: $s1 clan cannot join the alliance because one day has not yet passed since it left another
     * alliance.
     */
    public static final SystemMessageId S1_CANT_ENTER_ALLIANCE_WITHIN_1_DAY;

    /**
     * ID: 762<br> Message: $s1 rolled $s2 and $s3's eye came out.
     */
    public static final SystemMessageId S1_ROLLED_S2_S3_EYE_CAME_OUT;

    /**
     * ID: 763<br> Message: You failed at sending the package because you are too far from the warehouse.
     */
    public static final SystemMessageId FAILED_SENDING_PACKAGE_TOO_FAR;

    /**
     * ID: 764<br> Message: You have been playing for an extended period of time. Please consider taking a break.
     */
    public static final SystemMessageId PLAYING_FOR_LONG_TIME;

    /**
     * ID: 769<br> Message: A hacking tool has been discovered. Please try again after closing unnecessary programs.
     */
    public static final SystemMessageId HACKING_TOOL;

    /**
     * ID: 774<br> Message: Play time is no longer accumulating.
     */
    public static final SystemMessageId PLAY_TIME_NO_LONGER_ACCUMULATING;

    /**
     * ID: 775<br> Message: From here on, play time will be expended.
     */
    public static final SystemMessageId PLAY_TIME_EXPENDED;

    /**
     * ID: 776<br> Message: The clan hall which was put up for auction has been awarded to clan s1.
     */
    public static final SystemMessageId CLANHALL_AWARDED_TO_CLAN_S1;

    /**
     * ID: 777<br> Message: The clan hall which was put up for auction was not sold and therefore has been re-listed.
     */
    public static final SystemMessageId CLANHALL_NOT_SOLD;

    /**
     * ID: 778<br> Message: You may not log out from this location.
     */
    public static final SystemMessageId NO_LOGOUT_HERE;

    /**
     * ID: 779<br> Message: You may not restart in this location.
     */
    ...
    /**
     * ID: 795<br> Message: Only clan leaders are authorized to set rights.
     */
    public static final SystemMessageId ONLY_LEADERS_CAN_SET_RIGHTS;

    /**
     * ID: 796<br> Message: Your remaining observation time is minutes.
     */
    ...
    /**
     * ID: 798<br> Message: Item registration is irreversible. Do you wish to continue?
     */
    public static final SystemMessageId ITEM_REGISTRATION_IRREVERSIBLE;

    /**
     * ID: 799<br> Message: The observation time has expired.
     */
    public static final SystemMessageId OBSERVATION_TIME_EXPIRED;

    /**
     * ID: 800<br> Message: You are too late. The registration period is over.
     */
    public static final SystemMessageId REGISTRATION_PERIOD_OVER;

    /**
     * ID: 801<br> Message: Registration for the clan hall siege is closed.
     */
    public static final SystemMessageId REGISTRATION_CLOSED;

    /**
     * ID: 802<br> Message: Petitions are not being accepted at this time. You may submit your petition after a.m./p.m.
     */
    public static final SystemMessageId PETITION_NOT_ACCEPTED_NOW;

    /**
     * ID: 803<br> Message: Enter the specifics of your petition.
     */
    public static final SystemMessageId PETITION_NOT_SPECIFIED;

    /**
     * ID: 804<br> Message: Select a type.
     */
    public static final SystemMessageId SELECT_TYPE;

    /**
     * ID: 805<br> Message: Petitions are not being accepted at this time. You may submit your petition after $s1
     * a.m./p.m.
     */
    public static final SystemMessageId PETITION_NOT_ACCEPTED_SUBMIT_AT_S1;

    /**
     * ID: 806<br> Message: If you are trapped, try typing "/unstuck".
     */
    public static final SystemMessageId TRY_UNSTUCK_WHEN_TRAPPED;

    /**
     * ID: 807<br> Message: This terrain is navigable. Prepare for transport to the nearest village.
     */
    public static final SystemMessageId STUCK_PREPARE_FOR_TRANSPORT;

    /**
     * ID: 808<br> Message: You are stuck. You may submit a petition by typing "/gm".
     */
    public static final SystemMessageId STUCK_SUBMIT_PETITION;

    /**
     * ID: 809<br> Message: You are stuck. You will be transported to the nearest village in five minutes.
     */
    public static final SystemMessageId STUCK_TRANSPORT_IN_FIVE_MINUTES;

    /**
     * ID: 810<br> Message: Invalid macro. Refer to the Help file for instructions.
     */
    public static final SystemMessageId INVALID_MACRO;

    /**
     * ID: 811<br> Message: You will be moved to (). Do you wish to continue?
     */
    public static final SystemMessageId WILL_BE_MOVED;

    /**
     * ID: 812<br> Message: The secret trap has inflicted $s1 damage on you.
     */
    public static final SystemMessageId TRAP_DID_S1_DAMAGE;

    /**
     * ID: 813<br> Message: You have been poisoned by a Secret Trap.
     */
    public static final SystemMessageId POISONED_BY_TRAP;

    /**
     * ID: 814<br> Message: Your speed has been decreased by a Secret Trap.
     */
    public static final SystemMessageId SLOWED_BY_TRAP;

    /**
     * ID: 815<br> Message: The tryouts are about to begin. Line up!
     */
    ...
    /**
     * ID: 818<br> Message: Ticket sales for the Monster Race will end in $s1 minute(s).
     */
    public static final SystemMessageId MONSRACE_TICKETS_STOP_IN_S1_MINUTES;

    /**
     * ID: 819<br> Message: Tickets sales are closed for Monster Race $s1. Odds are posted.
     */
    ...
    /**
     * ID: 822<br> Message: Monster Race $s1 is about to begin! Countdown in five seconds!
     */
    ...
    /**
     * ID: 826<br> Message: First prize goes to the player in lane $s1. Second prize goes to the player in lane $s2.
     */
    ...
    /**
     * ID: 828<br> Message: Are you sure you wish to delete the $s1 macro?
     */
    ...
    /**
     * ID: 830<br> Message: You have recommended $s1. You have $s2 recommendations left.
     */
    ...
    /**
     * ID: 833<br> Message: You are not authorized to make further recommendations at this time. You will receive more
     * recommendation credits each day at 1 p.m.
     */
    public static final SystemMessageId NO_MORE_RECOMMENDATIONS_TO_HAVE;

    /**
     * ID: 834<br> Message: $s1 has rolled $s2.
     */
    public static final SystemMessageId S1_ROLLED_S2;

    /**
     * ID: 835<br> Message: You may not throw the dice at this time. Try again later.
     */
    public static final SystemMessageId YOU_MAY_NOT_THROW_THE_DICE_AT_THIS_TIME_TRY_AGAIN_LATER;

    /**
     * ID: 836<br> Message: You have exceeded your inventory volume limit and cannot take this item.
     */
    ...
    /**
     * ID: 839<br> Message: That name is already assigned to another macro.
     */
    ...
    /**
     * ID: 842<br> Message: You are not authorized to register a recipe.
     */
    public static final SystemMessageId NOT_AUTHORIZED_REGISTER_RECIPE;

    /**
     * ID: 843<br> Message: The siege of $s1 is finished.
     */
    public static final SystemMessageId SIEGE_OF_S1_FINISHED;

    /**
     * ID: 844<br> Message: The siege to conquer $s1 has begun.
     */
    public static final SystemMessageId SIEGE_OF_S1_BEGUN;

    /**
     * ID: 845<br> Message: The deadlineto register for the siege of $s1 has passed.
     */
    public static final SystemMessageId DEADLINE_FOR_SIEGE_S1_PASSED;

    /**
     * ID: 846<br> Message: The siege of $s1 has been canceled due to lack of interest.
     */
    public static final SystemMessageId SIEGE_OF_S1_HAS_BEEN_CANCELED_DUE_TO_LACK_OF_INTEREST;

    /**
     * ID: 847<br> Message: A clan that owns a clan hall may not participate in a clan hall siege.
     */
    public static final SystemMessageId CLAN_OWNING_CLANHALL_MAY_NOT_SIEGE_CLANHALL;

    /**
     * ID: 848<br> Message: $s1 has been deleted.
     */
    public static final SystemMessageId S1_HAS_BEEN_DELETED;

    /**
     * ID: 849<br> Message: $s1 cannot be found.
     */
    public static final SystemMessageId S1_NOT_FOUND;

    /**
     * ID: 850<br> Message: $s1 already exists.
     */
    public static final SystemMessageId S1_ALREADY_EXISTS2;

    /**
     * ID: 851<br> Message: $s1 has been added.
     */
    public static final SystemMessageId S1_ADDED;

    /**
     * ID: 852<br> Message: The recipe is incorrect.
     */
    public static final SystemMessageId RECIPE_INCORRECT;

    /**
     * ID: 853<br> Message: You may not alter your recipe book while engaged in manufacturing.
     */
    public static final SystemMessageId CANT_ALTER_RECIPEBOOK_WHILE_CRAFTING;

    /**
     * ID: 854<br> Message: You are missing $s2 $s1 required to create that.
     */
    public static final SystemMessageId MISSING_S2_S1_TO_CREATE;

    /**
     * ID: 855<br> Message: $s1 clan has defeated $s2.
     */
    public static final SystemMessageId S1_CLAN_DEFEATED_S2;

    /**
     * ID: 856<br> Message: The siege of $s1 has ended in a draw.
     */
    public static final SystemMessageId SIEGE_S1_DRAW;

    /**
     * ID: 857<br> Message: $s1 clan has won in the preliminary match of $s2.
     */
    public static final SystemMessageId S1_CLAN_WON_MATCH_S2;

    /**
     * ID: 858<br> Message: The preliminary match of $s1 has ended in a draw.
     */
    public static final SystemMessageId MATCH_OF_S1_DRAW;

    /**
     * ID: 859<br> Message: Please register a recipe.
     */
    public static final SystemMessageId PLEASE_REGISTER_RECIPE;

    /**
     * ID: 860<br> Message: You may not buld your headquarters in close proximity to another headquarters.
     */
    public static final SystemMessageId HEADQUARTERS_TOO_CLOSE;

    /**
     * ID: 861<br> Message: You have exceeded the maximum number of memos.
     */
    public static final SystemMessageId TOO_MANY_MEMOS;

    /**
     * ID: 862<br> Message: Odds are not posted until ticket sales have closed.
     */
    public static final SystemMessageId ODDS_NOT_POSTED;

    /**
     * ID: 863<br> Message: You feel the energy of fire.
     */
    public static final SystemMessageId FEEL_ENERGY_FIRE;

    /**
     * ID: 864<br> Message: You feel the energy of water.
     */
    public static final SystemMessageId FEEL_ENERGY_WATER;

    /**
     * ID: 865<br> Message: You feel the energy of wind.
     */
    public static final SystemMessageId FEEL_ENERGY_WIND;

    /**
     * ID: 866<br> Message: You may no longer gather energy.
     */
    public static final SystemMessageId NO_LONGER_ENERGY;

    /**
     * ID: 867<br> Message: The energy is depleted.
     */
    public static final SystemMessageId ENERGY_DEPLETED;

    /**
     * ID: 868<br> Message: The energy of fire has been delivered.
     */
    public static final SystemMessageId ENERGY_FIRE_DELIVERED;

    /**
     * ID: 869<br> Message: The energy of water has been delivered.
     */
    public static final SystemMessageId ENERGY_WATER_DELIVERED;

    /**
     * ID: 870<br> Message: The energy of wind has been delivered.
     */
    ...
    /**
     * ID: 874<br> Message: The capacity of the warehouse has been exceeded.
     */
    public static final SystemMessageId WAREHOUSE_CAPACITY_EXCEEDED;

    /**
     * ID: 875<br> Message: The transport of the cargo has been canceled.
     */
    public static final SystemMessageId CARGO_CANCELED;

    /**
     * ID: 876<br> Message: The cargo was not delivered.
     */
    ...
    /**
     * ID: 878<br> Message: The symbol has been deleted.
     */
    ...
    /**
     * ID: 895<br> Message: No recipes have been registered.
     */
    public static final SystemMessageId NO_RECIPES_REGISTERED;

    /**
     * ID: 896<br> Message:The ferry has arrived at Gludin Harbor.
     */
    public static final SystemMessageId FERRY_AT_GLUDIN;

    /**
     * ID: 897<br> Message:The ferry will leave for Talking Island Harbor after anchoring for ten minutes.
     */
    public static final SystemMessageId FERRY_LEAVE_TALKING;

    /**
     * ID: 898<br> Message: Only characters of level 10 or above are authorized to make recommendations.
     */
    ...
    /**
     * ID: 900<br> Message: No slot exists to draw the symbol
     */
    public static final SystemMessageId SYMBOLS_FULL;

    /**
     * ID: 901<br> Message: The symbol information cannot be found.
     */
    public static final SystemMessageId SYMBOL_NOT_FOUND;

    /**
     * ID: 902<br> Message: The number of items is incorrect.
     */
    public static final SystemMessageId NUMBER_INCORRECT;

    /**
     * ID: 903<br> Message: You may not submit a petition while frozen. Be patient.
     */
    public static final SystemMessageId NO_PETITION_WHILE_FROZEN;

    /**
     * ID: 904<br> Message: Items cannot be discarded while in private store status.
     */
    public static final SystemMessageId NO_DISCARD_WHILE_PRIVATE_STORE;

    /**
     * ID: 905<br> Message: The current score for the Humans is $s1.
     */
    public static final SystemMessageId HUMAN_SCORE_S1;

    /**
     * ID: 906<br> Message: The current score for the Elves is $s1.
     */
    public static final SystemMessageId ELVES_SCORE_S1;

    /**
     * ID: 907<br> Message: The current score for the Dark Elves is $s1.
     */
    public static final SystemMessageId DARK_ELVES_SCORE_S1;

    /**
     * ID: 908<br> Message: The current score for the Orcs is $s1.
     */
    public static final SystemMessageId ORCS_SCORE_S1;

    /**
     * ID: 909<br> Message: The current score for the Dwarves is $s1.
     */
    public static final SystemMessageId DWARVEN_SCORE_S1;

    /**
     * ID: 910<br> Message: Current location : $s1, $s2, $s3 (Near Talking Island Village)
     */
    public static final SystemMessageId LOC_TI_S1_S2_S3;

    /**
     * ID: 911<br> Message: Current location : $s1, $s2, $s3 (Near Gludin Village)
     */
    public static final SystemMessageId LOC_GLUDIN_S1_S2_S3;

    /**
     * ID: 912<br> Message: Current location : $s1, $s2, $s3 (Near the Town of Gludio)
     */
    public static final SystemMessageId LOC_GLUDIO_S1_S2_S3;

    /**
     * ID: 913<br> Message: Current location : $s1, $s2, $s3 (Near the Neutral Zone)
     */
    public static final SystemMessageId LOC_NEUTRAL_ZONE_S1_S2_S3;

    /**
     * ID: 914<br> Message: Current location : $s1, $s2, $s3 (Near the Elven Village)
     */
    public static final SystemMessageId LOC_ELVEN_S1_S2_S3;

    /**
     * ID: 915<br> Message: Current location : $s1, $s2, $s3 (Near the Dark Elf Village)
     */
    public static final SystemMessageId LOC_DARK_ELVEN_S1_S2_S3;

    /**
     * ID: 916<br> Message: Current location : $s1, $s2, $s3 (Near the Town of Dion)
     */
    public static final SystemMessageId LOC_DION_S1_S2_S3;

    /**
     * ID: 917<br> Message: Current location : $s1, $s2, $s3 (Near the Floran Village)
     */
    public static final SystemMessageId LOC_FLORAN_S1_S2_S3;

    /**
     * ID: 918<br> Message: Current location : $s1, $s2, $s3 (Near the Town of Giran)
     */
    ...
    /**
     * ID: 920<br> Message: Current location : $s1, $s2, $s3 (Near the Orc Village)
     */
    public static final SystemMessageId LOC_ORC_S1_S2_S3;

    /**
     * ID: 921<br> Message: Current location : $s1, $s2, $s3 (Near the Dwarven Village)
     */
    public static final SystemMessageId LOC_DWARVEN_S1_S2_S3;

    /**
     * ID: 922<br> Message: Current location : $s1, $s2, $s3 (Near the Town of Oren)
     */
    public static final SystemMessageId LOC_OREN_S1_S2_S3;

    /**
     * ID: 923<br> Message: Current location : $s1, $s2, $s3 (Near Hunters Village)
     */
    public static final SystemMessageId LOC_HUNTER_S1_S2_S3;

    /**
     * ID: 924<br> Message: Current location : $s1, $s2, $s3 (Near Aden Castle Town)
     */
    ...
    /**
     * ID: 929<br> Message: No compensation was given for the farm products.
     */
    ...
    /**
     * ID: 973<br> Message: Please input no more than the number you have.
     */
    ...
    /**
     * ID: 976<br> Message: The soul crystal broke because it was not able to endure the soul energy.
     */
    public static final SystemMessageId SOUL_CRYSTAL_BROKE;

    /**
     * ID: 977<br> Message: The soul crystals caused resonation and failed at absorbing a soul.
     */
    ...
    /**
     * ID: 979<br> Message: The ferry arrived at Talking Island Harbor.
     */
    public static final SystemMessageId FERRY_ARRIVED_AT_TALKING;

    /**
     * ID: 980<br> Message: The ferry will leave for Gludin Harbor after anchoring for ten minutes.
     */
    public static final SystemMessageId FERRY_LEAVE_FOR_GLUDIN_AFTER_10_MINUTES;

    /**
     * ID: 981<br> Message: The ferry will leave for Gludin Harbor in five minutes.
     */
    public static final SystemMessageId FERRY_LEAVE_FOR_GLUDIN_IN_5_MINUTES;

    /**
     * ID: 982<br> Message: The ferry will leave for Gludin Harbor in one minute.
     */
    public static final SystemMessageId FERRY_LEAVE_FOR_GLUDIN_IN_1_MINUTE;

    /**
     * ID: 983<br> Message: Those wishing to ride should make haste to get on.
     */
    public static final SystemMessageId MAKE_HASTE_GET_ON_BOAT;

    /**
     * ID: 984<br> Message: The ferry will be leaving soon for Gludin Harbor.
     */
    public static final SystemMessageId FERRY_LEAVE_SOON_FOR_GLUDIN;

    /**
     * ID: 985<br> Message: The ferry is leaving for Gludin Harbor.
     */
    public static final SystemMessageId FERRY_LEAVING_FOR_GLUDIN;

    /**
     * ID: 986<br> Message: The ferry has arrived at Gludin Harbor.
     */
    public static final SystemMessageId FERRY_ARRIVED_AT_GLUDIN;

    /**
     * ID: 987<br> Message: The ferry will leave for Talking Island Harbor after anchoring for ten minutes.
     */
    public static final SystemMessageId FERRY_LEAVE_FOR_TALKING_AFTER_10_MINUTES;

    /**
     * ID: 988<br> Message: The ferry will leave for Talking Island Harbor in five minutes.
     */
    public static final SystemMessageId FERRY_LEAVE_FOR_TALKING_IN_5_MINUTES;

    /**
     * ID: 989<br> Message: The ferry will leave for Talking Island Harbor in one minute.
     */
    public static final SystemMessageId FERRY_LEAVE_FOR_TALKING_IN_1_MINUTE;

    /**
     * ID: 990<br> Message: The ferry will be leaving soon for Talking Island Harbor.
     */
    public static final SystemMessageId FERRY_LEAVE_SOON_FOR_TALKING;

    /**
     * ID: 991<br> Message: The ferry is leaving for Talking Island Harbor.
     */
    public static final SystemMessageId FERRY_LEAVING_FOR_TALKING;

    /**
     * ID: 992<br> Message: The ferry has arrived at Giran Harbor.
     */
    public static final SystemMessageId FERRY_ARRIVED_AT_GIRAN;

    /**
     * ID: 993<br> Message: The ferry will leave for Giran Harbor after anchoring for ten minutes.
     */
    public static final SystemMessageId FERRY_LEAVE_FOR_GIRAN_AFTER_10_MINUTES;

    /**
     * ID: 994<br> Message: The ferry will leave for Giran Harbor in five minutes.
     */
    public static final SystemMessageId FERRY_LEAVE_FOR_GIRAN_IN_5_MINUTES;

    /**
     * ID: 995<br> Message: The ferry will leave for Giran Harbor in one minute.
     */
    public static final SystemMessageId FERRY_LEAVE_FOR_GIRAN_IN_1_MINUTE;

    /**
     * ID: 996<br> Message: The ferry will be leaving soon for Giran Harbor.
     */
    public static final SystemMessageId FERRY_LEAVE_SOON_FOR_GIRAN;

    /**
     * ID: 997<br> Message: The ferry is leaving for Giran Harbor.
     */
    public static final SystemMessageId FERRY_LEAVING_FOR_GIRAN;

    /**
     * ID: 998<br> Message: The Innadril pleasure boat has arrived. It will anchor for ten minutes.
     */
    public static final SystemMessageId INNADRIL_BOAT_ANCHOR_10_MINUTES;

    /**
     * ID: 999<br> Message: The Innadril pleasure boat will leave in five minutes.
     */
    public static final SystemMessageId INNADRIL_BOAT_LEAVE_IN_5_MINUTES;

    /**
     * ID: 1000<br> Message: The Innadril pleasure boat will leave in one minute.
     */
    public static final SystemMessageId INNADRIL_BOAT_LEAVE_IN_1_MINUTE;

    /**
     * ID: 1001<br> Message: The Innadril pleasure boat will be leaving soon.
     */
    public static final SystemMessageId INNADRIL_BOAT_LEAVE_SOON;

    /**
     * ID: 1002<br> Message: The Innadril pleasure boat is leaving.
     */
    public static final SystemMessageId INNADRIL_BOAT_LEAVING;

    /**
     * ID: 1003<br> Message: Cannot possess a monster race ticket.
     */
    public static final SystemMessageId CANNOT_POSSES_MONS_TICKET;

    /**
     * ID: 1004<br> Message: You have registered for a clan hall auction.
     */
    public static final SystemMessageId REGISTERED_FOR_CLANHALL;

    /**
     * ID: 1005<br> Message: There is not enough adena in the clan hall warehouse.
     */
    public static final SystemMessageId NOT_ENOUGH_ADENA_IN_CWH;

    /**
     * ID: 1006<br> Message: You have bid in a clan hall auction.
     */
    public static final SystemMessageId BID_IN_CLANHALL_AUCTION;

    /**
     * ID: 1007<br> Message: The preliminary match registration of $s1 has finished.
     */
    public static final SystemMessageId PRELIMINARY_REGISTRATION_OF_S1_FINISHED;

    /**
     * ID: 1008<br> Message: A hungry strider cannot be mounted or dismounted.
     */
    ...
    /**
     * ID: 1016<br> Message: Pet received $s2 damage by $s1.
     */
    ...
    /**
     * ID: 1027<br> Message: Servitor received $s2 damage caused by $s1.
     */
    ...
    /**
     * ID: 1029<br> Message: Summoned monster uses $s1.
     */
    ...
    /**
     * ID: 1036<br> Message: You have exceeded the quantity that can be inputted.
     */
    public static final SystemMessageId YOU_HAVE_EXCEEDED_QUANTITY_THAT_CAN_BE_INPUTTED;

    /**
     * ID: 1037<br> Message: $s1 manufactured $s2.
     */
    public static final SystemMessageId S1_MANUFACTURED_S2;

    /**
     * ID: 1038<br> Message: $s1 manufactured $s3 $s2(s).
     */
    public static final SystemMessageId S1_MANUFACTURED_S3_S2_S;

    /**
     * ID: 1039<br> Message: Items left at the clan hall warehouse can only be retrieved by the clan leader. Do you want
     * to continue?
     */
    public static final SystemMessageId ONLY_CLAN_LEADER_CAN_RETRIEVE_ITEMS_FROM_CLAN_WAREHOUSE;

    /**
     * ID: 1040<br> Message: Items sent by freight can be picked up from any Warehouse location. Do you want to
     * continue?
     */
    ...
    /**
     * ID: 1042<br> Message: The next farm goods purchase price is $s1 adena.
     */
    public static final SystemMessageId THE_NEXT_FARM_GOODS_PURCHASE_PRICE_IS_S1_ADENA;

    /**
     * ID: 1043<br> Message: At the current time, the "/unstuck" command cannot be used. Please send in a petition.
     */
    public static final SystemMessageId NO_UNSTUCK_PLEASE_SEND_PETITION;

    /**
     * ID: 1044<br> Message: Monster race payout information is not available while tickets are being sold.
     */
    ...
    /**
     * ID: 1047<br> Message: We did not succeed in producing $s1 item.
     */
    public static final SystemMessageId NOT_SUCCEED_PRODUCING_S1;

    /**
     * ID: 1048<br> Message: When "blocking" everything, whispering is not possible.
     */
    public static final SystemMessageId NO_WHISPER_WHEN_BLOCKING;

    /**
     * ID: 1049<br> Message: When "blocking" everything, it is not possible to send invitations for organizing parties.
     */
    public static final SystemMessageId NO_PARTY_WHEN_BLOCKING;

    /**
     * ID: 1050<br> Message: There are no communities in my clan. Clan communities are allowed for clans with skill
     * levels of 2 and higher.
     */
    public static final SystemMessageId NO_CB_IN_MY_CLAN;

    /**
     * ID: 1051 <br> Message: Payment for your clan hall has not been made please make payment tomorrow.
     */
    ...
    /**
     * ID: 1052 <br> Message: Payment of Clan Hall is overdue the owner loose Clan Hall.
     */
    ...
    /**
     * ID: 1053<br> Message: It is not possible to resurrect in battlefields where a siege war is taking place.
     */
    public static final SystemMessageId CANNOT_BE_RESURRECTED_DURING_SIEGE;

    /**
     * ID: 1054<br> Message: You have entered a mystical land.
     */
    public static final SystemMessageId ENTERED_MYSTICAL_LAND;

    /**
     * ID: 1055<br> Message: You have left a mystical land.
     */
    public static final SystemMessageId EXITED_MYSTICAL_LAND;

    /**
     * ID: 1056<br> Message: You have exceeded the storage capacity of the castle's vault.
     */
    public static final SystemMessageId VAULT_CAPACITY_EXCEEDED;

    /**
     * ID: 1057<br> Message: This command can only be used in the relax server.
     */
    ...
    /**
     * ID: 1059<br> Message: The remaining purchasing amount is $s1 adena.
     */
    ...
    /**
     * ID: 1061<br> Message: The recipe cannot be registered. You do not have the ability to create items.
     */
    public static final SystemMessageId CANT_REGISTER_NO_ABILITY_TO_CRAFT;

    /**
     * ID: 1062<br> Message: Writing something new is possible after level 10.
     */
    public static final SystemMessageId WRITING_SOMETHING_NEW_POSSIBLE_AFTER_LEVEL_10;

    /**
     * ID: 1063<br> if you become trapped or unable to move, please use the '/unstuck' command.
     */
    ...
    /**
     * ID: 1065<br> Message: While operating a private store or workshop, you cannot discard, destroy, or trade an
     * item.
     */
    ...
    /**
     * ID: 1070<br> Message: You do not have 'read' permission.
     */
    public static final SystemMessageId NO_READ_PERMISSION;

    /**
     * ID: 1071<br> Message: You do not have 'write' permission.
     */
    public static final SystemMessageId NO_WRITE_PERMISSION;

    /**
     * ID: 1072<br> Message: You have obtained a ticket for the Monster Race #$s1 - Single
     */
    public static final SystemMessageId OBTAINED_TICKET_FOR_MONS_RACE_S1_SINGLE;

    /**
     * ID: 1073<br> Message: You have obtained a ticket for the Monster Race #$s1 - Single
     */
    public static final SystemMessageId OBTAINED_TICKET_FOR_MONS_RACE_S1_SINGLE_;

    /**
     * ID: 1074<br> Message: You do not meet the age requirement to purchase a Monster Race Ticket.
     */
    public static final SystemMessageId NOT_MEET_AGE_REQUIREMENT_FOR_MONS_RACE;

    /**
     * ID: 1075<br> Message: The bid amount must be higher than the previous bid.
     */
    public static final SystemMessageId BID_AMOUNT_HIGHER_THAN_PREVIOUS_BID;

    /**
     * ID: 1076<br> Message: The game cannot be terminated at this time.
     */
    public static final SystemMessageId GAME_CANNOT_TERMINATE_NOW;

    /**
     * ID: 1077<br> Message: A GameGuard Execution error has occurred. Please send the *.erl file(s) located in the
     * GameGuard folder to game@inca.co.kr
     */
    public static final SystemMessageId GG_EXECUTION_ERROR;

    /**
     * ID: 1078<br> Message: When a user's keyboard input exceeds a certain cumulative score a chat ban will be applied.
    ...
    /**
     * ID: 1079<br> Message: The target is currently banend from chatting.
     */
    public static final SystemMessageId TARGET_IS_CHAT_BANNED;

    /**
     * ID: 1080<br> Message: Being permanent, are you sure you wish to use the facelift potion - Type A?
     */
    public static final SystemMessageId FACELIFT_POTION_TYPE_A;

    /**
     * ID: 1081<br> Message: Being permanent, are you sure you wish to use the hair dye potion - Type A?
     */
    public static final SystemMessageId HAIRDYE_POTION_TYPE_A;

    /**
     * ID: 1082<br> Message: Do you wish to use the hair style change potion - Type A? It is permanent.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_A;

    /**
     * ID: 1083<br> Message: Facelift potion - Type A is being applied.
     */
    public static final SystemMessageId FACELIFT_POTION_TYPE_A_APPLIED;

    /**
     * ID: 1084<br> Message: Hair dye potion - Type A is being applied.
     */
    public static final SystemMessageId HAIRDYE_POTION_TYPE_A_APPLIED;

    /**
     * ID: 1085<br> Message: The hair style chance potion - Type A is being used.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_A_USED;

    /**
     * ID: 1086<br> Message: Your facial appearance has been changed.
     */
    public static final SystemMessageId FACE_APPEARANCE_CHANGED;

    /**
     * ID: 1087<br> Message: Your hair color has changed.
     */
    public static final SystemMessageId HAIR_COLOR_CHANGED;

    /**
     * ID: 1088<br> Message: Your hair style has been changed.
     */
    public static final SystemMessageId HAIR_STYLE_CHANGED;

    /**
     * ID: 1089<br> Message: $s1 has obtained a first anniversary commemorative item.
     */
    public static final SystemMessageId S1_OBTAINED_ANNIVERSARY_ITEM;

    /**
     * ID: 1090<br> Message: Being permanent, are you sure you wish to use the facelift potion - Type B?
     */
    public static final SystemMessageId FACELIFT_POTION_TYPE_B;

    /**
     * ID: 1091<br> Message: Being permanent, are you sure you wish to use the facelift potion - Type C?
     */
    public static final SystemMessageId FACELIFT_POTION_TYPE_C;

    /**
     * ID: 1092<br> Message: Being permanent, are you sure you wish to use the hair dye potion - Type B?
     */
    public static final SystemMessageId HAIRDYE_POTION_TYPE_B;

    /**
     * ID: 1093<br> Message: Being permanent, are you sure you wish to use the hair dye potion - Type C?
     */
    public static final SystemMessageId HAIRDYE_POTION_TYPE_C;

    /**
     * ID: 1094<br> Message: Being permanent, are you sure you wish to use the hair dye potion - Type D?
     */
    public static final SystemMessageId HAIRDYE_POTION_TYPE_D;

    /**
     * ID: 1095<br> Message: Do you wish to use the hair style change potion - Type B? It is permanent.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_B;

    /**
     * ID: 1096<br> Message: Do you wish to use the hair style change potion - Type C? It is permanent.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_C;

    /**
     * ID: 1097<br> Message: Do you wish to use the hair style change potion - Type D? It is permanent.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_D;

    /**
     * ID: 1098<br> Message: Do you wish to use the hair style change potion - Type E? It is permanent.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_E;

    /**
     * ID: 1099<br> Message: Do you wish to use the hair style change potion - Type F? It is permanent.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_F;

    /**
     * ID: 1100<br> Message: Do you wish to use the hair style change potion - Type G? It is permanent.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_G;

    /**
     * ID: 1101<br> Message: Facelift potion - Type B is being applied.
     */
    public static final SystemMessageId FACELIFT_POTION_TYPE_B_APPLIED;

    /**
     * ID: 1102<br> Message: Facelift potion - Type C is being applied.
     */
    public static final SystemMessageId FACELIFT_POTION_TYPE_C_APPLIED;

    /**
     * ID: 1103<br> Message: Hair dye potion - Type B is being applied.
     */
    public static final SystemMessageId HAIRDYE_POTION_TYPE_B_APPLIED;

    /**
     * ID: 1104<br> Message: Hair dye potion - Type C is being applied.
     */
    public static final SystemMessageId HAIRDYE_POTION_TYPE_C_APPLIED;

    /**
     * ID: 1105<br> Message: Hair dye potion - Type D is being applied.
     */
    public static final SystemMessageId HAIRDYE_POTION_TYPE_D_APPLIED;

    /**
     * ID: 1106<br> Message: The hair style chance potion - Type B is being used.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_B_USED;

    /**
     * ID: 1107<br> Message: The hair style chance potion - Type C is being used.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_C_USED;

    /**
     * ID: 1108<br> Message: The hair style chance potion - Type D is being used.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_D_USED;

    /**
     * ID: 1109<br> Message: The hair style chance potion - Type E is being used.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_E_USED;

    /**
     * ID: 1110<br> Message: The hair style chance potion - Type F is being used.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_F_USED;

    /**
     * ID: 1111<br> Message: The hair style chance potion - Type G is being used.
     */
    public static final SystemMessageId HAIRSTYLE_POTION_TYPE_G_USED;

    /**
     * ID: 1112<br> Message: The prize amount for the winner of Lottery #$s1 is $s2 adena. We have $s3 first prize
     * winners.
     */
    public static final SystemMessageId AMOUNT_FOR_WINNER_S1_IS_S2_ADENA_WE_HAVE_S3_PRIZE_WINNER;

    /**
     * ID: 1113<br> Message: The prize amount for Lucky Lottery #$s1 is $s2 adena. There was no first prize winner in
     * this drawing, therefore the jackpot will be added to the next drawing.
     */
    public static final SystemMessageId AMOUNT_FOR_LOTTERY_S1_IS_S2_ADENA_NO_WINNER;

    /**
     * ID: 1114<br> Message: Your clan may not register to participate in a siege while under a grace period of the
     * clan's dissolution.
     */
    public static final SystemMessageId CANT_PARTICIPATE_IN_SIEGE_WHILE_DISSOLUTION_IN_PROGRESS;

    /**
     * ID: 1115<br> Message: Individuals may not surrender during combat.
     */
    ...
    /**
     * ID: 1118<br> Message: Progress in a quest is possible only when your inventory's weight and volume are less than
     * 80 percent of capacity.
     */
    public static final SystemMessageId INVENTORY_LESS_THAN_80_PERCENT;

    /**
     * ID: 1119<br> Message: Quest was automatically canceled when you attempted to settle the accounts of your quest
     * while your inventory exceeded 80 percent of capacity.
     */
    public static final SystemMessageId QUEST_CANCELED_INVENTORY_EXCEEDS_80_PERCENT;

    /**
     * ID: 1120<br> Message: You are still a member of the clan.
     */
    public static final SystemMessageId STILL_CLAN_MEMBER;

    /**
     * ID: 1121<br> Message: You do not have the right to vote.
     */
    public static final SystemMessageId NO_RIGHT_TO_VOTE;

    /**
     * ID: 1122<br> Message: There is no candidate.
     */
    public static final SystemMessageId NO_CANDIDATE;

    /**
     * ID: 1123<br> Message: Weight and volume limit has been exceeded. That skill is currently unavailable.
     */
    public static final SystemMessageId WEIGHT_EXCEEDED_SKILL_UNAVAILABLE;

    /**
     * ID: 1124<br> Message: Your recipe book may not be accessed while using a skill.
     */
    public static final SystemMessageId NO_RECIPE_BOOK_WHILE_CASTING;

    /**
     * ID: 1125<br> Message: An item may not be created while engaged in trading.
     */
    public static final SystemMessageId CANNOT_CREATED_WHILE_ENGAGED_IN_TRADING;

    /**
     * ID: 1126<br> Message: You cannot enter a negative number.
     */
    public static final SystemMessageId NO_NEGATIVE_NUMBER;

    /**
     * ID: 1127<br> Message: The reward must be less than 10 times the standard price.
     */
    public static final SystemMessageId REWARD_LESS_THAN_10_TIMES_STANDARD_PRICE;

    /**
     * ID: 1128<br> Message: A private store may not be opened while using a skill.
     */
    public static final SystemMessageId PRIVATE_STORE_NOT_WHILE_CASTING;

    /**
     * ID: 1129<br> Message: This is not allowed while riding a ferry or boat.
     */
    public static final SystemMessageId NOT_ALLOWED_ON_BOAT;

    /**
     * ID: 1130<br> Message: You have given $s1 damage to your target and $s2 damage to the servitor.
     */
    public static final SystemMessageId GIVEN_S1_DAMAGE_TO_YOUR_TARGET_AND_S2_DAMAGE_TO_SERVITOR;

    /**
     * ID: 1131<br> Message: It is now midnight and the effect of $s1 can be felt.
     */
    public static final SystemMessageId NIGHT_S1_EFFECT_APPLIES;

    /**
     * ID: 1132<br> Message: It is now dawn and the effect of $s1 will now disappear.
     */
    public static final SystemMessageId DAY_S1_EFFECT_DISAPPEARS;

    /**
     * ID: 1133<br> Message: Since HP has decreased, the effect of $s1 can be felt.
     */
    public static final SystemMessageId HP_DECREASED_EFFECT_APPLIES;

    /**
     * ID: 1134<br> Message: Since HP has increased, the effect of $s1 will disappear.
     */
    public static final SystemMessageId HP_INCREASED_EFFECT_DISAPPEARS;

    /**
     * ID: 1135<br> Message: While you are engaged in combat, you cannot operate a private store or private workshop.
     */
    public static final SystemMessageId CANT_OPERATE_PRIVATE_STORE_DURING_COMBAT;

    /**
     * ID: 1136<br> Message: Since there was an account that used this IP and attempted to log in illegally, this
     * account is not allowed to connect to the game server for $s1 minutes. Please use another game server.
     */
    ...
    /**
     * ID: 1139<br> Message: The weight and volume limit of your inventory must not be exceeded.
     */
    public static final SystemMessageId INVENTORY_LIMIT_MUST_NOT_BE_EXCEEDED;

    /**
     * ID: 1140<br> Message: Would you like to open the gate?
     */
    public static final SystemMessageId WOULD_YOU_LIKE_TO_OPEN_THE_GATE;

    /**
     * ID: 1141<br> Message: Would you like to close the gate?
     */
    public static final SystemMessageId WOULD_YOU_LIKE_TO_CLOSE_THE_GATE;

    /**
     * ID: 1142<br> Message: Since $s1 already exists nearby, you cannot summon it again.
     */
    public static final SystemMessageId CANNOT_SUMMON_S1_AGAIN;

    /**
     * ID: 1143<br> Message: Since you do not have enough items to maintain the servitor's stay, the servitor will
     * disappear.
     */
    public static final SystemMessageId SERVITOR_DISAPPEARED_NOT_ENOUGH_ITEMS;

    /**
     * ID: 1144<br> Message: Currently, you don't have anybody to chat with in the game.
     */
    public static final SystemMessageId NOBODY_IN_GAME_TO_CHAT;

    /**
     * ID: 1145<br> Message: $s2 has been created for $s1 after the payment of $s3 adena is received.
     */
    public static final SystemMessageId S2_CREATED_FOR_S1_FOR_S3_ADENA;

    /**
     * ID: 1146<br> Message: $s1 created $s2 after receiving $s3 adena.
     */
    public static final SystemMessageId S1_CREATED_S2_FOR_S3_ADENA;

    /**
     * ID: 1147<br> Message: $s2 $s3 have been created for $s1 at the price of $s4 adena.
     */
    public static final SystemMessageId S2_S3_S_CREATED_FOR_S1_FOR_S4_ADENA;

    /**
     * ID: 1148<br> Message: $s1 created $s2 $s3 at the price of $s4 adena.
     */
    public static final SystemMessageId S1_CREATED_S2_S3_S_FOR_S4_ADENA;

    /**
     * ID: 1149<br> Message: Your attempt to create $s2 for $s1 at the price of $s3 adena has failed.
     */
    public static final SystemMessageId CREATION_OF_S2_FOR_S1_AT_S3_ADENA_FAILED;

    /**
     * ID: 1150<br> Message: $s1 has failed to create $s2 at the price of $s3 adena.
     */
    public static final SystemMessageId S1_FAILED_TO_CREATE_S2_FOR_S3_ADENA;

    /**
     * ID: 1151<br> Message: $s2 is sold to $s1 at the price of $s3 adena.
     */
    public static final SystemMessageId S2_SOLD_TO_S1_FOR_S3_ADENA;

    /**
     * ID: 1152<br> Message: $s2 $s3 have been sold to $s1 for $s4 adena.
     */
    public static final SystemMessageId S3_S2_S_SOLD_TO_S1_FOR_S4_ADENA;

    /**
     * ID: 1153<br> Message: $s2 has been purchased from $s1 at the price of $s3 adena.
     */
    public static final SystemMessageId S2_PURCHASED_FROM_S1_FOR_S3_ADENA;

    /**
     * ID: 1154<br> Message: $s3 $s2 has been purchased from $s1 for $s4 adena.
     */
    public static final SystemMessageId S3_S2_S_PURCHASED_FROM_S1_FOR_S4_ADENA;

    /**
     * ID: 1155<br> Message: +$s2 $s3 have been sold to $s1 for $s4 adena.
     */
    public static final SystemMessageId S3_S2_SOLD_TO_S1_FOR_S4_ADENA;

    /**
     * ID: 1156<br> Message: +$s2 $s3 has been purchased from $s1 for $s4 adena.
     */
    public static final SystemMessageId S2_S3_PURCHASED_FROM_S1_FOR_S4_ADENA;

    /**
     * ID: 1157<br> Message: Trying on state lasts for only 5 seconds. When a character's state changes, it can be
     * cancelled.
     */
    public static final SystemMessageId TRYING_ON_STATE;

    /**
     * ID: 1158<br> Message: You cannot dismount from this elevation.
     */
    public static final SystemMessageId CANNOT_DISMOUNT_FROM_ELEVATION;

    /**
     * ID: 1159<br> Message: The ferry from Talking Island will arrive at Gludin Harbor in approximately 10 minutes.
     */
    public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GLUDIN_10_MINUTES;

    /**
     * ID: 1160<br> Message: The ferry from Talking Island will be arriving at Gludin Harbor in approximately 5
     * minutes.
     */
    public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GLUDIN_5_MINUTES;

    /**
     * ID: 1161<br> Message: The ferry from Talking Island will be arriving at Gludin Harbor in approximately 1 minute.
     */
    public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GLUDIN_1_MINUTE;

    /**
     * ID: 1162<br> Message: The ferry from Giran Harbor will be arriving at Talking Island in approximately 15
     * minutes.
     */
    public static final SystemMessageId FERRY_FROM_GIRAN_ARRIVE_AT_TALKING_15_MINUTES;

    /**
     * ID: 1163<br> Message: The ferry from Giran Harbor will be arriving at Talking Island in approximately 10
     * minutes.
     */
    public static final SystemMessageId FERRY_FROM_GIRAN_ARRIVE_AT_TALKING_10_MINUTES;

    /**
     * ID: 1164<br> Message: The ferry from Giran Harbor will be arriving at Talking Island in approximately 5 minutes.
     */
    public static final SystemMessageId FERRY_FROM_GIRAN_ARRIVE_AT_TALKING_5_MINUTES;

    /**
     * ID: 1165<br> Message: The ferry from Giran Harbor will be arriving at Talking Island in approximately 1 minute.
     */
    public static final SystemMessageId FERRY_FROM_GIRAN_ARRIVE_AT_TALKING_1_MINUTE;

    /**
     * ID: 1166<br> Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 20
     * minutes.
     */
    public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_20_MINUTES;

    /**
     * ID: 1167<br> Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 20
     * minutes.
     */
    public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_15_MINUTES;

    /**
     * ID: 1168<br> Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 20
     * minutes.
     */
    public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_10_MINUTES;

    /**
     * ID: 1169<br> Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 20
     * minutes.
     */
    public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_5_MINUTES;

    /**
     * ID: 1170<br> Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 1 minute.
     */
    public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_1_MINUTE;

    /**
     * ID: 1171<br> Message: The Innadril pleasure boat will arrive in approximately 20 minutes.
     */
    public static final SystemMessageId INNADRIL_BOAT_ARRIVE_20_MINUTES;

    /**
     * ID: 1172<br> Message: The Innadril pleasure boat will arrive in approximately 15 minutes.
     */
    public static final SystemMessageId INNADRIL_BOAT_ARRIVE_15_MINUTES;

    /**
     * ID: 1173<br> Message: The Innadril pleasure boat will arrive in approximately 10 minutes.
     */
    public static final SystemMessageId INNADRIL_BOAT_ARRIVE_10_MINUTES;

    /**
     * ID: 1174<br> Message: The Innadril pleasure boat will arrive in approximately 5 minutes.
     */
    public static final SystemMessageId INNADRIL_BOAT_ARRIVE_5_MINUTES;

    /**
     * ID: 1175<br> Message: The Innadril pleasure boat will arrive in approximately 1 minute.
     */
    ...
    /**
     * ID: 1178<br> <Seal of Avarice description>
     */
    public static final SystemMessageId AVARICE_DESCRIPTION;

    /**
     * ID: 1179<br> <Seal of Gnosis description>
     */
    public static final SystemMessageId GNOSIS_DESCRIPTION;

    /**
     * ID: 1180<br> <Seal of Strife description>
     */
    public static final SystemMessageId STRIFE_DESCRIPTION;

    /**
     * ID: 1181<br> Message: Do you really wish to change the title?
     */
    public static final SystemMessageId CHANGE_TITLE_CONFIRM;

    /**
     * ID: 1182<br> Message: Are you sure you wish to delete the clan crest?
     */
    ...
    /**
     * ID: 1184<br> Message: This is a period of calculating statistics in the server.
     */
    public static final SystemMessageId RESULTS_PERIOD;

    /**
     * ID: 1185<br> Message: days left until deletion.
     */
    public static final SystemMessageId DAYS_LEFT_UNTIL_DELETION;

    /**
     * ID: 1186<br> Message: To create a new account, please visit the PlayNC website
     * (http://www.plaync.com/us/support/)
     */
    public static final SystemMessageId TO_CREATE_ACCOUNT_VISIT_WEBSITE;

    /**
     * ID: 1187<br> Message: If you forgotten your account information or password, please visit the Support Center on
    ...
    /**
     * ID: 1188<br> Message: Your selected target can no longer receive a recommendation.
     */
    public static final SystemMessageId YOUR_TARGET_NO_LONGER_RECEIVE_A_RECOMMENDATION;

    /**
     * ID: 1189<br> Message: This temporary alliance of the Castle Attacker team is in effect. It will be dissolved when
     * the Castle Lord is replaced.
     */
    public static final SystemMessageId TEMPORARY_ALLIANCE;

    /**
     * ID: 1190<br> Message: This temporary alliance of the Castle Attacker team has been dissolved.
     */
    public static final SystemMessageId TEMPORARY_ALLIANCE_DISSOLVED;

    /**
     * ID: 1191<br> Message: The ferry from Gludin Harbor will be arriving at Talking Island in approximately 10
     * minutes.
     */
    public static final SystemMessageId FERRY_FROM_GLUDIN_ARRIVE_AT_TALKING_10_MINUTES;

    /**
     * ID: 1192<br> Message: The ferry from Gludin Harbor will be arriving at Talking Island in approximately 5
     * minutes.
     */
    public static final SystemMessageId FERRY_FROM_GLUDIN_ARRIVE_AT_TALKING_5_MINUTES;

    /**
     * ID: 1193<br> Message: The ferry from Gludin Harbor will be arriving at Talking Island in approximately 1 minute.
     */
    public static final SystemMessageId FERRY_FROM_GLUDIN_ARRIVE_AT_TALKING_1_MINUTE;

    /**
     * ID: 1194<br> Message: A mercenary can be assigned to a position from the beginning of the Seal Validation period
     * until the time when a siege starts.
     */
    public static final SystemMessageId MERC_CAN_BE_ASSIGNED;

    /**
     * ID: 1195<br> Message: This mercenary cannot be assigned to a position by using the Seal of Strife.
     */
    ...
    /**
     * ID: 1198<br> Message: The item has been successfully crystallized.
     */
    public static final SystemMessageId CRYSTALLIZATION_SUCCESSFUL;

    /**
     * ID: 1199<br> Message: =======<Clan War Target>=======
     */
    ...
    /**
     * ID: 1201<br> Message: Please select the quest you wish to abort.
     */
    ...
    /**
     * ID: 1203<br> Message: There is no clan war in progress.
     */
    public static final SystemMessageId NO_WAR_IN_PROGRESS;

    /**
     * ID: 1204<br> Message: The screenshot has been saved. ($s1 $s2x$s3)
     */
    public static final SystemMessageId SCREENSHOT;

    /**
     * ID: 1205<br> Message: Your mailbox is full. There is a 100 message limit.
     */
    public static final SystemMessageId MAILBOX_FULL;

    /**
     * ID: 1206<br> Message: The memo box is full. There is a 100 memo limit.
     */
    public static final SystemMessageId MEMOBOX_FULL;

    /**
     * ID: 1207<br> Message: Please make an entry in the field.
     */
    ...
    /**
     * ID: 1210<br> Message: Seven Signs: The quest event period has begun. Visit a Priest of Dawn or Priestess of Dusk
     * to participate in the event.
     */
    public static final SystemMessageId QUEST_EVENT_PERIOD_BEGUN;

    /**
     * ID: 1211<br> Message: Seven Signs: The quest event period has ended. The next quest event will start in one
     * week.
     */
    public static final SystemMessageId QUEST_EVENT_PERIOD_ENDED;

    /**
     * ID: 1212<br> Message: Seven Signs: The Lords of Dawn have obtained the Seal of Avarice.
     */
    public static final SystemMessageId DAWN_OBTAINED_AVARICE;

    /**
     * ID: 1213<br> Message: Seven Signs: The Lords of Dawn have obtained the Seal of Gnosis.
     */
    public static final SystemMessageId DAWN_OBTAINED_GNOSIS;

    /**
     * ID: 1214<br> Message: Seven Signs: The Lords of Dawn have obtained the Seal of Strife.
     */
    public static final SystemMessageId DAWN_OBTAINED_STRIFE;

    /**
     * ID: 1215<br> Message: Seven Signs: The Revolutionaries of Dusk have obtained the Seal of Avarice.
     */
    public static final SystemMessageId DUSK_OBTAINED_AVARICE;

    /**
     * ID: 1216<br> Message: Seven Signs: The Revolutionaries of Dusk have obtained the Seal of Gnosis.
     */
    public static final SystemMessageId DUSK_OBTAINED_GNOSIS;

    /**
     * ID: 1217<br> Message: Seven Signs: The Revolutionaries of Dusk have obtained the Seal of Strife.
     */
    ...
    /**
     * ID: 1220<br> Message: Are you sure you wish to summon it?
     */
    public static final SystemMessageId SUMMON_CONFIRM;

    /**
     * ID: 1221<br> Message: Are you sure you wish to return it?
     */
    public static final SystemMessageId RETURN_CONFIRM;

    /**
     * ID: 1222<br> Message: Current location : $s1, $s2, $s3 (GM Consultation Service)
     */
    public static final SystemMessageId LOC_GM_CONSULATION_SERVICE_S1_S2_S3;

    /**
     * ID: 1223<br> Message: We depart for Talking Island in five minutes.
     */
    public static final SystemMessageId DEPART_FOR_TALKING_5_MINUTES;

    /**
     * ID: 1224<br> Message: We depart for Talking Island in one minute.
     */
    public static final SystemMessageId DEPART_FOR_TALKING_1_MINUTE;

    /**
     * ID: 1225<br> Message: All aboard for Talking Island
     */
    public static final SystemMessageId DEPART_FOR_TALKING;

    /**
     * ID: 1226<br> Message: We are now leaving for Talking Island.
     */
    public static final SystemMessageId LEAVING_FOR_TALKING;

    /**
     * ID: 1227<br> Message: You have $s1 unread messages.
     */
    public static final SystemMessageId S1_UNREAD_MESSAGES;

    /**
     * ID: 1228<br> Message: $s1 has blocked you. You cannot send mail to $s1.
     */
    public static final SystemMessageId S1_BLOCKED_YOU_CANNOT_MAIL;

    /**
     * ID: 1229<br> Message: No more messages may be sent at this time. Each account is allowed 10 messages per day.
     */
    public static final SystemMessageId NO_MORE_MESSAGES_TODAY;

    /**
     * ID: 1230<br> Message: You are limited to five recipients at a time.
     */
    public static final SystemMessageId ONLY_FIVE_RECIPIENTS;

    /**
     * ID: 1231<br> Message: You've sent mail.
     */
    public static final SystemMessageId SENT_MAIL;

    /**
     * ID: 1232<br> Message: The message was not sent.
     */
    public static final SystemMessageId MESSAGE_NOT_SENT;

    /**
     * ID: 1233<br> Message: You've got mail.
     */
    public static final SystemMessageId NEW_MAIL;

    /**
     * ID: 1234<br> Message: The mail has been stored in your temporary mailbox.
     */
    ...
    /**
     * ID: 1236<br> Message: Please enter security card number.
     */
    public static final SystemMessageId ENTER_SECURITY_CARD_NUMBER;

    /**
     * ID: 1237<br> Message: Please enter the card number for number $s1.
     */
    public static final SystemMessageId ENTER_CARD_NUMBER_FOR_S1;

    /**
     * ID: 1238<br> Message: Your temporary mailbox is full. No more mail can be stored; you have reached the 10 message
     * limit.
     */
    public static final SystemMessageId TEMP_MAILBOX_FULL;

    /**
     * ID: 1239<br> Message: The keyboard security module has failed to load. Please exit the game and try again.
     */
    ...
    /**
     * ID: 1242<br> Message: Users who have not verified their age may not log in between the hours if 10:00 p.m. and
     * 6:00 a.m.
     */
    public static final SystemMessageId NOT_VERIFIED_AGE_NO_LOGIN;

    /**
     * ID: 1243<br> Message: The security card number is invalid.
     */
    public static final SystemMessageId SECURITY_CARD_NUMBER_INVALID;

    /**
     * ID: 1244<br> Message: Users who have not verified their age may not log in between the hours if 10:00 p.m. and
     * 6:00 a.m. Logging off now
     */
    public static final SystemMessageId NOT_VERIFIED_AGE_LOG_OFF;

    /**
     * ID: 1245<br> Message: You will be loged out in $s1 minutes.
     */
    public static final SystemMessageId LOGOUT_IN_S1_MINUTES;

    /**
     * ID: 1246<br> Message: $s1 died and has dropped $s2 adena.
     */
    public static final SystemMessageId S1_DIED_DROPPED_S2_ADENA;

    /**
     * ID: 1247<br> Message: The corpse is too old. The skill cannot be used.
     */
    public static final SystemMessageId CORPSE_TOO_OLD_SKILL_NOT_USED;

    /**
     * ID: 1248<br> Message: You are out of feed. Mount status canceled.
     */
    public static final SystemMessageId OUT_OF_FEED_MOUNT_CANCELED;

    /**
     * ID: 1249<br> Message: You may only ride a wyvern while you're riding a strider.
     */
    public static final SystemMessageId YOU_MAY_ONLY_RIDE_WYVERN_WHILE_RIDING_STRIDER;

    /**
     * ID: 1250<br> Message: Do you really want to surrender? If you surrender during an alliance war, your Exp will
     * drop the same as if you were to die once.
     */
    public static final SystemMessageId SURRENDER_ALLY_WAR_CONFIRM;

    /**
     * ID: 1251<br> you will not be able to accept another clan to your alliance for one day.
     */
    public static final SystemMessageId DISMISS_ALLY_CONFIRM;

    /**
     * ID: 1252<br> Message: Are you sure you want to surrender? Exp penalty will be the same as death.
     */
    public static final SystemMessageId SURRENDER_CONFIRM1;

    /**
     * ID: 1253<br> Message: Are you sure you want to surrender? Exp penalty will be the same as death and you will not
     * be allowed to participate in clan war.
     */
    public static final SystemMessageId SURRENDER_CONFIRM2;

    /**
     * ID: 1254<br> Message: Thank you for submitting feedback.
     */
    public static final SystemMessageId THANKS_FOR_FEEDBACK;

    /**
     * ID: 1255<br> Message: GM consultation has begun.
     */
    public static final SystemMessageId GM_CONSULTATION_BEGUN;

    /**
     * ID: 1256<br> Message: Please write the name after the command.
     */
    public static final SystemMessageId PLEASE_WRITE_NAME_AFTER_COMMAND;

    /**
     * ID: 1257<br> Message: The special skill of a servitor or pet cannot be registerd as a macro.
     */
    public static final SystemMessageId PET_SKILL_NOT_AS_MACRO;

    /**
     * ID: 1258<br> Message: $s1 has been crystallized
     */
    public static final SystemMessageId S1_CRYSTALLIZED;

    /**
     * ID: 1259<br> Message: =======<Alliance Target>=======
     */
    public static final SystemMessageId ALLIANCE_TARGET_HEADER;

    /**
     * ID: 1260<br> Message: Seven Signs: Preparations have begun for the next quest event.
     */
    public static final SystemMessageId PREPARATIONS_PERIOD_BEGUN;

    /**
     * ID: 1261<br> Message: Seven Signs: The quest event period has begun. Speak with a Priest of Dawn or Dusk
     * Priestess if you wish to participate in the event.
     */
    public static final SystemMessageId COMPETITION_PERIOD_BEGUN;

    /**
     * ID: 1262<br> Message: Seven Signs: Quest event has ended. Results are being tallied.
     */
    public static final SystemMessageId RESULTS_PERIOD_BEGUN;

    /**
     * ID: 1263<br> Message: Seven Signs: This is the seal validation period. A new quest event period begins next
     * Monday.
     */
    public static final SystemMessageId VALIDATION_PERIOD_BEGUN;

    /**
     * ID: 1264<br> Message: This soul stone cannot currently absorb souls. Absorption has failed.
     */
    public static final SystemMessageId STONE_CANNOT_ABSORB;

    /**
     * ID: 1265<br> Message: You can't absorb souls without a soul stone.
     */
    public static final SystemMessageId CANT_ABSORB_WITHOUT_STONE;

    /**
     * ID: 1266<br> Message: The exchange has ended.
     */
    ...
    /**
     * ID: 1268<br> Message: Do you wish to add class as your sub class?
     */
    ...
    /**
     * ID: 1271<br> Message: Do you wish to participate? Until the next seal validation period, you are a member of the
     * Lords of Dawn.
     */
    ...
    /**
     * ID: 1273<br> Message: You will participate in the Seven Signs as a member of the Lords of Dawn.
     */
    public static final SystemMessageId SEVENSIGNS_PARTECIPATION_DAWN;

    /**
     * ID: 1274<br> Message: You will participate in the Seven Signs as a member of the Revolutionaries of Dusk.
     */
    public static final SystemMessageId SEVENSIGNS_PARTECIPATION_DUSK;

    /**
     * ID: 1275<br> Message: You've chosen to fight for the Seal of Avarice during this quest event period.
     */
    public static final SystemMessageId FIGHT_FOR_AVARICE;

    /**
     * ID: 1276<br> Message: You've chosen to fight for the Seal of Gnosis during this quest event period.
     */
    public static final SystemMessageId FIGHT_FOR_GNOSIS;

    /**
     * ID: 1277<br> Message: You've chosen to fight for the Seal of Strife during this quest event period.
     */
    ...
    /**
     * ID: 1279<br> Message: Contribution level has exceeded the limit. You may not continue.
     */
    ...
    /**
     * ID: 1283<br> Message: The minimum frame option has been activated.
     */
    public static final SystemMessageId MINIMUM_FRAME_ACTIVATED;

    /**
     * ID: 1284<br> Message: The minimum frame option has been deactivated.
     */
    public static final SystemMessageId MINIMUM_FRAME_DEACTIVATED;

    /**
     * ID: 1285<br> Message: No inventory exists: You cannot purchase an item.
     */
    ...
    /**
     * ID: 1288<br> Message: If trends continue, $s1 will win and the seal will belong to:
     */
    public static final SystemMessageId S1_WILL_WIN_COMPETITION;

    /**
     * ID: 1289<br> Message: (Until next Monday at 6:00 p.m.)
     */
    public static final SystemMessageId SEAL_OWNED_10_MORE_VOTED;

    /**
     * ID: 1290<br> Message: Although the seal was not owned, since 35 percent or more people have voted.
     */
    public static final SystemMessageId SEAL_NOT_OWNED_35_MORE_VOTED;

    /**
     * ID: 1291<br> because less than 10 percent of people have voted.
     */
    public static final SystemMessageId SEAL_OWNED_10_LESS_VOTED;

    /**
     * ID: 1292<br> and since less than 35 percent of people have voted.
     */
    public static final SystemMessageId SEAL_NOT_OWNED_35_LESS_VOTED;

    /**
     * ID: 1293<br> Message: If current trends continue, it will end in a tie.
     */
    public static final SystemMessageId COMPETITION_WILL_TIE;

    /**
     * ID: 1294<br> Message: The competition has ended in a tie. Therefore, nobody has been awarded the seal.
     */
    public static final SystemMessageId COMPETITION_TIE_SEAL_NOT_AWARDED;

    /**
     * ID: 1295<br> Message: Sub classes may not be created or changed while a skill is in use.
     */
    public static final SystemMessageId SUBCLASS_NO_CHANGE_OR_CREATE_WHILE_SKILL_IN_USE;

    /**
     * ID: 1296<br> Message: You cannot open a Private Store here.
     */
    public static final SystemMessageId NO_PRIVATE_STORE_HERE;

    /**
     * ID: 1297<br> Message: You cannot open a Private Workshop here.
     */
    public static final SystemMessageId NO_PRIVATE_WORKSHOP_HERE;

    /**
     * ID: 1298<br> Message: Please confirm that you would like to exit the Monster Race Track.
     */
    public static final SystemMessageId MONS_EXIT_CONFIRM;

    /**
     * ID: 1299<br> Message: $s1's casting has been interrupted.
     */
    public static final SystemMessageId S1_CASTING_INTERRUPTED;

    /**
     * ID: 1300<br> Message: You are no longer trying on equipment.
     */
    ...
    /**
     * ID: 1303<br> Message: This may only be used during the quest event period.
     */
    public static final SystemMessageId CAN_BE_USED_DURING_QUEST_EVENT_PERIOD;

    /**
     * ID: 1304<br> except for an Alliance with a castle owning clan.
     */
    public static final SystemMessageId STRIFE_CANCELED_DEFENSIVE_REGISTRATION;

    /**
     * ID: 1305<br> Message: Seal Stones may only be transferred during the quest event period.
     */
    public static final SystemMessageId SEAL_STONES_ONLY_WHILE_QUEST;

    /**
     * ID: 1306<br> Message: You are no longer trying on equipment.
     */
    public static final SystemMessageId NO_LONGER_TRYING_ON;

    /**
     * ID: 1307<br> Message: Only during the seal validation period may you settle your account.
     */
    public static final SystemMessageId SETTLE_ACCOUNT_ONLY_IN_SEAL_VALIDATION;

    /**
     * ID: 1308<br> Message: Congratulations - You've completed a class transfer!
     */
    public static final SystemMessageId CLASS_TRANSFER;

    /**
     * ID: 1309<br> Message:To use this option, you must have the lastest version of MSN Messenger installed on your
     * computer.
     */
    public static final SystemMessageId LATEST_MSN_REQUIRED;

    /**
     * ID: 1310<br> Message: For full functionality, the latest version of MSN Messenger must be installed on your
     * computer.
     */
    public static final SystemMessageId LATEST_MSN_RECOMMENDED;

    /**
     * ID: 1311<br> Message: Previous versions of MSN Messenger only provide the basic features for in-game MSN
    ...
    /**
     * ID: 1312<br> Message: The latest version of MSN Messenger may be obtained from the MSN web site
     * (http://messenger.msn.com).
     */
    public static final SystemMessageId MSN_OBTAINED_FROM;

    /**
     * ID: 1313<br> Message: $s1, to better serve our customers, all chat histories [...]
     */
    public static final SystemMessageId S1_CHAT_HISTORIES_STORED;

    /**
     * ID: 1314<br> Message: Please enter the passport ID of the person you wish to add to your contact list.
     */
    public static final SystemMessageId ENTER_PASSPORT_FOR_ADDING;

    /**
     * ID: 1315<br> Message: Deleting a contact will remove that contact from MSN Messenger as well. The contact can
     * still check your online status and well not be blocked from sending you a message.
     */
    public static final SystemMessageId DELETING_A_CONTACT;

    /**
     * ID: 1316<br> Message: The contact will be deleted and blocked from your contact list.
     */
    public static final SystemMessageId CONTACT_WILL_DELETED;

    /**
     * ID: 1317<br> Message: Would you like to delete this contact?
     */
    public static final SystemMessageId CONTACT_DELETE_CONFIRM;

    /**
     * ID: 1318<br> Message: Please select the contact you want to block or unblock.
     */
    public static final SystemMessageId SELECT_CONTACT_FOR_BLOCK_UNBLOCK;

    /**
     * ID: 1319<br> Message: Please select the name of the contact you wish to change to another group.
     */
    public static final SystemMessageId SELECT_CONTACT_FOR_CHANGE_GROUP;

    /**
     * ID: 1320<br> Message: After selecting the group you wish to move your contact to, press the OK button.
     */
    public static final SystemMessageId SELECT_GROUP_PRESS_OK;

    /**
     * ID: 1321<br> Message: Enter the name of the group you wish to add.
     */
    public static final SystemMessageId ENTER_GROUP_NAME;

    /**
     * ID: 1322<br> Message: Select the group and enter the new name.
     */
    public static final SystemMessageId SELECT_GROUP_ENTER_NAME;

    /**
     * ID: 1323<br> Message: Select the group you wish to delete and click the OK button.
     */
    public static final SystemMessageId SELECT_GROUP_TO_DELETE;

    /**
     * ID: 1324<br> Message: Signing in...
     */
    public static final SystemMessageId SIGNING_IN;

    /**
     * ID: 1325<br> Message: You've logged into another computer and have been logged out of the .NET Messenger Service
     * on this computer.
     */
    public static final SystemMessageId ANOTHER_COMPUTER_LOGOUT;

    /**
     * ID: 1326<br> Message: $s1 :
     */
    public static final SystemMessageId S1_D;

    /**
     * ID: 1327<br> Message: The following message could not be delivered:
     */
    public static final SystemMessageId MESSAGE_NOT_DELIVERED;

    /**
     * ID: 1328<br> Message: Members of the Revolutionaries of Dusk will not be resurrected.
     */
    public static final SystemMessageId DUSK_NOT_RESURRECTED;

    /**
     * ID: 1329<br> Message: You are currently blocked from using the Private Store and Private Workshop.
     */
    public static final SystemMessageId BLOCKED_FROM_USING_STORE;

    /**
     * ID: 1330<br> Message: You may not open a Private Store or Private Workshop for another $s1 minute(s)
     */
    public static final SystemMessageId NO_STORE_FOR_S1_MINUTES;

    /**
     * ID: 1331<br> Message: You are no longer blocked from using the Private Store and Private Workshop
     */
    public static final SystemMessageId NO_LONGER_BLOCKED_USING_STORE;

    /**
     * ID: 1332<br> Message: Items may not be used after your character or pet dies.
     */
    public static final SystemMessageId NO_ITEMS_AFTER_DEATH;

    /**
     * ID: 1333<br> Message: The replay file is not accessible. Please verify that the replay.ini exists in your Linage
     * 2 directory.
     */
    public static final SystemMessageId REPLAY_INACCESSIBLE;

    /**
     * ID: 1334<br> Message: The new camera data has been stored.
     */
    public static final SystemMessageId NEW_CAMERA_STORED;

    /**
     * ID: 1335<br> Message: The attempt to store the new camera data has failed.
     */
    public static final SystemMessageId CAMERA_STORING_FAILED;

    /**
     * ID: 1336<br> Message: The replay file, $s1.$$s2 has been corrupted, please check the fle.
     */
    public static final SystemMessageId REPLAY_S1_S2_CORRUPTED;

    /**
     * ID: 1337<br> Message: This will terminate the replay. Do you wish to continue?
     */
    public static final SystemMessageId REPLAY_TERMINATE_CONFIRM;

    /**
     * ID: 1338<br> Message: You have exceeded the maximum amount that may be transferred at one time.
     */
    public static final SystemMessageId EXCEEDED_MAXIMUM_AMOUNT;

    /**
     * ID: 1339<br> Message: Once a macro is assigned to a shortcut, it cannot be run as a macro again.
     */
    public static final SystemMessageId MACRO_SHORTCUT_NOT_RUN;

    /**
     * ID: 1340<br> Message: This server cannot be accessed by the coupon you are using.
     */
    public static final SystemMessageId SERVER_NOT_ACCESSED_BY_COUPON;

    /**
     * ID: 1341<br> Message: Incorrect name and/or email address.
     */
    public static final SystemMessageId INCORRECT_NAME_OR_ADDRESS;

    /**
     * ID: 1342<br> Message: You are already logged in.
     */
    public static final SystemMessageId ALREADY_LOGGED_IN;

    /**
     * ID: 1343<br> Message: Incorrect email address and/or password. Your attempt to log into .NET Messenger Service
     * has failed.
     */
    public static final SystemMessageId INCORRECT_ADDRESS_OR_PASSWORD;

    /**
     * ID: 1344<br> Message: Your request to log into the .NET Messenger service has failed. Please verify that you are
     * currently connected to the internet.
     */
    public static final SystemMessageId NET_LOGIN_FAILED;

    /**
     * ID: 1345<br> Message: Click the OK button after you have selected a contact name.
     */
    public static final SystemMessageId SELECT_CONTACT_CLICK_OK;

    /**
     * ID: 1346<br> Message: You are currently entering a chat message.
     */
    public static final SystemMessageId CURRENTLY_ENTERING_CHAT;

    /**
     * ID: 1347<br> Message: The Linage II messenger could not carry out the task you requested.
     */
    public static final SystemMessageId MESSENGER_FAILED_CARRYING_OUT_TASK;

    /**
     * ID: 1348<br> Message: $s1 has entered the chat room.
     */
    public static final SystemMessageId S1_ENTERED_CHAT_ROOM;

    /**
     * ID: 1349<br> Message: $s1 has left the chat room.
     */
    public static final SystemMessageId S1_LEFT_CHAT_ROOM;

    /**
     * ID: 1350<br> Message: The state will be changed to indicate "off-line." All the chat windows currently opened
     * will be closed.
     */
    public static final SystemMessageId GOING_OFFLINE;

    /**
     * ID: 1351<br> Message: Click the Delete button after selecting the contact you wish to remove.
     */
    public static final SystemMessageId SELECT_CONTACT_CLICK_REMOVE;

    /**
     * ID: 1352<br> Message: You have been added to $s1 ($s2)'s contact list.
     */
    public static final SystemMessageId ADDED_TO_S1_S2_CONTACT_LIST;

    /**
     * ID: 1353<br> Message: You can set the option to show your status as always being off-line to all of your
     * contacts.
     */
    public static final SystemMessageId CAN_SET_OPTION_TO_ALWAYS_SHOW_OFFLINE;

    /**
     * ID: 1354<br> Message: You are not allowed to chat with a contact while chatting block is imposed.
     */
    public static final SystemMessageId NO_CHAT_WHILE_BLOCKED;

    /**
     * ID: 1355<br> Message: The contact is currently blocked from chatting.
     */
    public static final SystemMessageId CONTACT_CURRENTLY_BLOCKED;

    /**
     * ID: 1356<br> Message: The contact is not currently logged in.
     */
    public static final SystemMessageId CONTACT_CURRENTLY_OFFLINE;

    /**
     * ID: 1357<br> Message: You have been blocked from chatting with that contact.
     */
    public static final SystemMessageId YOU_ARE_BLOCKED;

    /**
     * ID: 1358<br> Message: You are being logged out...
     */
    public static final SystemMessageId YOU_ARE_LOGGING_OUT;

    /**
     * ID: 1359<br> Message: $s1 has logged in.
     */
    public static final SystemMessageId S1_LOGGED_IN2;

    /**
     * ID: 1360<br> Message: You have received a message from $s1.
     */
    public static final SystemMessageId GOT_MESSAGE_FROM_S1;

    /**
     * ID: 1361<br> Message: Due to a system error, you have been logged out of the .NET Messenger Service.
     */
    public static final SystemMessageId LOGGED_OUT_DUE_TO_ERROR;

    /**
     * ID: 1362<br> click the button next to My Status and then use the Options menu.
     */
    public static final SystemMessageId SELECT_CONTACT_TO_DELETE;

    /**
     * ID: 1363<br> Message: Your request to participate in the alliance war has been denied.
     */
    public static final SystemMessageId YOUR_REQUEST_ALLIANCE_WAR_DENIED;

    /**
     * ID: 1364<br> Message: The request for an alliance war has been rejected.
     */
    public static final SystemMessageId REQUEST_ALLIANCE_WAR_REJECTED;

    /**
     * ID: 1365<br> Message: $s2 of $s1 clan has surrendered as an individual.
     */
    public static final SystemMessageId S2_OF_S1_SURRENDERED_AS_INDIVIDUAL;

    /**
     * ID: 1366<br> Message: In order to delete a group, you must not [...]
     */
    public static final SystemMessageId DELTE_GROUP_INSTRUCTION;

    /**
     * ID: 1367<br> Message: Only members of the group are allowed to add records.
     */
    public static final SystemMessageId ONLY_GROUP_CAN_ADD_RECORDS;

    /**
     * ID: 1368<br> Message: You can not try those items on at the same time.
     */
    public static final SystemMessageId YOU_CAN_NOT_TRY_THOSE_ITEMS_ON_AT_THE_SAME_TIME;

    /**
     * ID: 1369<br> Message: You've exceeded the maximum.
     */
    public static final SystemMessageId EXCEEDED_THE_MAXIMUM;

    /**
     * ID: 1370<br> Message: Your message to $s1 did not reach its recipient. You cannot send mail to the GM staff.
     */
    public static final SystemMessageId CANNOT_MAIL_GM_S1;

    /**
     * ID: 1371<br> Message: It has been determined that you're not engaged in normal gameplay and a restriction has
     * been imposed upon you. You may not move for $s1 minutes.
     */
    public static final SystemMessageId GAMEPLAY_RESTRICTION_PENALTY_S1;

    /**
     * ID: 1372<br> Message: Your punishment will continue for $s1 minutes.
     */
    public static final SystemMessageId PUNISHMENT_CONTINUE_S1_MINUTES;

    /**
     * ID: 1373<br> Message: $s1 has picked up $s2 that was dropped by a Raid Boss.
     */
    public static final SystemMessageId S1_OBTAINED_S2_FROM_RAIDBOSS;

    /**
     * ID: 1374<br> Message: $s1 has picked up $s3 $s2(s) that was dropped by a Raid Boss.
     */
    public static final SystemMessageId S1_PICKED_UP_S3_S2_S_FROM_RAIDBOSS;

    /**
     * ID: 1375<br> Message: $s1 has picked up $s2 adena that was dropped by a Raid Boss.
     */
    public static final SystemMessageId S1_OBTAINED_S2_ADENA_FROM_RAIDBOSS;

    /**
     * ID: 1376<br> Message: $s1 has picked up $s2 that was dropped by another character.
     */
    public static final SystemMessageId S1_OBTAINED_S2_FROM_ANOTHER_CHARACTER;

    /**
     * ID: 1377<br> Message: $s1 has picked up $s3 $s2(s) that was dropped by a another character.
     */
    public static final SystemMessageId S1_PICKED_UP_S3_S2_S_FROM_ANOTHER_CHARACTER;

    /**
     * ID: 1378<br> Message: $s1 has picked up +$s3 $s2 that was dropped by a another character.
     */
    public static final SystemMessageId S1_PICKED_UP_S3_S2_FROM_ANOTHER_CHARACTER;

    /**
     * ID: 1379<br> Message: $s1 has obtained $s2 adena.
     */
    public static final SystemMessageId S1_OBTAINED_S2_ADENA;

    /**
     * ID: 1380<br> Message: You can't summon a $s1 while on the battleground.
     */
    public static final SystemMessageId CANT_SUMMON_S1_ON_BATTLEGROUND;

    /**
     * ID: 1381<br> Message: The party leader has obtained $s2 of $s1.
     */
    public static final SystemMessageId LEADER_OBTAINED_S2_OF_S1;

    /**
     * ID: 1382<br> Message: To fulfill the quest, you must bring the chosen weapon. Are you sure you want to choose
     * this weapon?
     */
    public static final SystemMessageId CHOOSE_WEAPON_CONFIRM;

    /**
     * ID: 1383<br> Message: Are you sure you want to exchange?
     */
    ...
    /**
     * ID: 1385<br> Message: You are not allowed to dismount at this location.
     */
    public static final SystemMessageId NO_DISMOUNT_HERE;

    /**
     * ID: 1386<br> Message: You are no longer held in place.
     */
    public static final SystemMessageId NO_LONGER_HELD_IN_PLACE;

    /**
     * ID: 1387<br> Message: Please select the item you would like to try on.
     */
    public static final SystemMessageId SELECT_ITEM_TO_TRY_ON;

    /**
     * ID: 1388<br> Message: A party room has been created.
     */
    public static final SystemMessageId PARTY_ROOM_CREATED;

    /**
     * ID: 1389<br> Message: The party room's information has been revised.
     */
    public static final SystemMessageId PARTY_ROOM_REVISED;

    /**
     * ID: 1390<br> Message: You are not allowed to enter the party room.
     */
    public static final SystemMessageId PARTY_ROOM_FORBIDDEN;

    /**
     * ID: 1391<br> Message: You have exited from the party room.
     */
    public static final SystemMessageId PARTY_ROOM_EXITED;

    /**
     * ID: 1392<br> Message: $s1 has left the party room.
     */
    public static final SystemMessageId S1_LEFT_PARTY_ROOM;

    /**
     * ID: 1393<br> Message: You have been ousted from the party room.
     */
    public static final SystemMessageId OUSTED_FROM_PARTY_ROOM;

    /**
     * ID: 1394<br> Message: $s1 has been kicked from the party room.
     */
    public static final SystemMessageId S1_KICKED_FROM_PARTY_ROOM;

    /**
     * ID: 1395<br> Message: The party room has been disbanded.
     */
    public static final SystemMessageId PARTY_ROOM_DISBANDED;

    /**
     * ID: 1396<br> Message: The list of party rooms can only be viewed by a person who has not joined a party or who is
     * currently the leader of a party.
     */
    public static final SystemMessageId CANT_VIEW_PARTY_ROOMS;

    /**
     * ID: 1397<br> Message: The leader of the party room has changed.
     */
    public static final SystemMessageId PARTY_ROOM_LEADER_CHANGED;

    /**
     * ID: 1398<br> Message: We are recruiting party members.
     */
    public static final SystemMessageId RECRUITING_PARTY_MEMBERS;

    /**
     * ID: 1399<br> Message: Only the leader of the party can transfer party leadership to another player.
     */
    public static final SystemMessageId ONLY_A_PARTY_LEADER_CAN_TRANSFER_ONES_RIGHTS_TO_ANOTHER_PLAYER;

    /**
     * ID: 1400<br> Message: Please select the person you wish to make the party leader.
     */
    ...
    /**
     * ID: 1402<br> Message: You may only transfer party leadership to another member of the party.
     */
    ...
    /**
     * ID: 1404<br> Message: The owner of the private manufacturing store has changed the price for creating this item.
    ...
    /**
     * ID: 1406<br> Message: $s2 CPs has been restored by $s1.
     */
    public static final SystemMessageId S2_CP_WILL_BE_RESTORED_BY_S1;

    /**
     * ID: 1407<br> Message: You are using a computer that does not allow you to log in with two accounts at the same
     * time.
     */
    public static final SystemMessageId NO_LOGIN_WITH_TWO_ACCOUNTS;

    /**
     * ID: 1408<br> Message: Your prepaid remaining usage time is $s1 hours and $s2 minutes. You have $s3 paid
     * reservations left.
     */
    public static final SystemMessageId PREPAID_LEFT_S1_S2_S3;

    /**
     * ID: 1409<br> Message: Your prepaid usage time has expired. Your new prepaid reservation will be used. The
     * remaining usage time is $s1 hours and $s2 minutes.
     */
    public static final SystemMessageId PREPAID_EXPIRED_S1_S2;

    /**
     * ID: 1410<br> Message: Your prepaid usage time has expired. You do not have any more prepaid reservations left.
     */
    public static final SystemMessageId PREPAID_EXPIRED;

    /**
     * ID: 1411<br> Message: The number of your prepaid reservations has changed.
     */
    public static final SystemMessageId PREPAID_CHANGED;

    /**
     * ID: 1412<br> Message: Your prepaid usage time has $s1 minutes left.
     */
    public static final SystemMessageId PREPAID_LEFT_S1;

    /**
     * ID: 1413<br> Message: You do not meet the requirements to enter that party room.
     */
    public static final SystemMessageId CANT_ENTER_PARTY_ROOM;

    /**
     * ID: 1414<br> Message: The width and length should be 100 or more grids and less than 5000 grids respectively.
     */
    public static final SystemMessageId WRONG_GRID_COUNT;

    /**
     * ID: 1415<br> Message: The command file is not sent.
     */
    public static final SystemMessageId COMMAND_FILE_NOT_SENT;

    /**
     * ID: 1416<br> Message: The representative of Team 1 has not been selected.
     */
    public static final SystemMessageId TEAM_1_NO_REPRESENTATIVE;

    /**
     * ID: 1417<br> Message: The representative of Team 2 has not been selected.
     */
    public static final SystemMessageId TEAM_2_NO_REPRESENTATIVE;

    /**
     * ID: 1418<br> Message: The name of Team 1 has not yet been chosen.
     */
    public static final SystemMessageId TEAM_1_NO_NAME;

    /**
     * ID: 1419<br> Message: The name of Team 2 has not yet been chosen.
     */
    public static final SystemMessageId TEAM_2_NO_NAME;

    /**
     * ID: 1420<br> Message: The name of Team 1 and the name of Team 2 are identical.
     */
    public static final SystemMessageId TEAM_NAME_IDENTICAL;

    /**
     * ID: 1421<br> Message: The race setup file has not been designated.
     */
    public static final SystemMessageId RACE_SETUP_FILE1;

    /**
     * ID: 1422<br> Message: Race setup file error - BuffCnt is not specified
     */
    public static final SystemMessageId RACE_SETUP_FILE2;

    /**
     * ID: 1423<br> Message: Race setup file error - BuffID$s1 is not specified.
     */
    public static final SystemMessageId RACE_SETUP_FILE3;

    /**
     * ID: 1424<br> Message: Race setup file error - BuffLv$s1 is not specified.
     */
    public static final SystemMessageId RACE_SETUP_FILE4;

    /**
     * ID: 1425<br> Message: Race setup file error - DefaultAllow is not specified
     */
    public static final SystemMessageId RACE_SETUP_FILE5;

    /**
     * ID: 1426<br> Message: Race setup file error - ExpSkillCnt is not specified.
     */
    public static final SystemMessageId RACE_SETUP_FILE6;

    /**
     * ID: 1427<br> Message: Race setup file error - ExpSkillID$s1 is not specified.
     */
    public static final SystemMessageId RACE_SETUP_FILE7;

    /**
     * ID: 1428<br> Message: Race setup file error - ExpItemCnt is not specified.
     */
    public static final SystemMessageId RACE_SETUP_FILE8;

    /**
     * ID: 1429<br> Message: Race setup file error - ExpItemID$s1 is not specified.
     */
    public static final SystemMessageId RACE_SETUP_FILE9;

    /**
     * ID: 1430<br> Message: Race setup file error - TeleportDelay is not specified
     */
    public static final SystemMessageId RACE_SETUP_FILE10;

    /**
     * ID: 1431<br> Message: The race will be stopped temporarily.
     */
    public static final SystemMessageId RACE_STOPPED_TEMPORARILY;

    /**
     * ID: 1432<br> Message: Your opponent is currently in a petrified state.
     */
    public static final SystemMessageId OPPONENT_PETRIFIED;

    /**
     * ID: 1433<br> Message: You will now automatically apply $s1 to your target.
     */
    public static final SystemMessageId USE_OF_S1_WILL_BE_AUTO;

    /**
     * ID: 1434<br> Message: You will no longer automatically apply $s1 to your weapon.
     */
    public static final SystemMessageId AUTO_USE_OF_S1_CANCELLED;

    /**
     * ID: 1435<br> Message: Due to insufficient $s1, the automatic use function has been deactivated.
     */
    public static final SystemMessageId AUTO_USE_CANCELLED_LACK_OF_S1;

    /**
     * ID: 1436<br> Message: Due to insufficient $s1, the automatic use function cannot be activated.
     */
    public static final SystemMessageId CANNOT_AUTO_USE_LACK_OF_S1;

    /**
     * ID: 1437<br> Message: Players are no longer allowed to play dice. Dice can no longer be purchased from a village
     * store. However, you can still sell them to any village store.
     */
    ...
    /**
     * ID: 1439<br> Message: You do not have all of the items needed to enchant that skill.
     */
    ...
    /**
     * ID: 1441<br> Message: Skill enchant failed. The skill will be initialized.
     */
    ...
    /**
     * ID: 1444<br> Message: You do not have enough experience (Exp) to enchant that skill.
     */
    public static final SystemMessageId YOU_DONT_HAVE_ENOUGH_EXP_TO_ENCHANT_THAT_SKILL;

    /**
     * ID: 1445<br> Message: Your previous subclass will be removed and replaced with the new subclass at level 40. Do
     * you wish to continue?
     */
    public static final SystemMessageId REPLACE_SUBCLASS_CONFIRM;

    /**
     * ID: 1446<br> Message: The ferry from $s1 to $s2 has been delayed.
     */
    ...
    /**
     * ID: 1450<br> Message: That fish is more determined than you are - it spit the hook!
     */
    ...
    /**
     * ID: 1456<br> Message: You cannot fish while riding as a passenger of a boat - it's against the rules.
     */
    ...
    /**
     * ID: 1462<br> Message: You may only use the Pumping skill while you are fishing.
     */
    public static final SystemMessageId CAN_USE_PUMPING_ONLY_WHILE_FISHING;

    /**
     * ID: 1463<br> Message: You may only use the Reeling skill while you are fishing.
     */
    ...
    /**
     * ID: 1466<br> Message: You failed to do anything with the fish and it regains $s1 HP.
     */
    ...
    /**
     * ID: 1468<br> Message: You failed to reel that fish in further and it regains $s1 HP.
     */
    ...
    /**
     * ID: 1472<br> Message: You look oddly at the fishing pole in disbelief and realize that you can't attack anything
     * with this.
     */
    public static final SystemMessageId CANNOT_ATTACK_WITH_FISHING_POLE;

    /**
     * ID: 1473<br> Message: $s1 is not sufficient.
     */
    public static final SystemMessageId S1_NOT_SUFFICIENT;

    /**
     * ID: 1474<br> Message: $s1 is not available.
     */
    public static final SystemMessageId S1_NOT_AVAILABLE;

    /**
     * ID: 1475<br> Message: Pet has dropped $s1.
     */
    public static final SystemMessageId PET_DROPPED_S1;

    /**
     * ID: 1476<br> Message: Pet has dropped +$s1 $s2.
     */
    public static final SystemMessageId PET_DROPPED_S1_S2;

    /**
     * ID: 1477<br> Message: Pet has dropped $s2 of $s1.
     */
    public static final SystemMessageId PET_DROPPED_S2_S1_S;

    /**
     * ID: 1478<br> Message: You may only register a 64 x 64 pixel, 256-color BMP.
     */
    public static final SystemMessageId ONLY_64_PIXEL_256_COLOR_BMP;

    /**
     * ID: 1479<br> Message: That is the wrong grade of soulshot for that fishing pole.
     */
    public static final SystemMessageId WRONG_FISHINGSHOT_GRADE;

    /**
     * ID: 1480<br> Message: Are you sure you want to remove yourself from the Grand Olympiad Games waiting list?
     */
    public static final SystemMessageId OLYMPIAD_REMOVE_CONFIRM;

    /**
     * ID: 1481<br> Message: You have selected a class irrelevant individual match. Do you wish to participate?
     */
    public static final SystemMessageId OLYMPIAD_NON_CLASS_CONFIRM;

    /**
     * ID: 1482<br> Message: You've selected to join a class specific game. Continue?
     */
    public static final SystemMessageId OLYMPIAD_CLASS_CONFIRM;

    /**
     * ID: 1483<br> Message: Are you ready to be a Hero?
     */
    public static final SystemMessageId HERO_CONFIRM;

    /**
     * ID: 1484<br> Message: Are you sure this is the Hero weapon you wish to use? Kamael race cannot use this.
     */
    public static final SystemMessageId HERO_WEAPON_CONFIRM;

    /**
     * ID: 1485<br> Message: The ferry from Talking Island to Gludin Harbor has been delayed.
     */
    public static final SystemMessageId FERRY_TALKING_GLUDIN_DELAYED;

    /**
     * ID: 1486<br> Message: The ferry from Gludin Harbor to Talking Island has been delayed.
     */
    public static final SystemMessageId FERRY_GLUDIN_TALKING_DELAYED;

    /**
     * ID: 1487<br> Message: The ferry from Giran Harbor to Talking Island has been delayed.
     */
    public static final SystemMessageId FERRY_GIRAN_TALKING_DELAYED;

    /**
     * ID: 1488<br> Message: The ferry from Talking Island to Giran Harbor has been delayed.
     */
    public static final SystemMessageId FERRY_TALKING_GIRAN_DELAYED;

    /**
     * ID: 1489<br> Message: Innadril cruise service has been delayed.
     */
    ...
    /**
     * ID: 1492<br> Message: You will be moved to the Olympiad Stadium in $s1 second(s).
     */
    public static final SystemMessageId YOU_WILL_ENTER_THE_OLYMPIAD_STADIUM_IN_S1_SECOND_S;

    /**
     * ID: 1493<br> Message: Your opponent made haste with their tail between their legs, the match has been cancelled.
     */
    public static final SystemMessageId THE_GAME_HAS_BEEN_CANCELLED_BECAUSE_THE_OTHER_PARTY_ENDS_THE_GAME;

    /**
     * ID: 1494<br> Message: Your opponent does not meet the requirements to do battle, the match has been cancelled.
     */
    ...
    /**
     * ID: 1495<br> Message: The match will start in $s1 second(s).
     */
    ...
    /**
     * ID: 1500<br> Message: You cannot participate in the Grand Olympiad Games with a character in their subclass.
     */
    ...
    /**
     * ID: 1502<br> Message: You have already been registered in a waiting list of an event.
     */
    public static final SystemMessageId YOU_HAVE_ALREADY_BEEN_REGISTERED_IN_A_WAITING_LIST_OF_AN_EVENT;

    /**
     * ID: 1503<br> Message: You have been registered in the Grand Olympiad Games waiting list for a class specific
     * match.
     */
    public static final SystemMessageId YOU_HAVE_BEEN_REGISTERED_IN_A_WAITING_LIST_OF_CLASSIFIED_GAMES;

    /**
     * ID: 1504<br> Message: You have been registered in the Grand Olympiad Games waiting list for a non-class specific
     * match.
     */
    public static final SystemMessageId YOU_HAVE_BEEN_REGISTERED_IN_A_WAITING_LIST_OF_NO_CLASS_GAMES;

    /**
     * ID: 1505<br> Message: You have been removed from the Grand Olympiad Games waiting list.
     */
    public static final SystemMessageId YOU_HAVE_BEEN_DELETED_FROM_THE_WAITING_LIST_OF_A_GAME;

    /**
     * ID: 1506<br> Message: You are not currently registered on any Grand Olympiad Games waiting list.
     */
    public static final SystemMessageId YOU_HAVE_NOT_BEEN_REGISTERED_IN_A_WAITING_LIST_OF_A_GAME;

    /**
     * ID: 1507<br> Message: You cannot equip that item in a Grand Olympiad Games match.
     */
    public static final SystemMessageId THIS_ITEM_CANT_BE_EQUIPPED_FOR_THE_OLYMPIAD_EVENT;

    /**
     * ID: 1508<br> Message: You cannot use that item in a Grand Olympiad Games match.
     */
    public static final SystemMessageId THIS_ITEM_IS_NOT_AVAILABLE_FOR_THE_OLYMPIAD_EVENT;

    /**
     * ID: 1509<br> Message: You cannot use that skill in a Grand Olympiad Games match.
     */
    public static final SystemMessageId THIS_SKILL_IS_NOT_AVAILABLE_FOR_THE_OLYMPIAD_EVENT;

    /**
     * ID: 1510<br> Message: $s1 is making an attempt at resurrection. Do you want to continue with this resurrection?
     */
    public static final SystemMessageId RESSURECTION_REQUEST_BY_S1;

    /**
     * ID: 1511<br> Message: While a pet is attempting to resurrect, it cannot help in resurrecting its master.
     */
    public static final SystemMessageId MASTER_CANNOT_RES;

    /**
     * ID: 1512<br> Message: You cannot resurrect a pet while their owner is being resurrected.
     */
    ...
    /**
     * ID: 1514<br> Message: You cannot the owner of a pet while their pet is being resurrected
     */
    public static final SystemMessageId CANNOT_RES_MASTER;

    /**
     * ID: 1515<br> Message: A pet cannot be resurrected while it's owner is in the process of resurrecting.
     */
    ...
    /**
     * ID: 1517<br> Message: Failed in Blessed Enchant. The enchant value of the item became 0.
     */
    public static final SystemMessageId BLESSED_ENCHANT_FAILED;

    /**
     * ID: 1518<br> Message: You do not meet the required condition to equip that item.
     */
    public static final SystemMessageId CANNOT_EQUIP_ITEM_DUE_TO_BAD_CONDITION;

    /**
     * ID: 1519<br> Message: Your pet has been killed! Make sure you resurrect your pet within 20 minutes or your pet
     * and all of it's items will disappear forever!
     */
    public static final SystemMessageId MAKE_SURE_YOU_RESSURECT_YOUR_PET_WITHIN_20_MINUTES;

    /**
     * ID: 1520<br> Message: Servitor passed away.
     */
    public static final SystemMessageId SERVITOR_PASSED_AWAY;

    /**
     * ID: 1521<br> Message: Your servitor has vanished! You'll need to summon a new one.
     */
    public static final SystemMessageId YOUR_SERVITOR_HAS_VANISHED;

    /**
     * ID: 1522<br> Message: Your pet's corpse has decayed!
     */
    public static final SystemMessageId YOUR_PETS_CORPSE_HAS_DECAYED;

    /**
     * ID: 1523<br> Message: You should release your pet or servitor so that it does not fall off of the boat and
     * drown!
     */
    public static final SystemMessageId RELEASE_PET_ON_BOAT;

    /**
     * ID: 1524<br> Message: $s1's pet gained $s2.
     */
    public static final SystemMessageId S1_PET_GAINED_S2;

    /**
     * ID: 1525<br> Message: $s1's pet gained $s3 of $s2.
     */
    public static final SystemMessageId S1_PET_GAINED_S3_S2_S;

    /**
     * ID: 1526<br> Message: $s1's pet gained +$s2$s3.
     */
    ...
    /**
     * ID: 1528<br> Message: You've sent a petition to the GM staff.
     */
    public static final SystemMessageId SENT_PETITION_TO_GM;

    /**
     * ID: 1529<br> Message: $s1 is inviting you to the command channel. Do you want accept?
     */
    public static final SystemMessageId COMMAND_CHANNEL_CONFIRM_FROM_S1;

    /**
     * ID: 1530<br> Message: Select a target or enter the name.
     */
    public static final SystemMessageId SELECT_TARGET_OR_ENTER_NAME;

    /**
     * ID: 1531<br> Message: Enter the name of the clan that you wish to declare war on.
     */
    public static final SystemMessageId ENTER_CLAN_NAME_TO_DECLARE_WAR2;

    /**
     * ID: 1532<br> Message: Enter the name of the clan that you wish to have a cease-fire with.
     */
    public static final SystemMessageId ENTER_CLAN_NAME_TO_CEASE_FIRE;

    /**
     * ID: 1533<br> Message: Attention: $s1 has picked up $s2.
     */
    public static final SystemMessageId ATTENTION_S1_PICKED_UP_S2;

    /**
     * ID: 1534<br> Message: Attention: $s1 has picked up +$s2$s3.
     */
    public static final SystemMessageId ATTENTION_S1_PICKED_UP_S2_S3;

    /**
     * ID: 1535<br> Message: Attention: $s1's pet has picked up $s2.
     */
    public static final SystemMessageId ATTENTION_S1_PET_PICKED_UP_S2;

    /**
     * ID: 1536<br> Message: Attention: $s1's pet has picked up +$s2$s3.
     */
    ...
    /**
     * ID: 1538<br> Message: Current Location: $s1, $s2, $s3 (near the Town of Goddard)
     */
    public static final SystemMessageId LOC_GODDARD_S1_S2_S3;

    /**
     * ID: 1539<br> Message: Cargo has arrived at Talking Island Village.
     */
    public static final SystemMessageId CARGO_AT_TALKING_VILLAGE;

    /**
     * ID: 1540<br> Message: Cargo has arrived at the Dark Elf Village.
     */
    public static final SystemMessageId CARGO_AT_DARKELF_VILLAGE;

    /**
     * ID: 1541<br> Message: Cargo has arrived at Elven Village.
     */
    public static final SystemMessageId CARGO_AT_ELVEN_VILLAGE;

    /**
     * ID: 1542<br> Message: Cargo has arrived at Orc Village.
     */
    public static final SystemMessageId CARGO_AT_ORC_VILLAGE;

    /**
     * ID: 1543<br> Message: Cargo has arrived at Dwarfen Village.
     */
    public static final SystemMessageId CARGO_AT_DWARVEN_VILLAGE;

    /**
     * ID: 1544<br> Message: Cargo has arrived at Aden Castle Town.
     */
    public static final SystemMessageId CARGO_AT_ADEN;

    /**
     * ID: 1545<br> Message: Cargo has arrived at Town of Oren.
     */
    public static final SystemMessageId CARGO_AT_OREN;

    /**
     * ID: 1546<br> Message: Cargo has arrived at Hunters Village.
     */
    public static final SystemMessageId CARGO_AT_HUNTERS;

    /**
     * ID: 1547<br> Message: Cargo has arrived at the Town of Dion.
     */
    public static final SystemMessageId CARGO_AT_DION;

    /**
     * ID: 1548<br> Message: Cargo has arrived at Floran Village.
     */
    public static final SystemMessageId CARGO_AT_FLORAN;

    /**
     * ID: 1549<br> Message: Cargo has arrived at Gludin Village.
     */
    public static final SystemMessageId CARGO_AT_GLUDIN;

    /**
     * ID: 1550<br> Message: Cargo has arrived at the Town of Gludio.
     */
    public static final SystemMessageId CARGO_AT_GLUDIO;

    /**
     * ID: 1551<br> Message: Cargo has arrived at Giran Castle Town.
     */
    public static final SystemMessageId CARGO_AT_GIRAN;

    /**
     * ID: 1552<br> Message: Cargo has arrived at Heine.
     */
    public static final SystemMessageId CARGO_AT_HEINE;

    /**
     * ID: 1553<br> Message: Cargo has arrived at Rune Village.
     */
    public static final SystemMessageId CARGO_AT_RUNE;

    /**
     * ID: 1554<br> Message: Cargo has arrived at the Town of Goddard.
     */
    public static final SystemMessageId CARGO_AT_GODDARD;

    /**
     * ID: 1555<br> Message: Do you want to cancel character deletion?
     */
    public static final SystemMessageId CANCEL_CHARACTER_DELETION_CONFIRM;

    /**
     * ID: 1556<br> Message: Your clan notice has been saved.
     */
    public static final SystemMessageId CLAN_NOTICE_SAVED;

    /**
     * ID: 1557<br> Message: Seed price should be more than $s1 and less than $s2.
     */
    public static final SystemMessageId SEED_PRICE_SHOULD_BE_MORE_THAN_S1_AND_LESS_THAN_S2;

    /**
     * ID: 1558<br> Message: The quantity of seed should be more than $s1 and less than $s2.
     */
    public static final SystemMessageId THE_QUANTITY_OF_SEED_SHOULD_BE_MORE_THAN_S1_AND_LESS_THAN_S2;

    /**
     * ID: 1559<br> Message: Crop price should be more than $s1 and less than $s2.
     */
    public static final SystemMessageId CROP_PRICE_SHOULD_BE_MORE_THAN_S1_AND_LESS_THAN_S2;

    /**
     * ID: 1560<br> Message: The quantity of crop should be more than $s1 and less than $s2
     */
    ...
    /**
     * ID: 1562<br> Message: A Clan War has been declared against the clan, $s1. you will only lose a quarter of the
     * normal experience from death.
     */
    public static final SystemMessageId CLAN_WAR_DECLARED_AGAINST_S1_IF_KILLED_LOSE_LOW_EXP;

    /**
     * ID: 1563<br> Message: The clan, $s1, cannot declare a Clan War because their clan is less than level three, and
    ...
    /**
     * ID: 1564<br> Message: A Clan War can be declared only if the clan is level three or above, and the number of clan
     * members is fifteen or greater.
     */
    public static final SystemMessageId CLAN_WAR_DECLARED_IF_CLAN_LVL3_OR_15_MEMBER;

    /**
     * ID: 1565<br> Message: A Clan War cannot be declared against a clan that does not exist!
     */
    ...
    /**
     * ID: 1568<br> Message: The target for declaration is wrong.
     */
    public static final SystemMessageId WRONG_DECLARATION_TARGET;

    /**
     * ID: 1569<br> Message: A declaration of Clan War against an allied clan can't be made.
     */
    public static final SystemMessageId CLAN_WAR_AGAINST_A_ALLIED_CLAN_NOT_WORK;

    /**
     * ID: 1570<br> Message: A declaration of war against more than 30 Clans can't be made at the same time
     */
    ...
    /**
     * ID: 1573<br> Message: There are no clans that your clan has declared war against.
     */
    public static final SystemMessageId YOU_ARENT_IN_CLAN_WARS;

    /**
     * ID: 1574<br> Message: All is well. There are no clans that have declared war against your clan.
     */
    public static final SystemMessageId NO_CLAN_WARS_VS_YOU;

    /**
     * ID: 1575<br> Message: Command Channels can only be formed by a party leader who is also the leader of a level 5
     * clan.
     */
    ...
    /**
     * ID: 1577<br> Message: Servitor uses the power of spirit.
     */
    public static final SystemMessageId SERVITOR_USE_THE_POWER_OF_SPIRIT;

    /**
     * ID: 1578<br> Message: Items are not available for a private store or a private manufacture.
     */
    public static final SystemMessageId ITEMS_UNAVAILABLE_FOR_STORE_MANUFACTURE;

    /**
     * ID: 1579<br> Message: $s1's pet gained $s2 adena.
     */
    public static final SystemMessageId S1_PET_GAINED_S2_ADENA;

    /**
     * ID: 1580<br> Message: The Command Channel has been formed.
     */
    public static final SystemMessageId COMMAND_CHANNEL_FORMED;

    /**
     * ID: 1581<br> Message: The Command Channel has been disbanded.
     */
    public static final SystemMessageId COMMAND_CHANNEL_DISBANDED;

    /**
     * ID: 1582<br> Message: You have joined the Command Channel.
     */
    public static final SystemMessageId JOINED_COMMAND_CHANNEL;

    /**
     * ID: 1583<br> Message: You were dismissed from the Command Channel.
     */
    public static final SystemMessageId DISMISSED_FROM_COMMAND_CHANNEL;

    /**
     * ID: 1584<br> Message: $s1's party has been dismissed from the Command Channel.
     */
    public static final SystemMessageId S1_PARTY_DISMISSED_FROM_COMMAND_CHANNEL;

    /**
     * ID: 1585<br> Message: The Command Channel has been disbanded.
     */
    public static final SystemMessageId COMMAND_CHANNEL_DISBANDED2;

    /**
     * ID: 1586<br> Message: You have quit the Command Channel.
     */
    public static final SystemMessageId LEFT_COMMAND_CHANNEL;

    /**
     * ID: 1587<br> Message: $s1's party has left the Command Channel.
     */
    public static final SystemMessageId S1_PARTY_LEFT_COMMAND_CHANNEL;

    /**
     * ID: 1588<br> Message: The Command Channel is activated only when there are at least 5 parties participating.
     */
    public static final SystemMessageId COMMAND_CHANNEL_ONLY_AT_LEAST_5_PARTIES;

    /**
     * ID: 1589<br> Message: Command Channel authority has been transferred to $s1.
     */
    public static final SystemMessageId COMMAND_CHANNEL_LEADER_NOW_S1;

    /**
     * ID: 1590<br> Message: ===<Guild Info (Total Parties: $s1)>===
     */
    public static final SystemMessageId GUILD_INFO_HEADER;

    /**
     * ID: 1591<br> Message: No user has been invited to the Command Channel.
     */
    public static final SystemMessageId NO_USER_INVITED_TO_COMMAND_CHANNEL;

    /**
     * ID: 1592<br> Message: You can no longer set up a Command Channel.
     */
    public static final SystemMessageId CANNOT_LONGER_SETUP_COMMAND_CHANNEL;

    /**
     * ID: 1593<br> Message: You do not have authority to invite someone to the Command Channel.
     */
    public static final SystemMessageId CANNOT_INVITE_TO_COMMAND_CHANNEL;

    /**
     * ID: 1594<br> Message: $s1's party is already a member of the Command Channel.
     */
    public static final SystemMessageId S1_ALREADY_MEMBER_OF_COMMAND_CHANNEL;

    /**
     * ID: 1595<br> Message: $s1 has succeeded.
     */
    public static final SystemMessageId S1_SUCCEEDED;

    /**
     * ID: 1596<br> Message: You were hit by $s1!
     */
    public static final SystemMessageId HIT_BY_S1;

    /**
     * ID: 1597<br> Message: $s1 has failed.
     */
    public static final SystemMessageId S1_FAILED;

    /**
     * ID: 1598<br> Message: Soulshots and spiritshots are not available for a dead pet or servitor. Sad, isn't it?
     */
    public static final SystemMessageId SOULSHOTS_AND_SPIRITSHOTS_ARE_NOT_AVAILABLE_FOR_A_DEAD_PET;

    /**
     * ID: 1599<br> Message: You cannot observe while you are in combat!
     */
    public static final SystemMessageId CANNOT_OBSERVE_IN_COMBAT;

    /**
     * ID: 1600<br> Message: Tomorrow's items will ALL be set to 0. Do you wish to continue?
     */
    public static final SystemMessageId TOMORROW_ITEM_ZERO_CONFIRM;

    /**
     * ID: 1601<br> Message: Tomorrow's items will all be set to the same value as today's items. Do you wish to
     * continue?
     */
    public static final SystemMessageId TOMORROW_ITEM_SAME_CONFIRM;

    /**
     * ID: 1602<br> Message: Only a party leader can access the Command Channel.
     */
    public static final SystemMessageId COMMAND_CHANNEL_ONLY_FOR_PARTY_LEADER;

    /**
     * ID: 1603<br> Message: Only channel operator can give All Command.
     */
    public static final SystemMessageId ONLY_COMMANDER_GIVE_COMMAND;

    /**
     * ID: 1604<br> Message: While dressed in formal wear, you can't use items that require all skills and casting
     * operations.
     */
    ...
    /**
     * ID: 1606<br> Message: Congratulations - You've completed the third-class transfer quest!
     */
    public static final SystemMessageId THIRD_CLASS_TRANSFER;

    /**
     * ID: 1607<br> Message: $s1 adena has been withdrawn to pay for purchasing fees.
     */
    public static final SystemMessageId S1_ADENA_HAS_BEEN_WITHDRAWN_TO_PAY_FOR_PURCHASING_FEES;

    /**
     * ID: 1608<br> Message: Due to insufficient adena you cannot buy another castle.
     */
    public static final SystemMessageId INSUFFICIENT_ADENA_TO_BUY_CASTLE;

    /**
     * ID: 1609<br> Message: War has already been declared against that clan... but I'll make note that you really don't
     * like them.
     */
    public static final SystemMessageId WAR_ALREADY_DECLARED;

    /**
     * ID: 1610<br> Message: Fool! You cannot declare war against your own clan!
     */
    ...
    /**
     * ID: 1613<br> Message: There is no clan listed on War List.
     */
    public static final SystemMessageId NO_CLAN_ON_WAR_LIST;

    /**
     * ID: 1614<br> Message: You have joined a channel that was already open.
     */
    public static final SystemMessageId JOINED_CHANNEL_ALREADY_OPEN;

    /**
     * ID: 1615<br> Message: The number of remaining parties is $s1 until a channel is activated
     */
    public static final SystemMessageId S1_PARTIES_REMAINING_UNTIL_CHANNEL;

    /**
     * ID: 1616<br> Message: The Command Channel has been activated.
     */
    public static final SystemMessageId COMMAND_CHANNEL_ACTIVATED;

    /**
     * ID: 1617<br> Message: You do not have the authority to use the Command Channel.
     */
    public static final SystemMessageId CANT_USE_COMMAND_CHANNEL;

    /**
     * ID: 1618<br> Message: The ferry from Rune Harbor to Gludin Harbor has been delayed.
     */
    public static final SystemMessageId FERRY_RUNE_GLUDIN_DELAYED;

    /**
     * ID: 1619<br> Message: The ferry from Gludin Harbor to Rune Harbor has been delayed.
     */
    public static final SystemMessageId FERRY_GLUDIN_RUNE_DELAYED;

    /**
     * ID: 1620<br> Message: Arrived at Rune Harbor.
     */
    public static final SystemMessageId ARRIVED_AT_RUNE;

    /**
     * ID: 1621<br> Message: Departure for Gludin Harbor will take place in five minutes!
     */
    public static final SystemMessageId DEPARTURE_FOR_GLUDIN_5_MINUTES;

    /**
     * ID: 1622<br> Message: Departure for Gludin Harbor will take place in one minute!
     */
    public static final SystemMessageId DEPARTURE_FOR_GLUDIN_1_MINUTE;

    /**
     * ID: 1623<br> Message: Make haste! We will be departing for Gludin Harbor shortly...
     */
    public static final SystemMessageId DEPARTURE_FOR_GLUDIN_SHORTLY;

    /**
     * ID: 1624<br> Message: We are now departing for Gludin Harbor Hold on and enjoy the ride!
     */
    public static final SystemMessageId DEPARTURE_FOR_GLUDIN_NOW;

    /**
     * ID: 1625<br> Message: Departure for Rune Harbor will take place after anchoring for ten minutes.
     */
    public static final SystemMessageId DEPARTURE_FOR_RUNE_10_MINUTES;

    /**
     * ID: 1626<br> Message: Departure for Rune Harbor will take place in five minutes!
     */
    public static final SystemMessageId DEPARTURE_FOR_RUNE_5_MINUTES;

    /**
     * ID: 1627<br> Message: Departure for Rune Harbor will take place in one minute!
     */
    public static final SystemMessageId DEPARTURE_FOR_RUNE_1_MINUTE;

    /**
     * ID: 1628<br> Message: Make haste! We will be departing for Gludin Harbor shortly...
     */
    public static final SystemMessageId DEPARTURE_FOR_GLUDIN_SHORTLY2;

    /**
     * ID: 1629<br> Message: We are now departing for Rune Harbor Hold on and enjoy the ride!
     */
    public static final SystemMessageId DEPARTURE_FOR_RUNE_NOW;

    /**
     * ID: 1630<br> Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 15 minutes.
     */
    public static final SystemMessageId FERRY_FROM_RUNE_AT_GLUDIN_15_MINUTES;

    /**
     * ID: 1631<br> Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 10 minutes.
     */
    public static final SystemMessageId FERRY_FROM_RUNE_AT_GLUDIN_10_MINUTES;

    /**
     * ID: 1632<br> Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 10 minutes.
     */
    public static final SystemMessageId FERRY_FROM_RUNE_AT_GLUDIN_5_MINUTES;

    /**
     * ID: 1633<br> Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 1 minute.
     */
    public static final SystemMessageId FERRY_FROM_RUNE_AT_GLUDIN_1_MINUTE;

    /**
     * ID: 1634<br> Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 15 minutes.
     */
    public static final SystemMessageId FERRY_FROM_GLUDIN_AT_RUNE_15_MINUTES;

    /**
     * ID: 1635<br> Message: The ferry from Gludin Harbor will be arriving at Rune harbor in approximately 10 minutes.
     */
    public static final SystemMessageId FERRY_FROM_GLUDIN_AT_RUNE_10_MINUTES;

    /**
     * ID: 1636<br> Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 10 minutes.
     */
    public static final SystemMessageId FERRY_FROM_GLUDIN_AT_RUNE_5_MINUTES;

    /**
     * ID: 1637<br> Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 1 minute.
     */
    public static final SystemMessageId FERRY_FROM_GLUDIN_AT_RUNE_1_MINUTE;

    /**
     * ID: 1638<br> Message: You cannot fish while using a recipe book, private manufacture or private store.
     */
    ...
    /**
     * ID: 1640<br> Message: Period $s1 of the Grand Olympiad Games has now ended.
     */
    public static final SystemMessageId OLYMPIAD_PERIOD_S1_HAS_ENDED;

    /**
     * ID: 1641<br> and make haste to a Grand Olympiad Manager! Battles in the Grand Olympiad Games are now taking
     * place!
     */
    public static final SystemMessageId THE_OLYMPIAD_GAME_HAS_STARTED;

    /**
     * ID: 1642<br> Message: Much carnage has been left for the cleanup crew of the Olympiad Stadium. Battles in the
     * Grand Olympiad Games are now over!
     */
    public static final SystemMessageId THE_OLYMPIAD_GAME_HAS_ENDED;

    /**
     * ID: 1643<br> Message: Current Location: $s1, $s2, $s3 (Dimensional Gap)
     */
    ...
    /**
     * ID: 1649<br> Message: Play time is now accumulating.
     */
    public static final SystemMessageId PLAY_TIME_NOW_ACCUMULATING;

    /**
     * ID: 1650<br> Message: Due to high server traffic, your login attempt has failed. Please try again soon.
     */
    public static final SystemMessageId TRY_LOGIN_LATER;

    /**
     * ID: 1651<br> Message: The Grand Olympiad Games are not currently in progress.
     */
    public static final SystemMessageId THE_OLYMPIAD_GAME_IS_NOT_CURRENTLY_IN_PROGRESS;

    /**
     * ID: 1652<br> Message: You are now recording gameplay.
     */
    public static final SystemMessageId RECORDING_GAMEPLAY_START;

    /**
     * ID: 1653<br> Message: Your recording has been successfully stored. ($s1)
     */
    public static final SystemMessageId RECORDING_GAMEPLAY_STOP_S1;

    /**
     * ID: 1654<br> Message: Your attempt to record the replay file has failed.
     */
    public static final SystemMessageId RECORDING_GAMEPLAY_FAILED;

    /**
     * ID: 1655<br> Message: You caught something smelly and scary, maybe you should throw it back!?
     */
    public static final SystemMessageId YOU_CAUGHT_SOMETHING_SMELLY_THROW_IT_BACK;

    /**
     * ID: 1656<br> Message: You have successfully traded the item with the NPC.
     */
    public static final SystemMessageId SUCCESSFULLY_TRADED_WITH_NPC;

    /**
     * ID: 1657<br> Message: $s1 has earned $s2 points in the Grand Olympiad Games.
     */
    public static final SystemMessageId S1_HAS_GAINED_S2_OLYMPIAD_POINTS;

    /**
     * ID: 1658<br> Message: $s1 has lost $s2 points in the Grand Olympiad Games.
     */
    public static final SystemMessageId S1_HAS_LOST_S2_OLYMPIAD_POINTS;

    /**
     * ID: 1659<br> Message: Current Location: $s1, $s2, $s3 (Cemetery of the Empire)
     */
    public static final SystemMessageId LOC_CEMETARY_OF_THE_EMPIRE_S1_S2_S3;

    /**
     * ID: 1660<br> Message: Channel Creator: $s1.
     */
    public static final SystemMessageId CHANNEL_CREATOR_S1;

    /**
     * ID: 1661<br> Message: $s1 has obtained $s3 $s2s.
     */
    public static final SystemMessageId S1_OBTAINED_S3_S2_S;

    /**
     * ID: 1662<br> Message: The fish are no longer biting here because you've caught too many! Try fishing in another
     * location.
     */
    public static final SystemMessageId FISH_NO_MORE_BITING_TRY_OTHER_LOCATION;

    /**
     * ID: 1663<br> Message: The clan crest was successfully registered. Remember, only a clan that owns a clan hall or
     * castle can have their crest displayed.
     */
    public static final SystemMessageId CLAN_EMBLEM_WAS_SUCCESSFULLY_REGISTERED;

    /**
     * ID: 1664<br> Message: The fish is resisting your efforts to haul it in! Look at that bobber go!
     */
    public static final SystemMessageId FISH_RESISTING_LOOK_BOBBLER;

    /**
     * ID: 1665<br> Message: You've worn that fish out! It can't even pull the bobber under the water!
     */
    public static final SystemMessageId YOU_WORN_FISH_OUT;

    /**
     * ID: 1666<br> Message: You have obtained +$s1 $s2.
     */
    ...
    /**
     * ID: 1670<br> Message: Due to your Reeling and/or Pumping skill being three or more levels higher than your
    ...
    /**
     * ID: 1673<br> Message: Your current record for this Grand Olympiad is $s1 match(es), $s2 win(s) and $s3 defeat(s).
     * You have earned $s4 Olympiad Point(s).
     */
    ...
    /**
     * ID: 1674<br> Message: This command can only be used by a Noblesse.
     */
    ...
    /**
     * ID: 1676<br> Message: You do not have a servitor or pet and therefore cannot use the automatic-use function.
     */
    public static final SystemMessageId NO_SERVITOR_CANNOT_AUTOMATE_USE;

    /**
     * ID: 1677<br> Message: A cease-fire during a Clan War can not be called while members of your clan are engaged in
     * battle.
     */
    public static final SystemMessageId CANT_STOP_CLAN_WAR_WHILE_IN_COMBAT;

    /**
     * ID: 1678<br> Message: You have not declared a Clan War against the clan $s1.
     */
    public static final SystemMessageId NO_CLAN_WAR_AGAINST_CLAN_S1;

    /**
     * ID: 1679<br> Message: Only the creator of a channel can issue a global command.
     */
    public static final SystemMessageId ONLY_CHANNEL_CREATOR_CAN_GLOBAL_COMMAND;

    /**
     * ID: 1680<br> Message: $s1 has declined the channel invitation.
     */
    public static final SystemMessageId S1_DECLINED_CHANNEL_INVITATION;

    /**
     * ID: 1681<br> Message: Since $s1 did not respond, your channel invitation has failed.
     */
    public static final SystemMessageId S1_DID_NOT_RESPOND_CHANNEL_INVITATION_FAILED;

    /**
     * ID: 1682<br> Message: Only the creator of a channel can use the channel dismiss command.
     */
    public static final SystemMessageId ONLY_CHANNEL_CREATOR_CAN_DISMISS;

    /**
     * ID: 1683<br> Message: Only a party leader can choose the option to leave a channel.
     */
    public static final SystemMessageId ONLY_PARTY_LEADER_CAN_LEAVE_CHANNEL;

    /**
     * ID: 1684<br> Message: A Clan War can not be declared against a clan that is being dissolved.
     */
    public static final SystemMessageId NO_CLAN_WAR_AGAINST_DISSOLVING_CLAN;

    /**
     * ID: 1685<br> Message: You are unable to equip this item when your PK count is greater or equal to one.
     */
    public static final SystemMessageId YOU_ARE_UNABLE_TO_EQUIP_THIS_ITEM_WHEN_YOUR_PK_COUNT_IS_GREATER_THAN_OR_EQUAL_TO_ONE;

    /**
     * ID: 1686<br> Message: Stones and mortar tumble to the earth - the castle wall has taken damage!
     */
    public static final SystemMessageId CASTLE_WALL_DAMAGED;

    /**
     * ID: 1687<br> Message: This area cannot be entered while mounted atop of a Wyvern. You will be dismounted from
     * your Wyvern if you do not leave!
     */
    public static final SystemMessageId AREA_CANNOT_BE_ENTERED_WHILE_MOUNTED_WYVERN;

    /**
     * ID: 1688<br> Message: You cannot enchant while operating a Private Store or Private Workshop.
     */
    public static final SystemMessageId CANNOT_ENCHANT_WHILE_STORE;

    /**
     * ID: 1689<br> Message: You have already joined the waiting list for a class specific match.
     */
    public static final SystemMessageId YOU_ARE_ALREADY_ON_THE_WAITING_LIST_TO_PARTICIPATE_IN_THE_GAME_FOR_YOUR_CLASS;

    /**
     * ID: 1690<br> Message: You have already joined the waiting list for a non-class specific match.
     */
    ...
    /**
     * ID: 1691<br> Message: You can't join a Grand Olympiad Game match with that much stuff on you! Reduce your weight
     * to below 80 percent full and request to join again!
     */
    ...
    /**
     * ID: 1692<br> Message: You have changed from your main class to a subclass and therefore are removed from the
     * Grand Olympiad Games waiting list.
     */
    ...
    /**
     * ID: 1693<br> Message: You may not observe a Grand Olympiad Games match while you are on the waiting list.
     */
    public static final SystemMessageId WHILE_YOU_ARE_ON_THE_WAITING_LIST_YOU_ARE_NOT_ALLOWED_TO_WATCH_THE_GAME;

    /**
     * ID: 1694<br> Message: Only a clan leader that is a Noblesse can view the Siege War Status window during a siege
     * war.
     */
    public static final SystemMessageId ONLY_NOBLESSE_LEADER_CAN_VIEW_SIEGE_STATUS_WINDOW;

    /**
     * ID: 1695<br> Message: You can only use that during a Siege War!
     */
    public static final SystemMessageId ONLY_DURING_SIEGE;

    /**
     * ID: 1696<br> Message: Your accumulated play time is $s1.
     */
    public static final SystemMessageId ACCUMULATED_PLAY_TIME_IS_S1;

    /**
     * ID: 1697<br> Message: Your accumulated play time has reached Fatigue level, so you will receive experience or
     * item drops at only 50 percent [...]
     */
    public static final SystemMessageId ACCUMULATED_PLAY_TIME_WARNING1;

    /**
     * ID: 1698<br> Message: Your accumulated play time has reached Ill-health level, so you will no longer gain
     * experience or item drops. [...}
     */
    public static final SystemMessageId ACCUMULATED_PLAY_TIME_WARNING2;

    /**
     * ID: 1699<br> Message: You cannot dismiss a party member by force.
     */
    public static final SystemMessageId CANNOT_DISMISS_PARTY_MEMBER;

    /**
     * ID: 1700<br> Message: You don't have enough spiritshots needed for a pet/servitor.
     */
    public static final SystemMessageId NOT_ENOUGH_SPIRITSHOTS_FOR_PET;

    /**
     * ID: 1701<br> Message: You don't have enough soulshots needed for a pet/servitor.
     */
    public static final SystemMessageId NOT_ENOUGH_SOULSHOTS_FOR_PET;

    /**
     * ID: 1702<br> Message: $s1 is using a third party program.
     */
    public static final SystemMessageId S1_USING_THIRD_PARTY_PROGRAM;

    /**
     * ID: 1703<br> Message: The previous investigated user is not using a third party program
     */
    public static final SystemMessageId NOT_USING_THIRD_PARTY_PROGRAM;

    /**
     * ID: 1704<br> Message: Please close the setup window for your private manufacturing store or private store, and
     * try again.
     */
    public static final SystemMessageId CLOSE_STORE_WINDOW_AND_TRY_AGAIN;

    /**
     * ID: 1705<br> Message: PC Bang Points acquisition period. Points acquisition period left $s1 hour.
     */
    public static final SystemMessageId PCPOINT_ACQUISITION_PERIOD;

    /**
     * ID: 1706<br> Message: PC Bang Points use period. Points acquisition period left $s1 hour.
     */
    public static final SystemMessageId PCPOINT_USE_PERIOD;

    /**
     * ID: 1707<br> Message: You acquired $s1 PC Bang Point.
     */
    public static final SystemMessageId ACQUIRED_S1_PCPOINT;

    /**
     * ID: 1708<br> Message: Double points! You acquired $s1 PC Bang Point.
     */
    public static final SystemMessageId ACQUIRED_S1_PCPOINT_DOUBLE;

    /**
     * ID: 1709<br> Message: You are using $s1 point.
     */
    public static final SystemMessageId USING_S1_PCPOINT;

    /**
     * ID: 1710<br> Message: You are short of accumulated points.
     */
    public static final SystemMessageId SHORT_OF_ACCUMULATED_POINTS;

    /**
     * ID: 1711<br> Message: PC Bang Points use period has expired.
     */
    public static final SystemMessageId PCPOINT_USE_PERIOD_EXPIRED;

    /**
     * ID: 1712<br> Message: The PC Bang Points accumulation period has expired.
     */
    public static final SystemMessageId PCPOINT_ACCUMULATION_PERIOD_EXPIRED;

    /**
     * ID: 1713<br> Message: The games may be delayed due to an insufficient number of players waiting.
     */
    public static final SystemMessageId GAMES_DELAYED;

    /**
     * ID: 1714<br> Message: Current Location: $s1, $s2, $s3 (Near the Town of Schuttgart)
     */
    public static final SystemMessageId LOC_SCHUTTGART_S1_S2_S3;

    /**
     * ID: 1715<br> Message: This is a Peaceful Zone
     */
    public static final SystemMessageId PEACEFUL_ZONE;

    /**
     * ID: 1716<br> Message: Altered Zone
     */
    public static final SystemMessageId ALTERED_ZONE;

    /**
     * ID: 1717<br> Message: Siege War Zone
     */
    public static final SystemMessageId SIEGE_ZONE;

    /**
     * ID: 1718<br> Message: General Field
     */
    public static final SystemMessageId GENERAL_ZONE;

    /**
     * ID: 1719<br> Message: Seven Signs Zone
     */
    ...
    /**
     * ID: 1721<br> Message: Combat Zone
     */
    public static final SystemMessageId COMBAT_ZONE;

    /**
     * ID: 1722<br> Message: Please enter the name of the item you wish to search for.
     */
    public static final SystemMessageId ENTER_ITEM_NAME_SEARCH;

    /**
     * ID: 1723<br> Message: Please take a moment to provide feedback about the petition service.
     */
    public static final SystemMessageId PLEASE_PROVIDE_PETITION_FEEDBACK;

    /**
     * ID: 1724<br> Message: A servitor whom is engaged in battle cannot be de-activated.
     */
    public static final SystemMessageId SERVITOR_NOT_RETURN_IN_BATTLE;

    /**
     * ID: 1725<br> Message: You have earned $s1 raid point(s).
     */
    public static final SystemMessageId EARNED_S1_RAID_POINTS;

    /**
     * ID: 1726<br> Message: $s1 has disappeared because its time period has expired.
     */
    public static final SystemMessageId S1_PERIOD_EXPIRED_DISAPPEARED;

    /**
     * ID: 1727<br> Message: $s1 has invited you to a party room. Do you accept?
     */
    public static final SystemMessageId S1_INVITED_YOU_TO_PARTY_ROOM_CONFIRM;

    /**
     * ID: 1728<br> Message: The recipient of your invitation did not accept the party matching invitation.
     */
    public static final SystemMessageId PARTY_MATCHING_REQUEST_NO_RESPONSE;

    /**
     * ID: 1729<br> Message: You cannot join a Command Channel while teleporting.
     */
    public static final SystemMessageId NOT_JOIN_CHANNEL_WHILE_TELEPORTING;

    /**
     * ID: 1730<br> Message: To establish a Clan Academy, your clan must be Level 5 or higher.
     */
    public static final SystemMessageId YOU_DO_NOT_MEET_CRITERIA_IN_ORDER_TO_CREATE_A_CLAN_ACADEMY;

    /**
     * ID: 1731<br> Message: Only the leader can create a Clan Academy.
     */
    public static final SystemMessageId ONLY_LEADER_CAN_CREATE_ACADEMY;

    /**
     * ID: 1732<br> Message: To create a Clan Academy, a Blood Mark is needed.
     */
    public static final SystemMessageId NEED_BLOODMARK_FOR_ACADEMY;

    /**
     * ID: 1733<br> Message: You do not have enough adena to create a Clan Academy.
     */
    public static final SystemMessageId NEED_ADENA_FOR_ACADEMY;

    /**
     * ID: 1734<br> not belong another clan and not yet completed their 2nd class transfer.
     */
    public static final SystemMessageId ACADEMY_REQUIREMENTS;

    /**
     * ID: 1735<br> Message: $s1 does not meet the requirements to join a Clan Academy.
     */
    public static final SystemMessageId S1_DOESNOT_MEET_REQUIREMENTS_TO_JOIN_ACADEMY;

    /**
     * ID: 1736<br> Message: The Clan Academy has reached its maximum enrollment.
     */
    public static final SystemMessageId ACADEMY_MAXIMUM;

    /**
     * ID: 1737<br> Message: Your clan has not established a Clan Academy but is eligible to do so.
     */
    ...
    /**
     * ID: 1739<br> Message: Would you like to create a Clan Academy?
     */
    public static final SystemMessageId CLAN_ACADEMY_CREATE_CONFIRM;

    /**
     * ID: 1740<br> Message: Please enter the name of the Clan Academy.
     */
    public static final SystemMessageId ACADEMY_CREATE_ENTER_NAME;

    /**
     * ID: 1741<br> Message: Congratulations! The $s1's Clan Academy has been created.
     */
    public static final SystemMessageId THE_S1S_CLAN_ACADEMY_HAS_BEEN_CREATED;

    /**
     * ID: 1742<br> Message: A message inviting $s1 to join the Clan Academy is being sent.
     */
    public static final SystemMessageId ACADEMY_INVITATION_SENT_TO_S1;

    /**
     * ID: 1743<br> Message: To open a Clan Academy, the leader of a Level 5 clan or above must pay XX Proofs of Blood
     * or a certain amount of adena.
     */
    public static final SystemMessageId OPEN_ACADEMY_CONDITIONS;

    /**
     * ID: 1744<br> Message: There was no response to your invitation to join the Clan Academy, so the invitation has
     * been rescinded.
     */
    public static final SystemMessageId ACADEMY_JOIN_NO_RESPONSE;

    /**
     * ID: 1745<br> Message: The recipient of your invitation to join the Clan Academy has declined.
     */
    public static final SystemMessageId ACADEMY_JOIN_DECLINE;

    /**
     * ID: 1746<br> Message: You have already joined a Clan Academy.
     */
    public static final SystemMessageId ALREADY_JOINED_ACADEMY;

    /**
     * ID: 1747<br> Message: $s1 has sent you an invitation to join the Clan Academy belonging to the $s2 clan. Do you
     * accept?
     */
    public static final SystemMessageId JOIN_ACADEMY_REQUEST_BY_S1_FOR_CLAN_S2;

    /**
     * ID: 1748<br> Message: Clan Academy member $s1 has successfully completed the 2nd class transfer and obtained $s2
     * Clan Reputation points.
     */
    public static final SystemMessageId CLAN_MEMBER_GRADUATED_FROM_ACADEMY;

    /**
     * ID: 1749<br> Message: Congratulations! You will now graduate from the Clan Academy and leave your current clan.
     * As a graduate of the academy, you can immediately join a clan as a regular member without being subject to any
     * penalties.
     */
    public static final SystemMessageId ACADEMY_MEMBERSHIP_TERMINATED;

    /**
     * ID: 1750<br> Message: If you possess $s1, you cannot participate in the Olympiad.
     */
    public static final SystemMessageId CANNOT_JOIN_OLYMPIAD_POSSESSING_S1;

    /**
     * ID: 1751<br> Message: The Grand Master has given you a commemorative item.
     */
    public static final SystemMessageId GRAND_MASTER_COMMEMORATIVE_ITEM;

    /**
     * ID: 1752<br> Message: Since the clan has received a graduate of the Clan Academy, it has earned $s1 points
     * towards its reputation score.
     */
    public static final SystemMessageId MEMBER_GRADUATED_EARNED_S1_REPU;

    /**
     * ID: 1753<br> Message: The clan leader has decreed that that particular privilege cannot be granted to a Clan
     * Academy member.
     */
    public static final SystemMessageId CANT_TRANSFER_PRIVILEGE_TO_ACADEMY_MEMBER;

    /**
     * ID: 1754<br> Message: That privilege cannot be granted to a Clan Academy member.
     */
    public static final SystemMessageId RIGHT_CANT_TRANSFERRED_TO_ACADEMY_MEMBER;

    /**
     * ID: 1755<br> Message: $s2 has been designated as the apprentice of clan member $s1.
     */
    ...
    /**
     * ID: 1760<br> Message: Clan member $s1's name title has been changed to $2.
     */
    public static final SystemMessageId CLAN_MEMBER_S1_TITLE_CHANGED_TO_S2;

    /**
     * ID: 1761<br> Message: Clan member $s1's privilege level has been changed to $s2.
     */
    ...
    /**
     * ID: 1763<br> Message: $s2, clan member $s1's apprentice, has been removed.
     */
    public static final SystemMessageId S2_CLAN_MEMBER_S1_APPRENTICE_HAS_BEEN_REMOVED;

    /**
     * ID: 1764<br> Message: This item can only be worn by a member of the Clan Academy.
     */
    public static final SystemMessageId EQUIP_ONLY_FOR_ACADEMY;

    /**
     * ID: 1765<br> Message: As a graduate of the Clan Academy, you can no longer wear this item.
     */
    public static final SystemMessageId EQUIP_NOT_FOR_GRADUATES;

    /**
     * ID: 1766<br> Message: An application to join the clan has been sent to $s1 in $s2.
     */
    public static final SystemMessageId CLAN_JOIN_APPLICATION_SENT_TO_S1_IN_S2;

    /**
     * ID: 1767<br> Message: An application to join the clan Academy has been sent to $s1.
     */
    public static final SystemMessageId ACADEMY_JOIN_APPLICATION_SENT_TO_S1;

    /**
     * ID: 1768<br> Message: $s1 has invited you to join the Clan Academy of $s2 clan. Would you like to join?
     */
    public static final SystemMessageId JOIN_REQUEST_BY_S1_TO_CLAN_S2_ACADEMY;

    /**
     * ID: 1769<br> Message: $s1 has sent you an invitation to join the $s3 Order of Knights under the $s2 clan. Would
     * you like to join?
     */
    public static final SystemMessageId JOIN_REQUEST_BY_S1_TO_ORDER_OF_KNIGHTS_S3_UNDER_CLAN_S2;

    /**
     * ID: 1770<br> Message: The clan's reputation score has dropped below 0. The clan may face certain penalties as a
     * result.
     */
    public static final SystemMessageId CLAN_REPU_0_MAY_FACE_PENALTIES;

    /**
     * ID: 1771<br> Message: Now that your clan level is above Level 5, it can accumulate clan reputation points.
     */
    public static final SystemMessageId CLAN_CAN_ACCUMULATE_CLAN_REPUTATION_POINTS;

    /**
     * ID: 1772<br> Message: Since your clan was defeated in a siege, $s1 points have been deducted from your clan's
     * reputation score and given to the opposing clan.
     */
    public static final SystemMessageId CLAN_WAS_DEFEATED_IN_SIEGE_AND_LOST_S1_REPUTATION_POINTS;

    /**
     * ID: 1773<br> Message: Since your clan emerged victorious from the siege, $s1 points have been added to your
     * clan's reputation score.
     */
    public static final SystemMessageId CLAN_VICTORIOUS_IN_SIEGE_AND_GAINED_S1_REPUTATION_POINTS;

    /**
     * ID: 1774<br> Message: Your clan's newly acquired contested clan hall has added $s1 points to your clan's
     * reputation score.
     */
    public static final SystemMessageId CLAN_ACQUIRED_CONTESTED_CLAN_HALL_AND_S1_REPUTATION_POINTS;

    /**
     * ID: 1775<br> Message: Clan member $s1 was an active member of the highest-ranked party in the Festival of
    ...
    /**
     * ID: 1776<br> Message: Clan member $s1 was named a hero. $2s points have been added to your clan's reputation
     * score.
     */
    public static final SystemMessageId CLAN_MEMBER_S1_BECAME_HERO_AND_GAINED_S2_REPUTATION_POINTS;

    /**
     * ID: 1777<br> Message: You have successfully completed a clan quest. $s1 points have been added to your clan's
     * reputation score.
     */
    public static final SystemMessageId CLAN_QUEST_COMPLETED_AND_S1_POINTS_GAINED;

    /**
     * ID: 1778<br> Message: An opposing clan has captured your clan's contested clan hall. $s1 points have been
    ...
    /**
     * ID: 1779<br> Message: After losing the contested clan hall, 300 points have been deducted from your clan's
     * reputation score.
     */
    public static final SystemMessageId CLAN_LOST_CONTESTED_CLAN_HALL_AND_300_POINTS;

    /**
     * ID: 1780<br> Message: Your clan has captured your opponent's contested clan hall. $s1 points have been deducted
     * from your opponent's clan reputation score.
     */
    public static final SystemMessageId CLAN_CAPTURED_CONTESTED_CLAN_HALL_AND_S1_POINTS_DEDUCTED_FROM_OPPONENT;

    /**
     * ID: 1781<br> Message: Your clan has added $1s points to its clan reputation score.
     */
    public static final SystemMessageId CLAN_ADDED_S1S_POINTS_TO_REPUTATION_SCORE;

    /**
     * ID: 1782<br> Message: Your clan member $s1 was killed. $s2 points have been deducted from your clan's reputation
     * score and added to your opponent's clan reputation score.
     */
    public static final SystemMessageId CLAN_MEMBER_S1_WAS_KILLED_AND_S2_POINTS_DEDUCTED_FROM_REPUTATION;

    /**
     * ID: 1783<br> Message: For killing an opposing clan member, $s1 points have been deducted from your opponents'
    ...
    /**
     * ID: 1784<br> Message: Your clan has failed to defend the castle. $s1 points have been deducted from your clan's
     * reputation score and added to your opponents'.
     */
    public static final SystemMessageId YOUR_CLAN_FAILED_TO_DEFEND_CASTLE_AND_S1_POINTS_LOST_AND_ADDED_TO_OPPONENT;

    /**
     * ID: 1785<br> Message: The clan you belong to has been initialized. $s1 points have been deducted from your clan
     * reputation score.
     */
    public static final SystemMessageId YOUR_CLAN_HAS_BEEN_INITIALIZED_AND_S1_POINTS_LOST;

    /**
     * ID: 1786<br> Message: Your clan has failed to defend the castle. $s1 points have been deducted from your clan's
     * reputation score.
     */
    public static final SystemMessageId YOUR_CLAN_FAILED_TO_DEFEND_CASTLE_AND_S1_POINTS_LOST;

    /**
     * ID: 1787<br> Message: $s1 points have been deducted from the clan's reputation score.
     */
    ...
    /**
     * ID: 1789<br> Message: Since the Clan Reputation Score has dropped to 0 or lower, your clan skill(s) will be
     * de-activated.
     */
    public static final SystemMessageId REPUTATION_POINTS_0_OR_LOWER_CLAN_SKILLS_DEACTIVATED;

    /**
     * ID: 1790<br> Message: The conditions necessary to increase the clan's level have not been met.
     */
    public static final SystemMessageId FAILED_TO_INCREASE_CLAN_LEVEL;

    /**
     * ID: 1791<br> Message: The conditions necessary to create a military unit have not been met.
     */
    public static final SystemMessageId YOU_DO_NOT_MEET_CRITERIA_IN_ORDER_TO_CREATE_A_MILITARY_UNIT;

    /**
     * ID: 1792<br> Message: Please assign a manager for your new Order of Knights.
     */
    public static final SystemMessageId ASSIGN_MANAGER_FOR_ORDER_OF_KNIGHTS;

    /**
     * ID: 1793<br> Message: $s1 has been selected as the captain of $s2.
     */
    ...
    /**
     * ID: 1796<br> Message: Your account has been suspended ...
     */
    public static final SystemMessageId ILLEGAL_USE17;

    /**
     * ID: 1797<br> Message: $s1 has been promoted to $s2.
     */
    ...
    /**
     * ID: 1799<br> Message: We are searching for BOT users. Please try again later.
     */
    public static final SystemMessageId SEARCHING_FOR_BOT_USERS_TRY_AGAIN_LATER;

    /**
     * ID: 1800<br> Message: User $s1 has a history of using BOT.
     */
    public static final SystemMessageId S1_HISTORY_USING_BOT;

    /**
     * ID: 1801<br> Message: The attempt to sell has failed.
     */
    public static final SystemMessageId SELL_ATTEMPT_FAILED;

    /**
     * ID: 1802<br> Message: The attempt to trade has failed.
     */
    public static final SystemMessageId TRADE_ATTEMPT_FAILED;

    /**
     * ID: 1803<br> Message: The request to participate in the game cannot be made starting from 10 minutes before the
     * end of the game.
     */
    public static final SystemMessageId GAME_REQUEST_CANNOT_BE_MADE;

    /**
     * ID: 1804<br> Message: Your account has been suspended ...
     */
    public static final SystemMessageId ILLEGAL_USE18;

    /**
     * ID: 1805<br> Message: Your account has been suspended ...
     */
    public static final SystemMessageId ILLEGAL_USE19;

    /**
     * ID: 1806<br> Message: Your account has been suspended ...
     */
    public static final SystemMessageId ILLEGAL_USE20;

    /**
     * ID: 1807<br> Message: Your account has been suspended ...
     */
    public static final SystemMessageId ILLEGAL_USE21;

    /**
     * ID: 1808<br> Message: Your account has been suspended ...
     */
    public static final SystemMessageId ILLEGAL_USE22;

    /**
     * ID: 1809<br> please visit the PlayNC website (http://www.plaync.com/us/support/)
     */
    public static final SystemMessageId ACCOUNT_MUST_VERIFIED;

    /**
     * ID: 1810<br> Message: The refuse invitation state has been activated.
     */
    public static final SystemMessageId REFUSE_INVITATION_ACTIVATED;

    /**
     * ID: 1812<br> Message: Since the refuse invitation state is currently activated, no invitation can be made
     */
    ...
    /**
     * ID: 1819<br> Message: An evil is pulsating from $s2 in $s1.
     */
    public static final SystemMessageId EVIL_FROM_S2_IN_S1;

    /**
     * ID: 1820<br> Message: $s1 is currently asleep.
     */
    public static final SystemMessageId S1_CURRENTLY_SLEEP;

    /**
     * ID: 1821<br> Message: $s2's evil presence is felt in $s1.
     */
    public static final SystemMessageId S2_EVIL_PRESENCE_FELT_IN_S1;

    /**
     * ID: 1822<br> Message: $s1 has been sealed.
     */
    public static final SystemMessageId S1_SEALED;

    /**
     * ID: 1823<br> Message: The registration period for a clan hall war has ended.
     */
    public static final SystemMessageId CLANHALL_WAR_REGISTRATION_PERIOD_ENDED;

    /**
     * ID: 1824<br> Message: You have been registered for a clan hall war. Please move to the left side of the clan
     * hall's arena and get ready.
     */
    public static final SystemMessageId REGISTERED_FOR_CLANHALL_WAR;

    /**
     * ID: 1825<br> Message: You have failed in your attempt to register for the clan hall war. Please try again.
     */
    public static final SystemMessageId CLANHALL_WAR_REGISTRATION_FAILED;

    /**
     * ID: 1826<br> Message: In $s1 minute(s), the game will begin. All players must hurry and move to the left side of
     * the clan hall's arena.
     */
    public static final SystemMessageId CLANHALL_WAR_BEGINS_IN_S1_MINUTES;

    /**
     * ID: 1827<br> Message: In $s1 minute(s), the game will begin. All players must, please enter the arena now
     */
    public static final SystemMessageId CLANHALL_WAR_BEGINS_IN_S1_MINUTES_ENTER_NOW;

    /**
     * ID: 1828<br> Message: In $s1 seconds(s), the game will begin.
     */
    public static final SystemMessageId CLANHALL_WAR_BEGINS_IN_S1_SECONDS;

    /**
     * ID: 1829<br> Message: The Command Channel is full.
     */
    public static final SystemMessageId COMMAND_CHANNEL_FULL;

    /**
     * ID: 1830<br> Message: $s1 is not allowed to use the party room invite command. Please update the waiting list.
     */
    public static final SystemMessageId S1_NOT_ALLOWED_INVITE_TO_PARTY_ROOM;

    /**
     * ID: 1831<br> Message: $s1 does not meet the conditions of the party room. Please update the waiting list.
     */
    public static final SystemMessageId S1_NOT_MEET_CONDITIONS_FOR_PARTY_ROOM;

    /**
     * ID: 1832<br> Message: Only a room leader may invite others to a party room.
     */
    public static final SystemMessageId ONLY_ROOM_LEADER_CAN_INVITE;

    /**
     * ID: 1833<br> Message: All of $s1 will be dropped. Would you like to continue?
     */
    public static final SystemMessageId CONFIRM_DROP_ALL_OF_S1;

    /**
     * ID: 1834<br> Message: The party room is full. No more characters can be invitet in
     */
    public static final SystemMessageId PARTY_ROOM_FULL;

    /**
     * ID: 1835<br> Message: $s1 is full and cannot accept additional clan members at this time.
     */
    public static final SystemMessageId S1_CLAN_IS_FULL;

    /**
     * ID: 1836<br> Message: You cannot join a Clan Academy because you have successfully completed your 2nd class
     * transfer.
     */
    public static final SystemMessageId CANNOT_JOIN_ACADEMY_AFTER_2ND_OCCUPATION;

    /**
     * ID: 1837<br> Message: $s1 has sent you an invitation to join the $s3 Royal Guard under the $s2 clan. Would you
     * like to join?
     */
    public static final SystemMessageId S1_SENT_INVITATION_TO_ROYAL_GUARD_S3_OF_CLAN_S2;

    /**
     * ID: 1838<br> Message: 1. The coupon an be used once per character.
     */
    public static final SystemMessageId COUPON_ONCE_PER_CHARACTER;

    /**
     * ID: 1839<br> Message: 2. A used serial number may not be used again.
     */
    public static final SystemMessageId SERIAL_MAY_USED_ONCE;

    /**
     * ID: 1840<br> Message: 3. If you enter the incorrect serial number more than 5 times, ...
     */
    public static final SystemMessageId SERIAL_INPUT_INCORRECT;

    /**
     * ID: 1841<br> Message: The clan hall war has been cancelled. Not enough clans have registered.
     */
    ...
    /**
     * ID: 1845<br> Message: Hero weapons cannot be destroyed.
     */
    public static final SystemMessageId HERO_WEAPONS_CANT_DESTROYED;

    /**
     * ID: 1846<br> Message: You are too far away from the Strider to mount it.
     */
    public static final SystemMessageId TOO_FAR_AWAY_FROM_STRIDER_TO_MOUNT;

    /**
     * ID: 1847<br> Message: You caught a fish $s1 in length.
     */
    public static final SystemMessageId CAUGHT_FISH_S1_LENGTH;

    /**
     * ID: 1848<br> Message: Because of the size of fish caught, you will be registered in the ranking
     */
    public static final SystemMessageId REGISTERED_IN_FISH_SIZE_RANKING;

    /**
     * ID: 1849<br> Message: All of $s1 will be discarded. Would you like to continue?
     */
    public static final SystemMessageId CONFIRM_DISCARD_ALL_OF_S1;

    /**
     * ID: 1850<br> Message: The Captain of the Order of Knights cannot be appointed.
     */
    ...
    /**
     * ID: 1852<br> Message: The attempt to acquire the skill has failed because of an insufficient Clan Reputation
     * Score.
     */
    public static final SystemMessageId ACQUIRE_SKILL_FAILED_BAD_CLAN_REP_SCORE;

    /**
     * ID: 1853<br> Message: Quantity items of the same type cannot be exchanged at the same time
     */
    public static final SystemMessageId CANT_EXCHANGE_QUANTITY_ITEMS_OF_SAME_TYPE;

    /**
     * ID: 1854<br> Message: The item was converted successfully.
     */
    public static final SystemMessageId ITEM_CONVERTED_SUCCESSFULLY;

    /**
     * ID: 1855<br> Message: Another military unit is already using that name. Please enter a different name.
     */
    public static final SystemMessageId ANOTHER_MILITARY_UNIT_IS_ALREADY_USING_THAT_NAME;

    /**
     * ID: 1856<br> Message: Since your opponent is now the owner of $s1, the Olympiad has been cancelled.
     */
    public static final SystemMessageId OPPONENT_POSSESSES_S1_OLYMPIAD_CANCELLED;

    /**
     * ID: 1857<br> Message: $s1 is the owner of $s2 and cannot participate in the Olympiad.
     */
    public static final SystemMessageId S1_OWNS_S2_AND_CANNOT_PARTICIPATE_IN_OLYMPIAD;

    /**
     * ID: 1858<br> Message: You cannot participate in the Olympiad while dead.
     */
    public static final SystemMessageId CANNOT_PARTICIPATE_OLYMPIAD_WHILE_DEAD;

    /**
     * ID: 1859<br> Message: You exceeded the quantity that can be moved at one time.
     */
    ...
    /**
     * ID: 1862<br> Message: Clan skills will now be activated since the clan's reputation score is 0 or higher.
     */
    public static final SystemMessageId CLAN_SKILLS_WILL_BE_ACTIVATED_SINCE_REPUTATION_IS_0_OR_HIGHER;

    /**
     * ID: 1863<br> Message: $s1 purchased a clan item, reducing the Clan Reputation by $s2 points.
     */
    public static final SystemMessageId S1_PURCHASED_CLAN_ITEM_REDUCING_S2_REPU_POINTS;

    /**
     * ID: 1864<br> Message: Your pet/servitor is unresponsive and will not obey any orders.
     */
    public static final SystemMessageId PET_REFUSING_ORDER;

    /**
     * ID: 1865<br> Message: Your pet/servitor is currently in a state of distress.
     */
    ...
    /**
     * ID: 1868<br> Message: You cannot exchange an item while it is being used.
     */
    public static final SystemMessageId CANNOT_EXCHANCE_USED_ITEM;

    /**
     * ID: 1869<br> Message: $s1 has granted the Command Channel's master party the privilege of item looting.
     */
    public static final SystemMessageId S1_GRANTED_MASTER_PARTY_LOOTING_RIGHTS;

    /**
     * ID: 1870<br> Message: A Command Channel with looting rights already exists.
     */
    public static final SystemMessageId COMMAND_CHANNEL_WITH_LOOTING_RIGHTS_EXISTS;

    /**
     * ID: 1871<br> Message: Do you want to dismiss $s1 from the clan?
     */
    public static final SystemMessageId CONFIRM_DISMISS_S1_FROM_CLAN;

    /**
     * ID: 1872<br> Message: You have $s1 hour(s) and $s2 minute(s) left.
     */
    public static final SystemMessageId S1_HOURS_S2_MINUTES_LEFT;

    /**
     * ID: 1873<br> Message: There are $s1 hour(s) and $s2 minute(s) left in the fixed use time for this PC Cafe.
     */
    public static final SystemMessageId S1_HOURS_S2_MINUTES_LEFT_FOR_THIS_PCCAFE;

    /**
     * ID: 1874<br> Message: There are $s1 minute(s) left for this individual user.
     */
    public static final SystemMessageId S1_MINUTES_LEFT_FOR_THIS_USER;

    /**
     * ID: 1875<br> Message: There are $s1 minute(s) left in the fixed use time for this PC Cafe.
     */
    public static final SystemMessageId S1_MINUTES_LEFT_FOR_THIS_PCCAFE;

    /**
     * ID: 1876<br> Message: Do you want to leave $s1 clan?
     */
    public static final SystemMessageId CONFIRM_LEAVE_S1_CLAN;

    /**
     * ID: 1877<br> Message: The game will end in $s1 minutes.
     */
    public static final SystemMessageId GAME_WILL_END_IN_S1_MINUTES;

    /**
     * ID: 1878<br> Message: The game will end in $s1 seconds.
     */
    public static final SystemMessageId GAME_WILL_END_IN_S1_SECONDS;

    /**
     * ID: 1879<br> Message: In $s1 minute(s), you will be teleported outside of the game arena.
     */
    public static final SystemMessageId IN_S1_MINUTES_TELEPORTED_OUTSIDE_OF_GAME_ARENA;

    /**
     * ID: 1880<br> Message: In $s1 seconds(s), you will be teleported outside of the game arena.
     */
    public static final SystemMessageId IN_S1_SECONDS_TELEPORTED_OUTSIDE_OF_GAME_ARENA;

    /**
     * ID: 1881<br> Message: The preliminary match will begin in $s1 second(s). Prepare yourself.
     */
    public static final SystemMessageId PRELIMINARY_MATCH_BEGIN_IN_S1_SECONDS;

    /**
     * ID: 1882<br> Message: Characters cannot be created from this server.
     */
    public static final SystemMessageId CHARACTERS_NOT_CREATED_FROM_THIS_SERVER;

    /**
     * ID: 1883<br> Message: There are no offerings I own or I made a bid for.
     */
    public static final SystemMessageId NO_OFFERINGS_OWN_OR_MADE_BID_FOR;

    /**
     * ID: 1884<br> Message: Enter the PC Room coupon serial number.
     */
    public static final SystemMessageId ENTER_PCROOM_SERIAL_NUMBER;

    /**
     * ID: 1885<br> Message: This serial number cannot be entered. Please try again in minute(s).
     */
    public static final SystemMessageId SERIAL_NUMBER_CANT_ENTERED;

    /**
     * ID: 1886<br> Message: This serial has already been used.
     */
    public static final SystemMessageId SERIAL_NUMBER_ALREADY_USED;

    /**
     * ID: 1887<br> Message: Invalid serial number. Your attempt to enter the number has failed time(s). You will be
     * allowed to make more attempt(s).
     */
    public static final SystemMessageId SERIAL_NUMBER_ENTERING_FAILED;

    /**
     * ID: 1888<br> Message: Invalid serial number. Your attempt to enter the number has failed 5 time(s). Please try
     * again in 4 hours.
     */
    public static final SystemMessageId SERIAL_NUMBER_ENTERING_FAILED_5_TIMES;

    /**
     * ID: 1889<br> Message: Congratulations! You have received $s1.
     */
    public static final SystemMessageId CONGRATULATIONS_RECEIVED_S1;

    /**
     * ID: 1890<br> Message: Since you have already used this coupon, you may not use this serial number.
     */
    public static final SystemMessageId ALREADY_USED_COUPON_NOT_USE_SERIAL_NUMBER;

    /**
     * ID: 1891<br> Message: You may not use items in a private store or private work shop.
     */
    public static final SystemMessageId NOT_USE_ITEMS_IN_PRIVATE_STORE;

    /**
     * ID: 1892<br> Message: The replay file for the previous version cannot be played.
     */
    public static final SystemMessageId REPLAY_FILE_PREVIOUS_VERSION_CANT_PLAYED;

    /**
     * ID: 1893<br> Message: This file cannot be replayed.
     */
    public static final SystemMessageId FILE_CANT_REPLAYED;

    /**
     * ID: 1894<br> Message: A sub-class cannot be created or changed while you are over your weight limit.
     */
    public static final SystemMessageId NOT_SUBCLASS_WHILE_OVERWEIGHT;

    /**
     * ID: 1895<br> Message: $s1 is in an area which blocks summoning.
     */
    public static final SystemMessageId S1_IN_SUMMON_BLOCKING_AREA;

    /**
     * ID: 1896<br> Message: $s1 has already been summoned.
     */
    public static final SystemMessageId S1_ALREADY_SUMMONED;

    /**
     * ID: 1897<br> Message: $s1 is required for summoning.
     */
    public static final SystemMessageId S1_REQUIRED_FOR_SUMMONING;

    /**
     * ID: 1898<br> Message: $s1 is currently trading or operating a private store and cannot be summoned.
     */
    ...
    /**
     * ID: 1900<br> Message: $s1 has entered the party room.
     */
    public static final SystemMessageId S1_ENTERED_PARTY_ROOM;

    /**
     * ID: 1901<br> Message: $s1 has invited you to enter the party room.
     */
    ...
    /**
     * ID: 1903<br> Message: Those of you who have requested NCOTP should run NCOTP by using your cell phone [...]
     */
    public static final SystemMessageId NCOTP;

    /**
     * ID: 1904<br> Message: A sub-class may not be created or changed while a servitor or pet is summoned.
     */
    public static final SystemMessageId CANT_SUBCLASS_WITH_SUMMONED_SERVITOR;

    /**
     * ID: 1905<br> Message: $s2 of $s1 will be replaced with $s4 of $s3.
     */
    public static final SystemMessageId S2_OF_S1_WILL_REPLACED_WITH_S4_OF_S3;

    /**
     * ID: 1906<br> Message: Select the combat unit
     */
    public static final SystemMessageId SELECT_COMBAT_UNIT;

    /**
     * ID: 1907<br> Message: Select the character who will [...]
     */
    public static final SystemMessageId SELECT_CHARACTER_WHO_WILL;

    /**
     * ID: 1908<br> Message: $s1 in a state which prevents summoning.
     */
    public static final SystemMessageId S1_STATE_FORBIDS_SUMMONING;

    /**
     * ID: 1909<br> Message: ==< List of Academy Graduates During the Past Week >==
     */
    public static final SystemMessageId ACADEMY_LIST_HEADER;

    /**
     * ID: 1910<br> Message: Graduates: $s1.
     */
    public static final SystemMessageId GRADUATES_S1;

    /**
     * ID: 1911<br> Message: You cannot summon players who are currently participating in the Grand Olympiad.
     */
    public static final SystemMessageId YOU_CANNOT_SUMMON_PLAYERS_WHO_ARE_IN_OLYMPIAD;

    /**
     * ID: 1912<br> Message: Only those requesting NCOTP should make an entry into this field.
     */
    public static final SystemMessageId NCOTP2;

    /**
     * ID: 1913<br> Message: The remaining recycle time for $s1 is $s2 minute(s).
     */
    public static final SystemMessageId TIME_FOR_S1_IS_S2_MINUTES_REMAINING;

    /**
     * ID: 1914<br> Message: The remaining recycle time for $s1 is $s2 seconds(s).
     */
    public static final SystemMessageId TIME_FOR_S1_IS_S2_SECONDS_REMAINING;

    /**
     * ID: 1915<br> Message: The game will end in $s1 second(s).
     */
    ...
    /**
     * ID: 1918<br> Message: Your pet is too high level to control.
     */
    ...
    /**
     * ID: 1920<br> Message: Your account is currently inactive because you have not logged into the game for some time.
    ...
    /**
     * ID: 1921<br> Message: $s2 hour(s) and $s3 minute(s) have passed since $s1 has killed.
     */
    public static final SystemMessageId S2_HOURS_S3_MINUTES_SINCE_S1_KILLED;

    /**
     * ID: 1922<br> Message: Because $s1 has failed to kill for one full day, it has expired.
     */
    public static final SystemMessageId S1_FAILED_KILLING_EXPIRED;

    /**
     * ID: 1923<br> Message: Court Magician: The portal has been created!
     */
    public static final SystemMessageId COURT_MAGICIAN_CREATED_PORTAL;

    /**
     * ID: 1924<br> Message: Current Location: $s1, $s2, $s3 (Near the Primeval Isle)
     */
    public static final SystemMessageId LOC_PRIMEVAL_ISLE_S1_S2_S3;

    /**
     * ID: 1925<br> Message: Due to the affects of the Seal of Strife, it is not possible to summon at this time.
     */
    public static final SystemMessageId SEAL_OF_STRIFE_FORBIDS_SUMMONING;

    /**
     * ID: 1926<br> Message: There is no opponent to receive your challenge for a duel.
     */
    ...
    /**
     * ID: 1929<br> Message: $s1 has accepted your challenge to a duel. The duel will begin in a few moments.
     */
    public static final SystemMessageId S1_HAS_ACCEPTED_YOUR_CHALLENGE_TO_A_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS;

    /**
     * ID: 1930<br> Message: You have accepted $s1's challenge to a duel. The duel will begin in a few moments.
     */
    ...
    /**
     * ID: 1932<br> Message: $s1 has declined your challenge to a duel.
     */
    public static final SystemMessageId S1_HAS_DECLINED_YOUR_CHALLENGE_TO_A_DUEL2;

    /**
     * ID: 1933<br> Message: You have accepted $s1's challenge to a party duel. The duel will begin in a few moments.
     */
    public static final SystemMessageId YOU_HAVE_ACCEPTED_S1_CHALLENGE_TO_A_PARTY_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS;

    /**
     * ID: 1934<br> Message: $s1 has accepted your challenge to duel against their party. The duel will begin in a few
     * moments.
     */
    ...
    /**
     * ID: 1935<br> Message: $s1 has declined your challenge to a party duel.
     */
    public static final SystemMessageId S1_HAS_DECLINED_YOUR_CHALLENGE_TO_A_PARTY_DUEL;

    /**
     * ID: 1936<br> Message: The opposing party has declined your challenge to a duel.
     */
    public static final SystemMessageId THE_OPPOSING_PARTY_HAS_DECLINED_YOUR_CHALLENGE_TO_A_DUEL;

    /**
     * ID: 1937<br> Message: Since the person you challenged is not currently in a party, they cannot duel against your
     * party.
     */
    ...
    /**
     * ID: 1941<br> Message: This is no suitable place to challenge anyone or party to a duel.
     */
    public static final SystemMessageId NO_PLACE_FOR_DUEL;

    /**
     * ID: 1942<br> Message: The opposing party is currently unable to accept a challenge to a duel.
     */
    public static final SystemMessageId THE_OPPOSING_PARTY_IS_CURRENTLY_UNABLE_TO_ACCEPT_A_CHALLENGE_TO_A_DUEL;

    /**
     * ID: 1943<br> Message: The opposing party is currently not in a suitable location for a duel.
     */
    public static final SystemMessageId THE_OPPOSING_PARTY_IS_AT_BAD_LOCATION_FOR_A_DUEL;

    /**
     * ID: 1944<br> Message: In a moment, you will be transported to the site where the duel will take place.
     */
    public static final SystemMessageId IN_A_MOMENT_YOU_WILL_BE_TRANSPORTED_TO_THE_SITE_WHERE_THE_DUEL_WILL_TAKE_PLACE;

    /**
     * ID: 1945<br> Message: The duel will begin in $s1 second(s).
     */
    public static final SystemMessageId THE_DUEL_WILL_BEGIN_IN_S1_SECONDS;

    /**
     * ID: 1946<br> Message: $s1 has challenged you to a duel. Will you accept?
     */
    public static final SystemMessageId S1_CHALLENGED_YOU_TO_A_DUEL;

    /**
     * ID: 1947<br> Message: $s1's party has challenged your party to a duel. Will you accept?
     */
    public static final SystemMessageId S1_CHALLENGED_YOU_TO_A_PARTY_DUEL;

    /**
     * ID: 1948<br> Message: The duel will begin in $s1 second(s).
     */
    ...
    /**
     * ID: 1953<br> Message: Since $s1 was disqualified, $s2 has won.
     */
    public static final SystemMessageId SINCE_S1_WAS_DISQUALIFIED_S2_HAS_WON;

    /**
     * ID: 1954<br> Message: Since $s1's party was disqualified, $s2's party has won.
     */
    ...
    /**
     * ID: 1956<br> Message: Since $s1's party withdrew from the duel, $s2's party has won.
     */
    ...
    /**
     * ID: 1975<br> Message: You cannot augment items while engaged in trade activities.
     */
    ...
    /**
     * ID: 1981<br> Message: $s1's remaining Mana is now 1. It will disappear soon.
     */
    public static final SystemMessageId S1S_REMAINING_MANA_IS_NOW_1;

    /**
     * ID: 1982<br> Message: $s1's remaining Mana is now 0, and the item has disappeared.
     */
    ...
    /**
     * ID: 2012<br> Message: $s1 has been activated.
     */
    public static final SystemMessageId S1_HAS_BEEN_ACTIVATED;

    /**
     * ID: 2013<br> Message: Your seed or remaining purchase amount is inadequate.
     */
    public static final SystemMessageId YOUR_SEED_OR_REMAINING_PURCHASE_AMOUNT_IS_INADEQUATE;

    /**
     * ID: 2014<br> Message: You cannot proceed because the manor cannot accept any more crops. All crops have been
     * returned and no adena withdrawn.
     */
    public static final SystemMessageId MANOR_CANT_ACCEPT_MORE_CROPS;

    /**
     * ID: 2015<br> Message: A skill is ready to be used again.
     */
    public static final SystemMessageId SKILL_READY_TO_USE_AGAIN;

    /**
     * ID: 2016<br> Message: A skill is ready to be used again but its re-use counter time has increased.
     */
    public static final SystemMessageId SKILL_READY_TO_USE_AGAIN_BUT_TIME_INCREASED;

    /**
     * ID: 2017<br> Message: $s1 cannot duel because $s1 is currently engaged in a private store or manufacture.
     */
    ...
    /**
     * ID: 2020<br> Message: $s1 cannot make a challenge to a duel because $s1 is currently in a duel-prohibited area
     * (Peaceful Zone / Seven Signs Zone / Near Water / Restart Prohibited Area).
     */
    ...
    /**
     * ID: 2021<br> Message: $s1 cannot duel because $s1 is currently engaged in battle.
     */
    public static final SystemMessageId S1_CANNOT_DUEL_BECAUSE_S1_IS_CURRENTLY_ENGAGED_IN_BATTLE;

    /**
     * ID: 2022<br> Message: $s1 cannot duel because $s1 is already engaged in a duel.
     */
    ...
    /**
     * ID: 2024<br> Message: $s1 cannot duel because $s1 is participating in the Olympiad.
     */
    public static final SystemMessageId S1_CANNOT_DUEL_BECAUSE_S1_IS_PARTICIPATING_IN_THE_OLYMPIAD;

    /**
     * ID: 2025<br> Message: $s1 cannot duel because $s1 is participating in a clan hall war.
     */
    public static final SystemMessageId S1_CANNOT_DUEL_BECAUSE_S1_IS_PARTICIPATING_IN_A_CLAN_HALL_WAR;

    /**
     * ID: 2026<br> Message: $s1 cannot duel because $s1 is participating in a siege war.
     */
    public static final SystemMessageId S1_CANNOT_DUEL_BECAUSE_S1_IS_PARTICIPATING_IN_A_SIEGE_WAR;

    /**
     * ID: 2027<br> Message: $s1 cannot duel because $s1 is currently riding a boat or strider.
     */
    public static final SystemMessageId S1_CANNOT_DUEL_BECAUSE_S1_IS_CURRENTLY_RIDING_A_BOAT_WYVERN_OR_STRIDER;

    /**
     * ID: 2028<br> Message: $s1 cannot receive a duel challenge because $s1 is too far away.
     */
    public static final SystemMessageId S1_CANNOT_RECEIVE_A_DUEL_CHALLENGE_BECAUSE_S1_IS_TOO_FAR_AWAY;

    /**
     * ID: 2029<br> Message: $s1 is currently teleporting and cannot participate in the Olympiad.
     */
    public static final SystemMessageId S1_CANNOT_PARTICIPATE_IN_OLYMPIAD_DURING_TELEPORT;

    /**
     * ID: 2030<br> Message: You are currently logging in.
     */
    public static final SystemMessageId CURRENTLY_LOGGING_IN;

    /**
     * ID: 2031<br> Message: Please wait a moment.
     */
    public static final SystemMessageId PLEASE_WAIT_A_MOMENT;
    /**
     * ID: 2032 Message: Spent talent point on $s1?
     */
    public static final SystemMessageId YOU_WANT_TO_LEARN_S1;

    /**
     * ID: 2033<br> Message: У вас нет карт, которые можно синтезировать.
     */
    public static final SystemMessageId YOU_DONT_HAVE_CARDS_FOR_SYNTHESIS;

    /**
     * ID: 2034<br> Message: У вас нет карт, которые можно подвергнуть десинтезу.
     */
    public static final SystemMessageId YOU_DONT_HAVE_CARDS_FOR_DESYNTHESIS;

    public static final SystemMessageId CANT_REPAIR_ITEM_NOT_FOUND;

    public static final SystemMessageId CANT_REPAIR_ONLY_DURABILITY_LOSS;

    public static final SystemMessageId CANT_REPAIR_MASTER_IS_OUT_OF_RANGE;

    public static final SystemMessageId CANT_REPAIR_ONLY_IF_NOT_EQUIPPED;

    public static final SystemMessageId S1_ITEM_REPAIRED;

    public static final SystemMessageId S1_ITEM_UNREPAIRED;

    public static final SystemMessageId YOU_WANT_TO_SPENT_S1_ADENA_FOR_REPAIR;

    public static final SystemMessageId CANT_REPAIR_ALL_ITEMS_ARE_GOOD;

    public static final SystemMessageId ITEMS_WAS_REPAIRED;

    public static final SystemMessageId S1_DENIED_YOUR_REPAIR_SERVICE;

    public static final SystemMessageId YOU_DENIED_S1_REPAIR_SERVICE;

    public static final SystemMessageId YOU_WANT_TO_SPENT_S1_ADENA_FOR_REPAIR_S2;

    /**
     * ID: 2047<br> Message: Your skill was removed due to a lack of CP.
     */
    public static final SystemMessageId SKILL_REMOVED_DUE_LACK_CP;

    /**
     * ID: 2048<br> Message: You hit for $s1 fire damage
     */
    ...
    static {
        ...
        YOU_WANT_TO_LEARN_S1 = new SystemMessageId(2032);
        YOU_DONT_HAVE_CARDS_FOR_SYNTHESIS = new SystemMessageId(2033);
        YOU_DONT_HAVE_CARDS_FOR_DESYNTHESIS = new SystemMessageId(2034);
        CANT_REPAIR_ITEM_NOT_FOUND = new SystemMessageId(2035);
        CANT_REPAIR_ONLY_DURABILITY_LOSS = new SystemMessageId(2036);
        CANT_REPAIR_MASTER_IS_OUT_OF_RANGE = new SystemMessageId(2037);
        CANT_REPAIR_ONLY_IF_NOT_EQUIPPED = new SystemMessageId(2038);
        S1_ITEM_REPAIRED = new SystemMessageId(2039);
        S1_ITEM_UNREPAIRED = new SystemMessageId(2040);
        YOU_WANT_TO_SPENT_S1_ADENA_FOR_REPAIR = new SystemMessageId(2041);
        CANT_REPAIR_ALL_ITEMS_ARE_GOOD = new SystemMessageId(2042);
        ITEMS_WAS_REPAIRED = new SystemMessageId(2043);
        S1_DENIED_YOUR_REPAIR_SERVICE = new SystemMessageId(2044);
        YOU_DENIED_S1_REPAIR_SERVICE = new SystemMessageId(2045);
