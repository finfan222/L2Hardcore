 ...
 * <br>
 * <b>Note:</b><br>
 * Names in points and lines are bugged they will appear even when not looking at them.<br> Packet must be sent using
 * sendTo() method, otherwise nested packets are not sent.
 */
