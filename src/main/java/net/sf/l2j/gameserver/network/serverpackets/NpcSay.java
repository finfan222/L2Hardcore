...
public final class NpcSay extends L2GameServerPacket {
    ...
    /**
     * For non-existing {@link Npc} instances, while we want to use {@link Npc} name.<br> Display a {@link Npc}'s name
     * (from client id).
     *
    ...
    /**
     * The {@link Npc} saying a message.<br> Display a {@link Npc}'s name (from client id). Show message above
     * {@link Npc} instance's head.
     *
    ...
    /**
     * The {@link Summon} saying a message.<br> Display a {@link Npc}'s name (from client id). Show message above
     * {@link Npc} instance's head.
     *
