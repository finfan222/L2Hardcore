...
public class GeoEngine {
    ...
    /**
     * Provides optimize selection of the buffer. When all pre-initialized buffer are locked, creates new buffer and log
     * this situation.
     *
    ...
    /**
     * Returns the height of cell, which is closest to given coordinates.<br> Note: Ignores geodata modification of
     * given {@link IGeoObject}.
     *
     * @param geoX : Cell geodata X coordinate.
     * @param geoY : Cell geodata Y coordinate.
     * @param worldZ : Cell world Z coordinate.
     * @param ignore : The {@link IGeoObject}, which geodata modification is ignored and original geodata picked
     * instead.
     * @return short : Cell geodata Z coordinate, closest to given coordinates.
     */
    ...
    /**
     * Returns the NSWE flag byte of cell, which is closes to given coordinates.<br> Note: Ignores geodata modification
     * of given {@link IGeoObject}.
     *
     * @param geoX : Cell geodata X coordinate.
     * @param geoY : Cell geodata Y coordinate.
     * @param worldZ : Cell world Z coordinate.
    ...
    /**
     * Returns calculated NSWE flag byte as a description of {@link IGeoObject}.<br> The {@link IGeoObject} is defined
     * by boolean 2D array, saying if the object is present on given cell or not.
     *
    ...
    /**
     * Check line of sight from {@link WorldObject} to {@link WorldObject}.<br> Note: If target is {@link IGeoObject}
     * (e.g. {@link Door}), it ignores its geodata modification.
     *
    ...
    /**
     * Check line of sight from {@link WorldObject} to {@link Location}.<br> Note: The check uses {@link Location}'s
     * real Z coordinate (e.g. point above ground), not its geodata representation.
     *
     * @param object : The origin object.
    ...
    /**
     * Simple check for origin to target visibility.<br> Note: Ignores geodata modification of given
     * {@link IGeoObject}.
     *
    ...
    /**
     * Check movement from coordinates to coordinates.<br> Note: The Z coordinates are supposed to be already validated
     * geodata coordinates.
     *
     * @param ox : Origin X coordinate.
     * @param oy : Origin Y coordinate.
    ...
    /**
     * Check movement of object to target coordinates. Returns last accessible point in the checked path.<br> Target X
     * and Y reachable and Z is on same floor:
     * <ul>
    ...
    /**
     * Check movement of object to target. Returns last accessible point in the checked path.<br> Target X and Y
     * reachable and Z is on same floor:
     * <ul>
     * <li>Location of the target with corrected Z value from geodata.</li>
     * </ul>
     * Target X and Y reachable but Z is on another floor:
    ...
    /**
     * Check movement of object to target position. Returns last accessible point in the checked path.<br> Target X and
     * Y reachable and Z is on same floor:
     * <ul>
     * <li>Location of the target with corrected Z value from geodata.</li>
     * </ul>
     * Target X and Y reachable but Z is on another floor:
    ...
    /**
     * Check movement from origin to target positions. Returns last accessible point in the checked path.<br> Target X
     * and Y reachable and Z is on same floor:
     * <ul>
     * <li>Location of the target with corrected Z value from geodata.</li>
     * </ul>
    ...
    /**
     * Check movement from origin to target coordinates. Returns last available point in the checked path.<br> Target X
     * and Y reachable and Z is on same floor:
     * <ul>
     * <li>Location of the target with corrected Z value from geodata.</li>
     * </ul>
