...
public abstract class ABlock {
    ...
    /**
     * Returns the NSWE flag byte of cell, which is closest to given coordinates.<br> Note: Ignores geodata modification
    ...
    /**
     * Returns index to data of the cell, which is closes layer to given coordinates.<br> Note: Ignores geodata
     * modification of given {@link IGeoObject}.
     *
     * @param geoX : Cell geodata X coordinate.
     * @param geoY : Cell geodata Y coordinate.
     * @param worldZ : Cell world Z coordinate.
    ...
    /**
     * Returns index to data of the cell, which is first layer above given coordinates.<br> Note: Ignores geodata
     * modification of given {@link IGeoObject}.
     *
     * @param geoX : Cell geodata X coordinate.
     * @param geoY : Cell geodata Y coordinate.
    ...
    /**
     * Returns index to data of the cell, which is first layer below given coordinates.<br> Note: Ignores geodata
     * modification of given {@link IGeoObject}.
     *
     * @param geoX : Cell geodata X coordinate.
     * @param geoY : Cell geodata Y coordinate.
    ...
    /**
     * Returns the height of cell given by cell index.<br> Note: Ignores geodata modification of given
     * {@link IGeoObject}.
     *
    ...
    /**
     * Returns the NSWE flag byte of cell given by cell index.<br> Note: Ignores geodata modification of given
     * {@link IGeoObject}.
     *
     * @param index : Index of the cell.
     * @param ignore : The {@link IGeoObject}, which geodata modification is ignored and original geodata picked
