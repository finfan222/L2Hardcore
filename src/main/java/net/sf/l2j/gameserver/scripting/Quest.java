...
public class Quest {
    ...
    /**
     * @return An array of registered quest items ids. Those items are automatically destroyed in case a {@link Player}
     * aborts or finishes this {@link Quest}.
     */
    ...
    /**
     * Register all items ids that are automatically destroyed in case a {@link Player} aborts or finishes this
     * {@link Quest}.
     *
    ...
    /**
     * Add a new {@link QuestState} related to this {@link Quest} for the {@link Player} set as parameter to the
    ...
    /**
     * Check a {@link Player}'s {@link QuestState} condition. {@link Player} must be within Config.PARTY_RANGE distance
     * from the {@link Npc}. If {@link Npc} is null, distance condition is ignored.
     *
    ...
    /**
     * Check a {@link Player}'s {@link Clan} leader {@link QuestState} condition. Both of them must be within
     * Config.PARTY_RANGE distance from the {@link Npc}. If {@link Npc} is null, distance condition is ignored.
     *
     * @param player : The {@link Player} who acted towards the {@link Npc}.
     ...
     * <br>
     * Note: This function is only here because of how commonly it may be used by quest developers. For any variations
     * on this function, the quest script can always handle things on its own.
     *
     ...
     * @return The {@link List} of party members, that matches the specified condition, empty list if none matches. If
     * the var is null, empty list is returned (i.e. no condition is applied).
     */
     ...
     * @param value : A tuple specifying a quest condition that must be satisfied for a party member to be considered.
     * @return The {@link QuestState} of random party member, that matches the specified condition, or null if no match.
     * If the var is null, null is returned (i.e. no condition is applied).
     */
    ...
    /**
     * Check the {@link Player}'s {@link QuestState} state. {@link Player} must be within Config.PARTY_RANGE distance
     * from the {@link Npc}.
     *
     * @param player : The {@link Player} who acted towards the {@link Npc}.
     * @param npc : The {@link Npc} used to compare distance.
     ...
     * @return {@link List} of party members, that matches the specified {@link QuestState} state, empty list if none
     * matches.
     */
     ...
     * @param npc : The {@link Npc} used to compare distance.
     * @param state : The {@link QuestState} state to be matched by every party member.
     * @return The {@link QuestState} of random party member, that matches the specified {@link QuestState} state, or
     * null if no match.
     */
    ...
    /**
     * Check a {@link Player}'s {@link Clan} leader {@link QuestState} state. Both of them must be within
     * Config.PARTY_RANGE distance from the {@link Npc}. If {@link Npc} is null, distance condition is ignored.
     *
     * @param player : The {@link Player} who acted towards the {@link Npc}.
     * @param npc : The {@link Npc} used to compare distance (optional).
     * @return The {@link QuestState} of that {@link Player}'s {@link Clan} leader, if existing and online - otherwise,
     * null.
     */
    ...
    /**
     * Drop multiple items to the {@link Player}'s inventory. Rate and amount is affected by DIVMOD of
    ...
    /**
     * Reward {@link Player} with items. The amount is affected by Config.RATE_QUEST_REWARD or
     * Config.RATE_QUEST_REWARD_ADENA.
     *
    ...
    /**
     * Reward {@link Player} with EXP and SP. The amount is affected by Config.RATE_QUEST_REWARD_XP and
     * Config.RATE_QUEST_REWARD_SP.
     *
    ...
    /**
     * @return The default html page "You are either not on a quest that involves this NPC, or you don't meet this NPC's
    ...
    /**
     * @return The default html page "You have already accepted the maximum number of quests. No more than 25 quests may
     * be undertaken simultaneously. For quest information, enter Alt+U."
     */
    ...
    /**
     * Register this {@link Quest} to the {@link Npc}, which will respond to attacking {@link Player} (his
     * {@link Summon}) event.
     *
     * @param npcIds : The ids of the {@link Npc}.
     */
    ...
    /**
     * Register this {@link Quest} to the {@link Npc}, which will respond to {@link Player} (his {@link Summon}) gaining
     * aggro event.
     *
     * @param npcIds : The ids of the {@link Npc}.
     */
    ...
    /**
     * Register this {@link Quest} to the {@link Npc}, which will respond to {@link Npc} seeing other {@link Creature}
     * within 400 range.
     *
     * @param npcIds : The ids of the {@link Npc}.
     */
