...
public class AttackableAIScript extends Quest {
    ...
    /**
     * Implicit constructor for generic AI script.<br> It is used by default for all {@link Attackable} instances.
     */
    ...
    /**
     * A superclass constructor for all inherited AI scripts.<br> Inherited AI provides special behavior for particular
     * {@link Attackable} instances.
     *
    ...
    /**
     * Registers this AI script to the {@link Attackable}'s {@link NpcTemplate} for various {@link ScriptEventType}
     * events.<br> All inherited AI scripts must override this method and register only to related {@link NpcTemplate}s
     * + {@link ScriptEventType}s.<br> Every overridden {@link ScriptEventType} replaces default
     * {@link AttackableAIScript} with the new AI script.
     */
    ...
    /**
     * This method selects a random player.<br> Player can't be dead and isn't an hidden GM aswell.
     *
     * @param npc to check.
    ...
    /**
     * Return the number of players in a defined radius.<br> Dead players aren't counted, invisible ones is the boolean
     * parameter.
     *
    ...
    /**
     * Under that barbarian name, return the number of players in front, back and sides of the npc.<br> Dead players
     * aren't counted, invisible ones is the boolean parameter.
     *
     * @param range : the radius.
     * @param npc : the object to make the test on.
     * @param invisible : true counts invisible characters.
