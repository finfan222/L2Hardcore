...
public final class QuestState extends MemoSet {
    ...
    /**
     * Set condition value of the {@link Player}'s {@link Quest}.<br> Internally handles the progression of the quest so
     * that it is ready for sending appropriate packets to the client<BR>
     * <BR>
     * <U><I>Actions :</I></U><BR>
     ...
     *
     * @param repeatable : If true, we delete progression and if false, we set the {@link QuestStatus} to
