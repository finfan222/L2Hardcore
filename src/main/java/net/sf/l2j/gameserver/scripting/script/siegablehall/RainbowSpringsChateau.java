 ...
 * which is different from previous contested clan hall war styles.<br>
 * <br>
 * In order to own the clan hall, winning is decided through a mini-game. Only a clan level 3 or higher is allowed to
 * participate and the maximum number of clans is four. Participants may have 5 or more member in their party.<br>
 * <br>
 * <b>How to Participate</b><br>
 * <br>
 * A clan leader in possession of a 'Rainbow Springs Clan Hall War Decree' may register to participate through a
 * messenger NPC up to one hour before the contest begins. The top four clans, owning the highest number of Rainbow
 * Springs Clan Hall War Decrees amongst them, will be chosen to compete and their clan leaders notified through a
 * system message.<br>
 * <br>
 * Rainbow Springs Clan Hall War Decrees may be obtained by fishing in the Hot Springs area of Goddard. However, a
 * player must use Hot Springs Bait for fishing bait.<br>
 * <br>
 * If a participating clan requests disorganization in the middle of a siege war registration period, the siege war
 * participation registration is automatically cancelled. However, the certificates are not returned at this time.<br>
 * <br>
 * A participating clan may cancel its participation up until the end of the registration period. If this happens, the
 * clan will only get back half of their submitted certificates.<br>
 * <br>
 * The clan that owns the Rainbow Springs Chateau is automatically registered for the next contest. In this case, the
 * top three clans, owning the highest number of Rainbow Springs Clan Hall War Decrees amongst them, will be chosen to
 * compete.<br>
 * <br>
 ...
 * <br>
 * After clans are selected to compete, the contest is comprised of a one-hour waiting period, a contest time of 58
 * minutes, and an end time of 2 minutes.<br>
 * <br>
 * Registered clans must organize one party with five or more members, with their clan leader as the party leader. The
 * party must move to the arena before the siege war starts and enter the arena through the Caretaker. The surrounding
 * area of the arena is a Peaceful Zone.<br>
 * <br>
 * Participating clans enter into different game fields respectively and through the Caretaker.<br>
 * <br>
 * Upon entering the arena, all buffs that are active on all participating characters will be removed, and summoned
 * pet/servitors will disappear and cannot be summoned back into the arena.<br>
 * <br>
 * Once the contest begins, a Hot Springs Yeti and a Hot Springs Gourd appear in the center of the arena and treasure
 * chests appear randomly throughout the arena.<br>
 * <br>
 * The Hot Springs Yeti announces the game rules and helps guide players.<br>
 * <br>
 * All of the Hot Springs Yeti's shouts may be collected and then exchanged with/for various Hot Springs items. Text
 * exchange or Hot Springs item use is only available to the clan leader and clan members.<br>
 * <br>
 * Participants can break the spawned treasure chests in the arena and can acquire text passages. Text items cannot be
 * exchanged; therefore to give them to other characters, they should be dropped first and then picked up.<br>
 * <br>
 * Treasure Chests can only be damaged with your bare hands, however Mimics can be attacked with P. Atk and M. Atk.<br>
 * <br>
 * When using Hot Springs Nectar, an Enraged Yeti is spawned at certain intervals and interrupts the game. The Enraged
 * Yeti can be attacked with P. Atk. and M. Atk.<br>
 * <br>
 * The Hot Springs items may be used when the Hot Springs Yeti is a target, and they can reduce the HP of the gourd,
 * cast debuff on other teams, change the gourd, or recover.<br>
 * <br>
 * The team that first destroys the Hot Springs Gourd wins the game. All the participants are then teleported outside of
 * the arena after a 2-minute delay.<br>
 * <br>
            ...
            for (int id : ARENA_ZONES) {
                ...
                for (Creature creature : zone.getCharacters()) {
                    for (L2Skill sk : DEBUFFS) {
                        sk.applyEffects(creature, creature);
                    }
                }
            }
        }
