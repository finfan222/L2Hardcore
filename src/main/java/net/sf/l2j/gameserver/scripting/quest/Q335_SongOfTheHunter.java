...
public class Q335_SongOfTheHunter extends Quest {
    ...
    /**
     * Droplist for Grey's test 1 - Apprentice become Hunter license 1:<br> Key : The monster npc ID.<br> Value :
     * Monster drop data:<br> [1] : The dropped quest item.<br> [2] : The required amount of quest item.<br> [3] : The
     * chance.
     */
    ...
    /**
     * Droplist for Grey's test 2 - Hunter license 1 become Hunter license 2:<br> Key : The monster npc ID.<br> Value :
     * Monster drop data:<br> [1] : The dropped quest item.<br> [2] : The required amount of quest item.<br> [3] : The
     * chance.
     */
    ...
    /**
     * Tor's request 1 and 2 drop data.<br> Note: Dropped item id and count is defined in {@link TorRequestReward}.
     */
    class TorRequestDroplist {
        ...
        /**
         * Note:<br> When chance is 5.000.000, it has 100% chance to drop 5 items.<br> When chance is 1.600.000, it has
         * 60% chance to drop 2 items and 40% to drop 1 item.
         *
    ...
    /**
     * Drop data for Tor's request 1 and 2 - Hunting specific monsters under Hunter license 1 or 2.<br> Drop chances are
     * taken from GF.
     */
    ...
    /**
     * Spawn data for Tor's request 1 and 2 - Hunting specific monsters under Hunter license 1 or 2.<br> Note: Spawn
     * chances are taken from GF.
     */
    ...
    /**
     * Droplist for Cybellin's request - Blood Crystals (Hunter license 1 and 2)<br> Since all values are 60% (50% on
     * C4), it is hardcoded on onKill section.
     */
    ...
    /**
     * Rewards for Cybellin's request - Blood Crystals (Hunter license 1 and 2):<br> Key : The returned stage of Blood
     * Crystal.<br> Value : Adena reward.<br>
     */
