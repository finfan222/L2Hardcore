...
public class Q501_ProofOfClanAlliance extends Quest {
    ...
    public String onAdvEvent(String event, Npc npc, Player player) {
        ...
        // Kalis
            ...
            // Apply poison effect.
            SkillTable.getInstance().getInfo(POTION_OF_DEATH, 1).applyEffects(npc, player);
        }
        // Statue of Offering
     ...
     * @return The {@link QuestState} of random party member's {@link Clan} leader, if existing and matching conditions
     * - otherwise, null.
     */
