 ...
 * style of the Devastated Castle clan hall. It is of the highest grade among all contested clan halls.<br>
 * <br>
 * Only a clan level 4 or higher may participate.<br>
 * <br>
 * Siege registration is open up to two hours before a war and is scheduled through the messenger NPC outside of the
 * clan hall.<br>
 * <br>
 * The siege war follows the same rules as Devastated Castle. The siege war goes on for one hour, and the clan that
 * contributes the most to killing Lidia von Hellmann takes possession of the clan hall. If the followers of Lidia von
 * Hellmann, Alfred von Hellmann, and Giselle von Hellmann are killed, the clan hall war will be a lot easier.<br>
 * <br>
 * The siege war ends upon the death of Lidia von Hellmann; just as in Devastated Castle, and if there is no clan that
 * has killed the applicable NPC, the clan hall is under the NPC's possession until the next siege war.<br>
 * <br>
