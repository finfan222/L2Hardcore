...
/**
 * Antharas is one of the great dragons in the history of Aden. This dragon is by far the most fearsome creature in the
 * Lineage II world. The earth tyrant Antharas, also known as Giran's Disaster, has finally awakened from a long, deep
 * slumber.<br>
 * <br>
...
public class Antharas extends AttackableAIScript {
    ...
    public String onTimer(String name, Npc npc, Player player) {
        ...
        if (name.equalsIgnoreCase("regen_task")) {
            ...
            _skillRegen.applyEffects(npc, npc);
        }
    ...
    /**
     * Pick a random skill.<br> The use is based on current HPs ratio.
     *
     * @param npc Antharas
    ...
    /**
     * Update Antharas informations depending about how much players joined the fight.<br> Used when server restarted
     * and Antharas is fighting, or used while the cinematic occurs (after the 30min timer).
     */
