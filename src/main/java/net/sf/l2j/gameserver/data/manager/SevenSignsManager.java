...
public class SevenSignsManager {
    ...
    /**
     * Calculate the number of days until the next period.<BR> A period starts at 18:00 pm (local time), like on
     * official servers.
     */
    ...
    /**
     * Saves all Seven Signs player data.<br> Should be called on period change and shutdown only.
     */
    ...
    /**
     * Used to reset the cabal details of all players, and update the database.<BR> Primarily used when beginning a new
     * cycle, and should otherwise never be called.
     */
    ...
    /**
     * Used to specify cabal-related details for the specified player.<br> This method checks to see if the player has
     * registered before and will update the database if necessary.
     *
     * @param objectId
     * @param cabal
     * @param seal
     ...
     * the point score the contribution was worth.<br> Each stone count <B>must be</B> broken down and specified by the
     * stone's color.
     *
    ...
    /**
     * Calculates the ownership of the three Seals of the Seven Signs, based on various criterias.<BR> Should only ever
