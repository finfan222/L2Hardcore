...
/**
 * This class loads and stores multisell lists under {@link ListContainer}.<br> Each ListContainer contains a List of
 * {@link Entry}, and the list of allowed npcIds.<br>
 * <br>
...
public class MultisellData implements IXmlReader {
     ...
     * <br>
     * {@link ListContainer} template is first retrieved, based on its name, then {@link Npc} npcId check is done for
     * security reason. Then the content is sent into {@link PreparedListContainer}, notably to check Player inventory.
     * Finally a {@link MultiSellList} packet is sent to the Player. That new, prepared list is kept in memory on Player
     * instance, mostly for memory reason.
     *
