...
public class FestivalOfDarknessManager {
    ...
    /**
     * Restores saved festival data, basic settings from the properties file and past high score data from the
     * database.
     */
    ...
    /**
     * Stores current festival data, basic settings to the properties file and past high score data to the
     * database.<BR>
     * <BR>
     ...
     * @return The {@link StatSet} containing the highest score <b>this cycle</b> for the the specified
     * {@link CabalType} and festival id.
     */
    ...
    private class FestivalManager implements Runnable {
        ...
        /**
         * Returns the running instance of a festival for the given Oracle and festivalID. <BR> A <B>null</B> value is
         * returned if there are no participants in that festival.
         *
         * @param oracle
         * @param festivalId
    ...
    private class L2DarknessFestival {
        ...
        /**
         * Used to spawn monsters unique to the festival. <BR> Valid SpawnTypes:<BR> 0 - All Primary Monsters (starting
         * monsters) <BR> 1 - Same as 0, but without archers/marksmen. (used for challenge increase) <BR> 2 - Secondary
         * Monsters (archers) <BR> 3 - Festival Chests
         *
         * @param respawnDelay
         * @param spawnType
         */
