...
/**
 * This class loads and stores {@link Announcement}s, the key being dynamically generated on loading.<br> As the storage
 * is a XML, the whole XML needs to be regenerated on Announcement addition/deletion.
 */
public class AnnouncementData implements IXmlReader {
    ...
    /**
     * Use {@link World#announceToOnlinePlayers(String, boolean)} in order to send announcement, wrapped into a ioobe
     * try/catch.
     *
