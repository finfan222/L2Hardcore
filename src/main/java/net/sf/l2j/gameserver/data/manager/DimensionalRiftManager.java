...
public class DimensionalRiftManager implements IXmlReader {
    ...
    /**
     * Start the {@link DimensionalRift} process for a {@link Player} {@link Party}. Numerous checks are processed
     * (party leader, already rifting, not enough mats, no free cells,...).
     *
     ...
     * @return a {@link List} of all available {@link DimensionalRiftRoom}s. A free room is considered without party
     * inside. Boss room is a valid room according the boolean flag.
     */
