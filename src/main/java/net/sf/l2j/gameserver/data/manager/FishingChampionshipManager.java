...
/**
 * The championship tournament is held on a weekly cycle. During the competition, players vie to catch the biggest fish.
 * The results are ranked based on the size of the fish they caught, with the biggest fish determining the winner.<br>
 * <br>
 * The top five fishers of the first week's tournament will be determined on Tuesday. At that time, a new tournament
 * begins for the second week of the event. Winners for that week will be determined on the following Tuesday. The
 * tournament will continue to run weekly with winners determined every Tuesday.<br>
 * <br>
 * The current status of the tournament can be viewed by clicking the Contest button in the Fishing window. The current
 * results can also be viewed by speaking with a Fisherman's Guild Member after the results of the first week have been
 * calculated.<br>
 * <br>
 * <b>Catching the Big One</b><br>
 * <br>
 * A big fish is measured by length only. Fish between 60.000 and 90.000 can be caught with any normal type of fishing
 * lure, including Lure for Beginners. A Prize-Winning Fishing Lure increases your chances of catching an even larger
 * fish.<br>
 * <br>
 * If you catch a fish worthy of ranking in the tournament, a system message displays to let you know that you have been
 * registered in the current ranking.<br>
 * <br>
 * When more than one competitor has a winning fish that are all the same in size, the person who caught the first fish
 * wins.<br>
 * <br>
 * <b>Claiming the Prize</b><br>
 * <br>
 * Championship prizes are awarded by a Fisherman's Guild Member, and you only have one week to claim your prize. The
 * Fisherman's Guild Member award a weekly prize of Adena based on ranking:
 * <ul>
