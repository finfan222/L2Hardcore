...
public class RaidBossManager {
    ...
    /**
     * Retrieve an existing {@link BossSpawn} based on a {@link RaidBoss} id, and activate it's
     * {@link BossSpawn#onDeath()} method.
     *
    ...
    /**
     * Cleanup data. Cancel all running tasks, save hp/mp and location if boolean flag is true, delete existing
     * {@link BossSpawn} entries.
     *
