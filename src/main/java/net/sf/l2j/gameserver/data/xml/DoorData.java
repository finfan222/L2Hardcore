 ...
 * <br>
 * The different informations help to generate a {@link DoorTemplate} and a GeoObject, then we create the Door instance
 * itself. The spawn is made just after the initialization of this class to avoid NPEs.
 */
public class DoorData implements IXmlReader {
    ...
    /**
     * Spawns {@link Door}s into the world. If this door is associated to a {@link Castle}, we load door upgrade
     * aswell.<br>
     * <br>
     * Note: keep as side-method, do not join to the load(). On initial load, the DoorTable.getInstance() is not
     * initialized, yet Door is calling it during spawn process...causing NPE.
     */
