...
public abstract class L2Skill implements IChanceSkillTrigger {
    ...
    public final List<AbstractEffect> applyEffects(Creature effector, Creature effected) {
        return applyEffects(effector, effected, ShieldDefense.FAILED, false);
    }

    public final List<AbstractEffect> applyEffects(Creature effector, Creature effected, ShieldDefense sDef, boolean isBlessedSpiritShot) {
    ...
    public final List<AbstractEffect> applyEffects(Cubic effector, Creature effected) {
        return applyEffects(effector, effected, ShieldDefense.FAILED, false);
    }

    public final List<AbstractEffect> applyEffects(Cubic effector, Creature effected, ShieldDefense sDef, boolean isBlessedSpiritShot) {
        if (!hasEffects() || isPassive()) {
            return Collections.emptyList();
        }
    ...
    public final List<AbstractEffect> applySelfEffects(Creature effector) {
