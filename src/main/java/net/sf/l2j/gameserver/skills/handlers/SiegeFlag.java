...
public class SiegeFlag extends L2Skill {
    ...
    public void useSkill(Creature activeChar, WorldObject[] targets) {
        ...
        // Spawn a new flag.
        final net.sf.l2j.gameserver.model.actor.instance.SiegeFlag flag = new net.sf.l2j.gameserver.model.actor.instance.SiegeFlag(clan, IdFactory.getInstance().getNextId(), new NpcTemplate(npcDat));
     ...
     * @return True if the {@link Player} can place a {@link net.sf.l2j.gameserver.model.actor.instance.SiegeFlag}.
     */
    public static boolean check(Player player, boolean isCheckOnly) {
        ...
        } else if (!player.getKnownTypeInRadius(net.sf.l2j.gameserver.model.actor.instance.SiegeFlag.class, 400).isEmpty()) {
