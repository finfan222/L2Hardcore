...
/**
 * A super class for all functions. {@link Func} is container used to calculate a {@link Stats}'s value. It contains the
 * {@link Stats}, order and the value itself.<br>
 * <br>
 * When the calculation is required (via {@link Calculator}), each {@link Func} is called sequentially by its order.
 * Lowest priority order is executed first, while same order are executed in unspecified order.<br>
 * <ul>
