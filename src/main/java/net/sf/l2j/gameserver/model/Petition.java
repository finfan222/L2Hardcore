...
public class Petition {
    ...
    /**
     * Add the {@link Player} set as parameter to responders, but only if not null, not already registered as
     * petitioner, or not already part of the responders.
     *
     ...
     * <br>
     * If already under ACCEPTED state, then register the {@link Player} as additional responder and abort the basic
     * behavior.
     *
    ...
    /**
     * Abort this {@link Petition} for the given {@link Player} ; if none valid responder is found, end the
     * consultation, setting back the PetitionState to PENDING.
     *
