 ...
 * <br>
 * Mass Gatekeepers allow Castle Defenders Players to teleport back to battle, after 30 seconds. The time can increase
 * to 480 seconds (8 minutes) during an active siege where all ControlTowers shattered.
 */
public class CastleGatekeeper extends Folk {
    ...
    /**
     * @return The teleport delay, as following : 30 seconds for regular teleport, 480 seconds (8 minutes) during an
     * active siege, and if all ControlTowers have been broken.
     */
