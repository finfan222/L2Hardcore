...
public class Party extends AbstractGroup {
    ...
    /**
     * Set invitation process flag and store time for expiration happens when a {@link Player} joins or declines to
     * join.
     *
     ...
     * @return A random valid {@link Player} looter from this {@link Party}, or null if none of the members match
     * conditions.
     */
     ...
     * @param itemId : The ID of the item for which the member must have inventory space.
     * @param target : The {@link Creature} of which the member must be within a certain range (must not be null).
     * @return The next valid {@link Player} looter from this {@link Party}, or null if none of the members match
     * conditions.
     */
    ...
    /**
     * Send a {@link L2GameServerPacket} to all {@link Player}s of this {@link Party}, except the {@link Player} set as
     * parameter.
     *
    ...
    /**
     * Check whether the leader of this {@link Party} is the same as the leader of the specified {@link Party} (which
     * essentially means they're the same group).
     *
