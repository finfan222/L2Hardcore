...
/**
 * This instance leads the behavior of Wyvern Managers.<br> Those NPCs allow Castle Lords to mount a wyvern in return
 * for B Crystals.<br> Three configs exist so far :<br>
 * <ul>
