...
/**
 * A datatype used to retain Henna infos. Hennas are called "dye" ingame, and enhance {@link Player} stats for a
 * fee.<br>
 * <br>
 * You can draw up to 3 hennas (depending about your current class rank), but accumulated boni for a stat can't be
 * higher than +5. There is no limit in reduction.
 */
