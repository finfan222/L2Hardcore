...
public abstract class Playable extends Creature {
    ...
    /**
     * Send a {@link SystemMessage} packet using a {@link SystemMessageId} to the {@link Player} associated to this
     * {@link Playable}.
     *
    ...
    /**
     * Check if an item is disabled. All skills disabled are identified by their reuse objectIds in
     * <B>_disabledItems</B>.
     *
                    ...
                    if (getStatus().getLevel() - attackable.getStatus().getLevel() > 8) {
                        ...
                        if (ai != null && ai.getHate() > 0) {
                            ...
                            if (getFirstEffect(curse) == null) {
                                ...
                                curse.applyEffects(attackable, this);
