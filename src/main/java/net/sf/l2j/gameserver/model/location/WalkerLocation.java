 ...
 * <br>
 * Added to the x/y/z informations, you can also find delay (the time the Walker NPC will stand on the point without
 * moving), the String to broadcast (null if none) and the running behavior.
 */
