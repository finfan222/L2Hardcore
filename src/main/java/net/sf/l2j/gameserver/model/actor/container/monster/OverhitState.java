 ...
 * <br>
 * An over-hit occurs when a {@link Player} procs a over-hit-friendly skill over a Monster. If that Monster dies due to
 * that skill, the damage amount difference is calculated as exp points bonus.
 */
public class OverhitState {
    ...
    /**
     * Test and eventually set the over-hit values based on the {@link Creature} who did the strike and the damage
     * amount.
     *
