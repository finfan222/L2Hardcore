...
public class Teleport extends Location {
    ...
    /**
     * In L2OFF half price teleport feature is set in 'event.ini' and is named 'CoreTime'.<br> However some
     * custom/extended L2OFF packs are likely to use type "PRIMEHOURS", but it is nothing more than static data
     * duplication.<br> Also core-time shall effect only standard teleport.
     *
