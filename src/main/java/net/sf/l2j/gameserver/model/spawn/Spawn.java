...
public final class Spawn implements Runnable {
    ...
    /**
     * Set the respawn delay, representing the respawn time of this {@link Spawn}. It can't be inferior to 0, it is
     * automatically modified to 1 second.
     *
    ...
    /**
     * Create a respawn task to be launched after the fixed + random delay. Respawn is only possible when respawn
     * enabled.
     */
