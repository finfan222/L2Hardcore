...
public class SchemeBuffer extends Folk {
    ...
    /**
     * Send an html packet to the {@link Player} set a parameter with Give Buffs menu info for player and pet, depending
     * on targetType parameter {player, pet}.
     *
    ...
    /**
     * Send an html packet to the {@link Player} set as parameter with Edit Scheme Menu info. This allows the
     * {@link Player} to edit each created scheme (add/delete skills)
     *
     * @param player : The {@link Player} to make checks on.
