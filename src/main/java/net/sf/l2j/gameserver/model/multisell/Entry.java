...
/**
 * A datatype which is part of multisell system. A multisell list can hold multiple Products.<br> Each Product owns a
 * List of "required part(s)" and "result(s)" known both as {@link Ingredient}s.
 */
public class Entry {
