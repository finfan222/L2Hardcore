...
public abstract class ZoneType {
    ...
    /**
     * Add a {@link Quest} on _questEvents {@link Map}. Generate both Map and {@link List} if not existing (lazy
     * initialization).<br>
     * <br>
    ...
    /**
     * Setup new parameters for this zone. By default, we return a warning (which mean this parameter isn't used on
     * child zone).
     *
