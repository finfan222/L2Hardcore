...
/**
 * Clan system is one of the major features of the game. Clans unite players and let them influence the world of Lineage
 * 2.<br>
 * <br>
...
public class Clan {
     ...
     * @return True if the operation was successful (the {@link L2Skill} wasn't existing or at a lower level), or false
     * otherwise.
     */
    ...
    /**
     * Check olympiad state, clan reputation and pledge rank, then reward the {@link L2Skill} to the {@link Player} set
     * as parameter if everything is ok.
     *
     * @param player : The {@link Player} to test.
     * @param skill : The {@link L2Skill} to test.
     * @return True if the {@link Clan} {@link L2Skill} could be properly added to the {@link Player}, or false
     * otherwise.
     */
    ...
    /**
     * Check olympiad state, clan reputation and pledge rank, then reward all {@link Clan} {@link L2Skill}s to the
     * {@link Player} set as parameter if everything is ok.
     *
     * @param player : The {@link Player} to test.
     * @return True if all {@link Clan} {@link L2Skill}s could be properly added to the {@link Player}, or false
     * otherwise.
     */
     ...
     * @return True if a status refresh occured (being positive value reached negative, or negative value reached
     * positive).
     */
