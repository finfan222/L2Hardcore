...
abstract class AbstractAI {
     ...
     * attack
     * and is stunned, he will attack again after the stunned period).</b></font>
     *
     ...
     * @return True if the {@link IntentionType} set as parameter can be sheduled after this {@link IntentionType},
     * otherwise cast it immediately.
     */
    ...
    /**
     * Activate the attack stance, broadcasting {@link AutoAttackStart} packet. Refresh the timer if already registered
     * on {@link AttackStanceTaskManager}.
     */
    ...
    /**
     * Deactivate the attack stance, broadcasting {@link AutoAttackStop} packet if the actor was registered on
     * {@link AttackStanceTaskManager}.
     */
     ...
     * @return True if the given {@link WorldObject} is missing out (null, not registered, not on same region), giving a
     * given {@link L2Skill}.
     */
