...
public class Npc extends Creature {
     ...
     * @return True if the {@link Player} set as parameter is the clan leader owning this {@link Npc} (being a
     * {@link Castle}, {@link ClanHall} or {@link SiegableHall}).
     */
    ...
    /**
     * @return The Exp reward of this {@link Npc} based on its {@link NpcTemplate} and modified by
     * {@link Config#RATE_XP}.
     */
    ...
    /**
     * @return The SP reward of this {@link Npc} based on its {@link NpcTemplate} and modified by
     * {@link Config#RATE_SP}.
     */
    ...
    /**
     * Open a quest or chat window for a {@link Player} with the text of this {@link Npc} based of the {@link String}
     * set as parameter.
     *
     ...
     *
     * @param player : The {@link Player} to test.
     * @param index : The {@link Location} index information to retrieve from this {@link Npc}'s instant teleports
     * {@link List}.
     */
     ...
     *
     * @param player : The {@link Player} to test.
     * @param index : The {@link Teleport} index information to retrieve from this {@link Npc}'s instant teleports
     * {@link List}.
     */
    ...
    /**
     * Research the pk chat window htm related to this {@link Npc}, based on a String folder and npcId.<br> Send the
     * content to the {@link Player} passed as parameter.
     *
    ...
    /**
     * Open a chat window on client with the text of the Npc.<br> Send the content to the {@link Player} passed as
     * parameter.
     *
     * @param player : The player that talk with the Npc.
     */
    ...
    /**
     * Open a chat window on client with the text specified by {@link #getHtmlPath} and val parameter.<br> Send the
     * content to the {@link Player} passed as parameter.
     *
     * @param player : The player that talk with the Npc.
    ...
    /**
     * Open a chat window on client with the text specified by the given file name and path.<br> Send the content to the
     * {@link Player} passed as parameter.
     *
     * @param player : The player that talk with the Npc.
    ...
    /**
     * Move this {@link Npc} from its initial {@link Spawn} location using a defined random offset. The {@link Npc} will
     * circle around the initial location.
     *
