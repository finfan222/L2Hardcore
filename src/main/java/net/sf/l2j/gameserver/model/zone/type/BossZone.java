...
public class BossZone extends ZoneType {
    ...
    /**
     * Enables the entry of a {@link Player} to this {@link BossZone} for next "duration" seconds. If the Player tries
     * to enter the zone after this period, he will be teleported out.
     *
    ...
    /**
     * Enables the entry of a {@link Player} to this {@link BossZone} after server shutdown/restart. The time limit is
     * specified by each zone via "InvadeTime" parameter. If the player tries to enter the zone after this period, he
    ...
    /**
     * Teleport all {@link Player}s located in this {@link BossZone} to a specific location, as listed on
     * {@link #_oustLoc}. Clear both containers holding Players informations.
     *
