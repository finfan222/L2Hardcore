 ...
 * <br>
 * isUnderSiege() checks current siege state associated to the doorman castle, while isOwnerClan() checks if the user is
 * part of clan owning the castle and got the rights to open/close doors.
 */
