...
/**
 * Mass events, like sieges or raids require joining several {@link Party}. That's what {@link CommandChannel}s are for
 * in the world of Lineage.<br>
 * <br>
...
public class CommandChannel extends AbstractGroup {
    ...
    /**
     * Check whether the leader of this {@link CommandChannel} is the same as the leader of the specified CommandChannel
     ...
     * @return true if the given Player set as parameter is a level 5 clan member with either Clan Imperium skill
     * (skillId: 391) or a valid Strategy Guide item (itemId: 8871).
     */
