 ...
 * <br>
 * The fishing stance starts with a task named _lookingForFish. This task handles the waiting process, up to the caught
 * time.<br>
 * <br>
 * Once a {@link Fish} is found, a new task occurs, named _fishCombat. The {@link Player} will play a minigame to reduce
 * the resilience of the Fish. If he succeeds, he caught the Fish.
 */
public class FishingStance {
    ...
    /**
     * Modify {@link Fish} current HP during the minigame. We also handle the different events (HP reaching 0, or HP
     * going past maximum HP).
     *
