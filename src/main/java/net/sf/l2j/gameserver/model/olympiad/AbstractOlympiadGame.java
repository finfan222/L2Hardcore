...
public abstract class AbstractOlympiadGame {
     ...
     * @return true if both {@link Participant}s have been successfully teleported on the given {@link Location}s, false
     * otherwise.
     */
    protected abstract boolean portPlayersToArena(List<Location> spawns);

    /**
     * Cancel all {@link Player}s animations, set their Intention to IDLE. Affects also their {@link Summon}, if
     * existing. Heal Players, start their HP/MP regen.
     */
    ...
    /**
     * Reset {@link Player}s status back to regular behaviour : stop all charges and effects, add back clan & hero
     * skills.
     */
    ...
    /**
     * @return true if the battle is still continuing due to regular Olympiad rules (no disconnection, correct number of
     * Participants,...)
     */
     ...
     * @return null if the tested {@link Player} passed all checks or broadcast the {@link SystemMessage} associated to
     * opponent defection.
     */
     ...
     * @return true if the {@link Participant} has been successfully teleported on the given {@link Location}, false
     * otherwise.
     */
    ...
    /**
     * Cancel all {@link Player} animations, set the Intention to IDLE. Affects also the {@link Summon}, if existing.
     * Heal the Player, start his HP/MP regen.
     *
     * @param player : The Player to affect.
     */
    ...
    /**
     * Reset {@link Player} status back to regular behaviour : stop all charges and effects, add back clan & hero
     * skills.
     *
     * @param player : The Player to affect.
     */
