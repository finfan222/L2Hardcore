...
public class CreatureStatus<T extends Creature> {
    ...
    /**
     * Add the {@link Player} to this {@link CreatureStatus} status listener that must inform HP/MP updates of this
     * {@link Creature}.
     *
    ...
    /**
     * Remove the {@link Player} to this {@link CreatureStatus} status listener that must inform HP/MP updates of this
     * {@link Creature}.
     *
    ...
    /**
     * Set both HPs and MPs to given values set as parameters. The udpate is called only one time, during MPs
     * allocation.
     *
     ...
     * @param target : The {@link Creature} target whose properties will be used in the calculation.
     * @param skill : The {@link L2Skill} whose properties will be used in the calculation.
     * @return The MAtk (base+modifier) of this {@link Creature} for a given {@link L2Skill} and {@link Creature}
     * target.
     */
     ...
     * @param target : The {@link Creature} target whose properties will be used in the calculation.
     * @param skill : The {@link L2Skill} whose properties will be used in the calculation.
     * @return The MDef (base+modifier) of this {@link Creature} for a given {@link L2Skill} and {@link Creature}
     * target.
     */
    ...
    /**
     * @return The base movement speed, given by owner template and movement status. Player is affected by mount type
     * and by being in L2WaterZone.
     */
