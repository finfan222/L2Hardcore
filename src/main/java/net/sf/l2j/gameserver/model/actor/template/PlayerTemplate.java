 ...
 * collision values for female, hp/mp/cp tables, etc.<br>
 * <br>
 * Since each PlayerTemplate is associated to a {@link ClassId}, it is also used as a container for
 * {@link GeneralSkillNode}s this class can use.<br>
 * <br>
 * Finally, it holds starter equipment (under an int array of itemId) and initial spawn {@link Location} for newbie
 * templates.
 */
public class PlayerTemplate extends CreatureTemplate {
    ...
    /**
     * @return the {@link List} of {@link ItemTemplateHolder}s holding the starter equipment informations for this
     * {@link PlayerTemplate}.
     */
     ...
     * @return the associated {@link GeneralSkillNode} if a matching id/level is found on this {@link PlayerTemplate},
     * or null.
     */
