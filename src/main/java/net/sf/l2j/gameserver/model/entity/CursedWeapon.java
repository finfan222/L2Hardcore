...
/**
 * One of these swords can drop from any mob. But only one instance of each sword can exist in the world. When a cursed
 * sword drops, the world becomes red for several seconds, the ground shakes, and there's also an announcement as a
 * system message that a cursed sword is found.<br>
 * <br>
 * The owner automatically becomes chaotic and their HP/CP/MP are fully restored.<br>
 * <br>
 * A cursed sword is equipped automatically when it's found, and the owner doesn't have an option to unequip it, to drop
 * it or to destroy it. With a cursed sword you get some special skills.<br>
 * <br>
 * The cursed swords disappear after a certain period of time, and it doesn't matter how much time the owner spends
 * online. This period of time is reduced if the owner kills another player, but the abilities of the sword increase.
 * However, the owner needs to kill at least one player per day, otherwise the sword disappears in 24 hours. There will
 * be system messages about how much lifetime the sword has and when last murder was committed.<br>
 * <br>
...
public class CursedWeapon {
    ...
    /**
     * This method is used to destroy a {@link CursedWeapon}.<br> It manages following states :
     * <ul>
    ...
    /**
     * This method is used to drop the {@link CursedWeapon} from its {@link Player} owner.<br> It drops the item on
     * ground, and reset player stats and skills. Finally it broadcasts a message to all online players.
     *
    ...
    /**
     * This method is used to drop the {@link CursedWeapon} from a {@link Attackable} monster.<br> It drops the item on
     * ground, and broadcast earthquake && red sky animations. Finally it broadcasts a message to all online players.
     *
    ...
    private void dropFromMob(Attackable attackable, Player player) {
        ...
        _item = ItemFactory.create(_itemId, 1, player, attackable);
    ...
    /**
     * Rebind the passive skill belonging to the {@link CursedWeapon} owner. Invoke this method if the weapon owner
    ...
    /**
     * Handles the drop rate of a {@link CursedWeapon}. If successful, launches the different associated tasks (end,
     * overall and drop timers).
     *
    ...
    /**
     * Activate the {@link CursedWeapon}. We refresh {@link Player} owner, store related infos, save references,
     * activate cursed weapon skills, expell him from the party (if any).<br>
     * <br>
    ...
    /**
     * Increase the number of kills. If actual counter reaches the number generated to reach next stage, than rank up
     * the {@link CursedWeapon}.
     */
