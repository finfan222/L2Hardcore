...
/**
 * The core of craft system, which allow {@link Player} to exchange materials for a final product. Numerous checks are
 * made (integrity checks, such as item existence, mana left, adena cost).<br>
 * <br>
...
public class RecipeItemMaker implements Runnable {
    ...
    /**
     * Send to the {@link Player} customer {@link RecipeItemMakeInfo} (self crafting) or {@link RecipeShopItemInfo}
     * (private workshop) packet.
     *
