...
public class Point2D {
    ...
    /**
     * Refresh the current {@link Point2D} using a reference {@link Point2D} and a distance. The new destination is
     * calculated to go in opposite side of the {@link Point2D} reference.<br>
     * <br>
