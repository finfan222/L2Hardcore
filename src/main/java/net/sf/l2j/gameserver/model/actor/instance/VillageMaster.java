...
public class VillageMaster extends Folk {
    ...
    /**
     * Check subclass classId for validity (villagemaster race/type is not contains in previous subclasses, but in
     * allowed subclasses). Base class not added into allowed subclasses.
     *
