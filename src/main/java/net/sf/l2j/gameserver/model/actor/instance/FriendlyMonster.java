...
/**
 * This class represents Friendly Mobs lying over the world.<br> These friendly mobs should only attack players with
 * karma > 0 and it is always aggro, since it just attacks players with karma.
 */
