 ...
 * <br>
 * You can customize class rewards as needed items. Check npc.properties for more informations.<br> This NPC type got 2
 * differents ways to level:
 * <ul>
...
public final class ClassMaster extends Folk {
    ...
    private static String getRequiredItems(int level) {
        ...
        for (IntIntHolder item : neededItems) {
            StringUtil.append(sb, "<tr><td><font color=\"LEVEL\">", item.getValue(), "</font></td><td>", ItemManager.getInstance().getTemplate(item.getId()).getName(), "</td></tr>");
        }
