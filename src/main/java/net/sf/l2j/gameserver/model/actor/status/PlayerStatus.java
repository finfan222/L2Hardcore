...
public class PlayerStatus extends PlayableStatus<Player> {
    ...
    /**
     * Set both CPs, HPs and MPs to given values set as parameters. The udpate is called only one time, during MPs
     * allocation.
     *
    ...
    /**
     * Send {@link StatusUpdate} packet to current {@link Player} and current HP, MP and Level to all other
     * {@link Player}s of the {@link Party}.
     */
    @Override
     ...
     *
     * @return True if this {@link Player} exceeded the authorized inventory slots ratio (which is 80%), or false
     * otherwise.
     */
