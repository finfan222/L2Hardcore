...
/**
 * The generic datatype used by any character template. It holds basic informations, such as base stats (STR, CON,
 * DEX,...) and extended stats (power attack, magic attack, hp/mp regen, collision values).
 */
