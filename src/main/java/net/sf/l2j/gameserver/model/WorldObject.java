...
public abstract class WorldObject {
    ...
    /**
     * Set the position of this {@link WorldObject} using a WorldObject reference position, and if necessary modify its
     * _region.
     *
     ...
     * @return true if the {@link WorldObject} set as parameter is registered in same grid of regions than this
     * WorldObject.
     */
     ...
     * <br>
     * A region activation occurs when one {@link Player} enters for the first time in this {@link WorldObject}'s
     * {@link WorldRegion} surroundings (self region included).<br>
     * <br>
     ...
     * <br>
     * A region desactivation occurs when the last {@link Player} left this {@link WorldObject}'s {@link WorldRegion}
     * surroundings (self region included).<br>
     * <br>
     ...
     * @return True is this {@link WorldObject} is inside the given radius around the {@link WorldObject} set as
     * parameter.
     */
    ...
    /**
     * @param object : The {@link WorldObject} to test.
     * @return The distance - without counting Z - between this {WorldObject} and the {@link WorldObject} set as
     * parameter.
     */
